...
// leads table routing
const ContactLeads = Loadable(lazy(() => import('views/forms/tables/leads/ContactLeads')));
const QuickConsultLeads = Loadable(lazy(() => import('views/forms/tables/leads/QuickConsultLeads')));

// quote table routing
const QuoteTable = Loadable(lazy(() => import('views/forms/tables/all_quote/QuoteTable')));
const KitchenQuoteTable = Loadable(lazy(() => import('views/forms/tables/all_quote/KitchenQuoteTable')));
const WardrobeQuoteTable = Loadable(lazy(() => import('views/forms/tables/all_quote/WardrobeQuoteTable')));
...
const AdminPrivacyPolicyForm = Loadable(lazy(() => import('views/forms/content-layouts/privacy-policy/PrivacyPolicyForm')));
const AdminRefundPolicyForm = Loadable(lazy(() => import('views/forms/content-layouts/refund-policy/RefundPolicyForm')));
const AdminTermsAndConditionsForm = Loadable(lazy(() => import('views/forms/content-layouts/terms-and-conditions/TermsAndConditionsForm')));
const AdminContactForm = Loadable(lazy(() => import('views/forms/content-layouts/contact/ContactForm')));

const HomeLayout = Loadable(lazy(() => import('views/forms/content-layouts/home/HomeLayout')));
const AboutLayout = Loadable(lazy(() => import('views/forms/content-layouts/about/AboutLayout')));
const ServiceLayout = Loadable(lazy(() => import('views/forms/content-layouts/service/ServiceLayout')));
const LandingLayout = Loadable(lazy(() => import('views/forms/content-layouts/landing/LandingLayout')));
