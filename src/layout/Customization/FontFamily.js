...
const FontFamily = () => {
  ...
  const bgActiveColor =
    theme.palette.mode === 'dark' ? 'primary.800' : 'primary.light';
        ...
        <Grid container spacing={1.25}>
          <Grid item xs={12}>
            <MainCard
              ...
              sx={{
                p: 0.75,
                bgcolor: font === 'Inter' ? bgActiveColor : bgColor,
              }}
            >
              <MainCard
                content={false}
              ...
              >
                <FormControlLabel
                  ...
                  label={
                    <Typography
                      variant="h5"
                      sx={{ pl: 2, fontFamily: `'Inter', sans-serif` }}
                    >
                      Inter
                    </Typography>
                  }
          ...
          <Grid item xs={12}>
            <MainCard
              ...
              sx={{
                p: 0.75,
                bgcolor: font === 'Poppins' ? bgActiveColor : bgColor,
              }}
            >
              <MainCard
                content={false}
              ...
              >
                <FormControlLabel
                  ...
                  label={
                    <Typography
                      variant="h5"
                      sx={{ pl: 2, fontFamily: `'Poppins', sans-serif` }}
                    >
                      Poppins
                    </Typography>
                  }
          ...
          <Grid item xs={12}>
            <MainCard
              ...
              sx={{
                p: 0.75,
                bgcolor: font === 'Roboto' ? bgActiveColor : bgColor,
              }}
            >
              <MainCard
                content={false}
              ...
              >
                <FormControlLabel
                  ...
                  label={
                    <Typography
                      variant="h5"
                      sx={{ pl: 2, fontFamily: `'Roboto', sans-serif` }}
                    >
                      Roboto
                    </Typography>
                  }
