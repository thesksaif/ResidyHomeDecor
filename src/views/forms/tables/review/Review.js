...
const rows = [
    createData(1, 'Alice Smith', 'alice@example.com', 5, 'Great product!', 'Approved', '2024-06-01'),
    createData(2, 'Bob Johnson', 'bob@example.com', 4, 'Very useful.', 'Pending', '2024-05-28'),
    createData(3, 'Charlie Lee', 'charlie@example.com', 3, 'Average experience.', 'Rejected', '2024-05-25'),
    createData(4, 'Diana King', 'diana@example.com', 5, 'Loved it!', 'Approved', '2024-05-20'),
    createData(5, 'Evan Wright', 'evan@example.com', 2, 'Not as expected.', 'Pending', '2024-05-18')
];
