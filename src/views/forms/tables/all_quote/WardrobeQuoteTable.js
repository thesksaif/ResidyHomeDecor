              ...
              <Box sx={{ margin: 1 }}>
                <TableContainer>
                  <SubCard
                    ...
                    title="Wardrobe Quote Details"
                    content={false}
                    secondary={
                      <Stack direction="row" spacing={2} alignItems="center">
                        <CSVExport
                          data={row.details}
                          filename={`wardrobe-quote-details-${row.id}.csv`}
                          header={[
                  ...
                  >
                    <Table size="small" aria-label="wardrobe quote details">
                      <TableHead>
                        <TableRow>
...
export default function WardrobeQuoteTable() {
    ...
    <MainCard
      ...
      secondary={
        <Stack direction="row" spacing={2} alignItems="center">
          <CSVExport
            data={rows}
            filename="wardrobe-quote-requests.csv"
            header={header}
          />
