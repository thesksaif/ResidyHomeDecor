...
const UIProgress = () => {
  ...
  return (
    <MainCard
      title="Progress"
      secondary={
        <SecondaryAction link="https://next.material-ui.com/components/progress/" />
      }
    >
          ...
          <SubCard title="Circular Indeterminate">
            <Grid container spacing={2} justifyContent="center">
              ...
              <Grid item>
                <CircularProgress
                  color="secondary"
                  aria-label="progress with secondary color"
                />
              </Grid>
            </Grid>
          </SubCard>
            ...
            <Grid container spacing={2} justifyContent="center">
              <Grid item xs={12}>
                <LinearProgress
                  variant="determinate"
                  value={progress}
                  aria-label="linear secondary progress"
                />
              </Grid>
            </Grid>
          </SubCard>
