  ...
  return (
    <>
      <MainCard
        title="Cards"
        secondary={
          <SecondaryAction link="https://next.material-ui.com/components/cards/" />
        }
      >
          ...
          <Grid item xs={12}>
            <SubCard title="Color Card">
              <Grid container spacing={gridSpacing}>
                ...
                <Grid item sm={6} md={4}>
                  <Card
                    sx={{ bgcolor: theme.palette.dark.main, color: '#fff' }}
                  >
                    <CardHeader
                      title={
          ...
          <Grid item xs={12}>
            <SubCard title="Outlined Card">
              <Grid container spacing={gridSpacing}>
                ...
                <Grid item sm={6} md={4}>
                  <Card
                    sx={{ border: `1px solid ${theme.palette.orange.main}` }}
                  >
                    <CardHeader
                      sx={{
                        borderBottom: `1px solid ${theme.palette.orange.main}`,
                      }}
                      title={
                        <Typography
                          variant="h5"
