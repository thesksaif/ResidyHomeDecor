          ...
          >
            ...
            >
              <Items
                ...
                image={
                  theme.palette.mode === 'dark' ? SliderDark5 : SliderLight5
                }
                link="/app/mail"
              />
              <Items
                title="Chat App"
                image={
                  theme.palette.mode === 'dark' ? SliderDark3 : SliderLight3
                }
                link="/app/chat"
              />
              <Items
                title="Kanban App"
                image={
                  theme.palette.mode === 'dark' ? SliderDark4 : SliderLight4
                }
              ...
              <Items
                title="Calendar App"
                image={
                  theme.palette.mode === 'dark' ? SliderDark2 : SliderLight2
                }
                link="/app/calendar"
              />
              <Items
                title="Ecommerce App"
                image={
                  theme.palette.mode === 'dark' ? SliderDark1 : SliderLight1
                }
              ...
              <Items
                ...
                image={
                  theme.palette.mode === 'dark' ? SliderDark6 : SliderLight6
                }
