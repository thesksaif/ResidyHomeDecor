            ...
            <Grid container spacing={gridSpacing}>
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={formik.handleChange}
                  error={
                    formik.touched.building && Boolean(formik.errors.street)
                  }
              ...
              <Grid item xs={6}>
                <TextField
                  ...
                  onChange={formik.handleChange}
                  error={
                    formik.touched.building && Boolean(formik.errors.state)
                  }
              ...
              <Grid item xs={12}>
                <TextField
                  ...
                  onChange={formik.handleChange}
                  error={
                    formik.touched.building && Boolean(formik.errors.phone)
                  }
