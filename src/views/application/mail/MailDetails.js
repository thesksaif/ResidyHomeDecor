...
// import 'react-quill/dist/quill.snow.css'; // Commented out due to missing file
        ...
        <Grid container spacing={gridSpacing}>
          <Grid item xs={12}>
            ...
            >
              ...
              <Grid item>
                <Typography variant="subtitle2">
                  {format(new Date(data?.time), 'd MMM')}
                </Typography>
              </Grid>
            </Grid>
          </Grid>
                    ...
                    <Grid item xs={12}>
                      <Stack direction="row" alignItems="center" spacing={1}>
                        <AttachmentTwoToneIcon
                          fontSize="small"
                          aria-label="any attachment file"
                        />
                    ...
                    >
                      ...
                      >
                        ...
                        <Grid item>
                          <IconButton
                            size="large"
                            aria-label="attachment any file"
                          >
                            <AttachmentTwoToneIcon />
                          </IconButton>
                        </Grid>
