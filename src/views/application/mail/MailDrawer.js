                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      {unreadCounts?.all !== 0 && (
                        <Chip label={unreadCounts?.all} size="small" />
                      )}
                    </ListItemButton>
                    <ListItemButton
                    ...
                    >
                      ...
                      {unreadCounts?.inbox !== 0 && (
                        <Chip label={unreadCounts?.inbox} size="small" />
                      )}
                    </ListItemButton>
                    <ListItemButton
                    ...
                    >
                      ...
                      {unreadCounts?.sent !== 0 && (
                        <Chip label={unreadCounts?.sent} size="small" />
                      )}
                    </ListItemButton>
                    <ListItemButton
                    ...
                    >
                      ...
                      {unreadCounts?.draft !== 0 && (
                        <Chip label={unreadCounts?.draft} size="small" />
                      )}
                    </ListItemButton>
                    <ListItemButton
                      selected={filter === 'spam'}
                    ...
                    >
                      ...
                      {unreadCounts?.spam !== 0 && (
                        <Chip label={unreadCounts?.spam} size="small" />
                      )}
                    </ListItemButton>
                    <ListItemButton
                    ...
                    >
                      ...
                      {unreadCounts?.trash !== 0 && (
                        <Chip label={unreadCounts?.trash} size="small" />
                      )}
                    </ListItemButton>
                    <Divider />
                    ...
                    >
                      ...
                      {unreadCounts?.starred !== 0 && (
                        <Chip label={unreadCounts?.starred} size="small" />
                      )}
                    </ListItemButton>
                    <ListItemButton
                    ...
                    >
                      ...
                      {unreadCounts?.important !== 0 && (
                        <Chip label={unreadCounts?.important} size="small" />
                      )}
                    </ListItemButton>
                    <Divider />
                    <ListSubheader sx={{ bgcolor: 'transparent' }}>
                    ...
                    >
                      ...
                      {unreadCounts?.promotions !== 0 && (
                        <Chip label={unreadCounts?.promotions} size="small" />
                      )}
                    </ListItemButton>
                    <ListItemButton
                      selected={filter === 'forums'}
                      onClick={() => handleFilter('forums')}
                    >
                      <ListItemIcon>
                        <LabelTwoToneIcon
                      ...
                      {unreadCounts?.forums !== 0 && (
                        <Chip label={unreadCounts?.forums} size="small" />
                      )}
                    </ListItemButton>
                  </List>
                </PerfectScrollbar>
