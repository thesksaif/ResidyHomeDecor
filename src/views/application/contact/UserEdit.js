...
const UserEdit = ({ user, onCancel, onSave, ...others }) => {
  ...
  return (
    <ElevationScroll {...others}>
      ...
      >
        <PerfectScrollbar
          style={{ height: 'calc(100vh - 83px)', overflowX: 'hidden' }}
        >
            ...
            <Grid item xs={12}>
              <FormControl fullWidth>
                ...
                <OutlinedInput
                  ...
                  onChange={(e) =>
                    setProfile({ ...profile, work_email: e.target.value })
                  }
                  type="text"
                  label="Email"
                  startAdornment={
            ...
            <Grid item xs={12}>
              <FormControl fullWidth>
                ...
                <OutlinedInput
                  ...
                  onChange={(e) =>
                    setProfile({ ...profile, personal_email: e.target.value })
                  }
                  type="text"
                  label="Email"
                  startAdornment={
            ...
            <Grid item xs={12}>
              <FormControl fullWidth>
                ...
                <OutlinedInput
                  ...
                  onChange={(e) =>
                    setProfile({ ...profile, birthdayText: e.target.value })
                  }
                  type="text"
                  label="Bio"
                  multiline
