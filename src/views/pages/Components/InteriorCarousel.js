        ...
        <div className="carousel-container">
            ...
            <OwlCarousel options={options}>
                ...
                <div className="item">
                    ...
                    <div className="carousel-caption">Contemporary 3 BHK house, Gurgaon</div>
                </div>
                <div className="item">
                    <img src={image3} alt="Contemporary 3 BHK flat, Ahmedabad" />
                    <div className="carousel-caption">Contemporary 3 BHK flat, Ahmedabad</div>
                </div>
                <div className="item">
            ...
            <a href="/quote" className="get-quote-btn" target="_blank" rel="noopener noreferrer">
                GET FREE QUOTE
            </a>
        </div>
    );
