        ...
        <div className="row justify-content-between">
          ...
          <div className="col-lg-5">
            ...
            <p className="about-content">
              Besides great interior design, there are other reasons to choose
            ...
            <ul className="list-unstyled feature-list">
              ...
              <li className="feature-item">
                ...
                <div className="feature-content">
                  <h4>Unusual Ideas</h4>
                  <p>
                    Our designers generate various yet always original ideas
                    that will surely fit your needs.
                  </p>
                </div>
              </li>
              <li className="feature-item">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    All our work is built around respect for our clients, great
