    ...
    drawTitle() {
        ...
        if (this.isHorizontal()) {
            ...
            y =
                ...
                _alignStartEnd(opts.align, this.top, this.bottom - maxHeight - opts.labels.padding - this._computeTitleHeight());
        }
...
class CategoryScale extends Scale {
    ...
    parse(raw, index) {
        ...
        const labels = this.getLabels();
        index =
            isFinite(index) && labels[index] === raw ? index : findOrAddLabel(labels, raw, valueOrDefault(index, raw), this._addedLabels);
