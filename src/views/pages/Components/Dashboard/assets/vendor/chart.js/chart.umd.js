...
!(function (t, e) {
    ...
    function Ee(t, e, i, s, n) {
        ...
        if (f && 'object' == typeof f && ((o = f.toString()), '[object HTMLImageElement]' === o || '[object HTMLCanvasElement]' === o))
            return (
                t.save(), t.translate(i, s), t.rotate(m), t.drawImage(f, -f.width / 2, -f.height / 2, f.width, f.height), void t.restore()
            );
        if (!(isNaN(p) || p <= 0)) {
    ...
    function Zs(t, e, i) {
        let s = ut(t);
        return (
            ((i && 'right' !== e) || (!i && 'right' === e)) && (s = ((t) => ('left' === t ? 'right' : 'right' === t ? 'left' : t))(s)), s
        );
    }
    class Js extends Hs {
        constructor(t) {
        ...
        calculateLabelRotation() {
            ...
            (o = t.offset ? this.maxWidth / i : u / (i - 1)),
                c + 6 > o &&
                    ...
                    (r = Math.sqrt(c * c + d * d)),
                    (l = Y(
                        Math.min(Math.asin(J((h.highest.height + 6) / o, -1, 1)), Math.asin(J(a / r, -1, 1)) - Math.asin(J(d / r, -1, 1)))
                    )),
    ...
    function to(t, e, i, s) {
        ...
        for (l && ((d = n[x(0)]), t.moveTo(d.x, d.y)), c = 0; c <= r; ++c) {
            ...
            const e = d.x,
                i = d.y,
                s = 0 | e;
            s === u ? (i < f ? (f = i) : i > g && (g = i), (m = (b * m + e) / ++b)) : (_(), t.lineTo(e, i), (u = s), (b = 0), (f = g = i)),
                (p = i);
        }
        _();
    }
    ...
    function Fo(t, e) {
        ...
        return (
            ...
            null === l ? null : (o && (l = 'week' !== o || (!N(r) && !0 !== r) ? i.startOf(l, o) : i.startOf(l, 'isoWeek', r)), +l)
        );
    }
    function Vo(t, e, i, s) {
        const n = Io.length;
    ...
    class Va extends Hs {
        ...
        handleEvent(t, e, i = !0) {
            ...
            const s = this.options,
                ...
                r = e || !f(o, n) || a;
            return (
                r && ((this._active = o), (s.enabled || s.external) && ((this._eventPosition = { x: t.x, y: t.y }), this.update(!0, e))), r
            );
        }
        _getActiveElements(t, e, i, s) {
            const n = this.options;
