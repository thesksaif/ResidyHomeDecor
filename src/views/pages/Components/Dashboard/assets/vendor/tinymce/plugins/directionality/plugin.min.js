...
!(function () {
    ...
    const m = (t) => (e) => ((t) => t.dom.nodeType)(e) === t,
        ...
        S = (t) =>
            ...
            ((t, e) => {
                ...
                return '' !== r || N(t)
                    ? r
                    : ((t, e) => (((t) => void 0 !== t.style && i(t.style.getPropertyValue))(t) ? t.style.getPropertyValue(e) : ''))(o, e);
            })(t, 'direction')
                ? 'rtl'
                : 'ltr',
        A = (t, e) =>
    ...
    const T = (t, e, n) => {
        ...
        D = (t, e) => (o) => {
            ...
            return t.on('NodeChange', r), o.setEnabled(t.selection.isEditable()), () => t.off('NodeChange', r);
        };
