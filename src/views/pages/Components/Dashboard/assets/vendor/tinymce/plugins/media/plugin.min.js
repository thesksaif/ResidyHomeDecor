...
!(function () {
    ...
    const M = (e, t = {}) => A({ forced_root_block: !1, validate: !1, allow_conditional_comments: !0, ...t }, e),
        N = O.DOM,
        ...
        G = (e, t) => {
            var r;
            const o = j.extend({}, t);
            if (!o.source && (j.extend(o, T(null !== (r = o.embed) && void 0 !== r ? r : '', e.schema)), !o.source)) return '';
                    ...
                    'iframe' === o.type
                        ? ((e, t) => {
                              if (t) return t(e);
                              {
                                  ...
                                  return (
                                      '<iframe src="' + e.source + '" width="' + e.width + '" height="' + e.height + '"' + t + '></iframe>'
                                  );
                              }
                          })(o, a)
        ...
        J = (e, t) => {
            ...
            return r
                ? ((e, t, r) =>
                      new Promise((o, a) => {
                          const s = (r) => (r.html && (q[e.source] = r), o({ url: e.source, html: r.html ? r.html : t(e) }));
        ...
        te = (e, t) => ((e, t) => e.width !== t.width || e.height !== t.height)(e, t) && ee(t.source, e.type),
        re = (e) => {
            const t = ((e) => {
                ...
                o = V(t),
                a = k(e) ? [{ type: 'sizeinput', name: 'dimensions', label: 'Constrain proportions', constrain: !0 }] : [],
                s = {
                    title: 'General',
                    name: 'general',
                    items: c([[{ name: 'source', type: 'urlinput', filetype: 'media', label: 'Source' }], a])
                },
                i = [];
            x(e) && i.push({ name: 'altsource', type: 'urlinput', filetype: 'media', label: 'Alternative source URL' }),
                _(e) && i.push({ name: 'poster', type: 'urlinput', filetype: 'image', label: 'Media poster (Image URL)' });
                        ...
                        switch (o.name) {
                            case 'source':
                                ((t, r) => {
                                    ...
                                    t.source !== o.source && (Y(u, e)({ url: o.source, html: '' }), J(e, o).then(Y(u, e)).catch(X(e)));
                                })(r.get(), t);
                                break;
                            case 'embed':
                                ((t) => {
    ...
    const ae = (e) => {
        ...
        ne = (e, t) => {
            ...
            return (
                ce(e, t, o),
                ie(t, o, {}),
                o.attr({ style: t.attr('style'), src: oe.transparentSrc, 'data-mce-object': r, class: 'mce-object mce-object-' + r }),
                o
            );
        },
        le = (e, t) => {
            ...
            const o = t.name,
                a = new D('span', 1);
            a.attr({ contentEditable: 'false', style: t.attr('style'), 'data-mce-object': o, class: 'mce-preview-object mce-object-' + o }),
                ce(e, t, a);
            const i = e.dom.parseStyle(null !== (r = t.attr('style')) && void 0 !== r ? r : ''),
                n = new D(o, 1);
            if ((ie(t, n, i), n.attr({ src: t.attr('src'), style: t.attr('style'), class: t.attr('class') }), 'iframe' === o))
        ...
        (e) => (
            ...
            ((e) => {
                ...
                e.ui.registry.addToggleButton('media', {
                    ...
                    e.ui.registry.addMenuItem('media', { icon: 'embed', text: 'Media...', onAction: t, onSetup: he(e) });
            })(e),
            ((e) => {
                e.on('ResolveName', (e) => {
                    let t;
                                    ...
                                    (r = t[o]),
                                        r.parent &&
                                            (r.parent.attr('data-mce-object') ||
                                                (ae(r) && v(e) ? ue(r) || r.replace(le(e, r)) : ue(r) || r.replace(ne(e, r))));
                            })(e)
                        ),
