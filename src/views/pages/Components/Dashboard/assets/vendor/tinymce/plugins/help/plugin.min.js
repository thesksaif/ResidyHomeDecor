    ...
    const S = (e) => {
        ...
        x = y(
            [
                ...
                { key: 'advtemplate', name: 'Advanced Templates', type: 'premium', slug: 'advanced-templates' },
                ...
                { key: 'rtc', name: 'Real-Time Collaboration', type: 'premium', slug: 'rtc-introduction' },
                { key: 'tinymcespellchecker', name: 'Spell Checker Pro', type: 'premium', slug: 'introduction-to-tiny-spellchecker' },
        ...
        _ = (e) => {
            const t = (e) => `<a data-alloy-tabstop="true" tabindex="-1" href="${e.url}" target="_blank" rel="noopener">${e.name}</a>`,
                n = (e, n) => {
                    return ((a = x),
                    (r = (e) => e.key === n),
                    ((e, t, n) => {
                        ...
                        (e) => {
                            ...
                            return { name: n, html: t({ name: n, url: `https://www.tiny.cloud/docs/tinymce/6/${e.slug}/` }) };
                        }
                    );
                    var a, r;
                },
                a = (e) => {
                    const t = ((e) => {
                        ...
                        i = r.length,
                        l = r.join('');
                    return '<p><b>' + f.translate(['Plugins installed ({0}):', i]) + '</b></p><ul>' + l + '</ul>';
                },
                r = {
                    type: 'htmlpanel',
                    presets: 'document',
