...
!(function () {
    ...
    const L = (e) => (t) => ((e) => e.dom.nodeType)(t) === e,
        ...
        z = (e) => {
            ...
            return _(R(t)).fold(() => n.body.contains(t), ((r = z), (o = j), (e) => r(o(e))));
            var r, o;
        },
        $ = (e, t) => {
                    ...
                    ((e) => {
                        if (B() && u(e.target)) {
                            ...
                            if (M(t) && u(t.dom.shadowRoot) && e.composed && e.composedPath) {
                                ...
                                if (t) return ((e, t) => (0 < e.length ? w.some(e[0]) : w.none()))(t);
                            }
                        }
        ...
        oe = [
            ...
            { name: 'Opera', versionRegexes: [ne, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: re('opera') },
            { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: re('firefox') },
            {
                name: 'Safari',
        ...
        se = [
            { name: 'Windows', search: re('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
            {
                name: 'iOS',
            ...
            { name: 'Android', search: re('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
            { name: 'macOS', search: re('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
            ...
            { name: 'ChromeOS', search: re('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] }
        ],
                        ...
                        .bind((e) =>
                            ((e, t) =>
                                ((e, t) => {
                                    ...
                                    }).map((e) => ({ current: e.name, version: ee.nu(parseInt(t.version, 10), 0) }));
                                }))(r, e)
                        )
                        .orThunk(() =>
                            ((e, t) =>
    ...
    const Ce = (e, t) => ({ left: e, top: t, translate: (n, r) => Ce(e + n, t + r) }),
        Ae = Ce,
        Re = (e) => {
            const t = void 0 === e ? window : e;
            return ke().browser.isFirefox() ? w.none() : w.from(t.visualViewport);
        },
        Le = (e, t, n, r) => ({ x: e, y: t, width: n, height: r, right: e + n, bottom: t + r }),
        Me = (e) => {
            const t = void 0 === e ? window : e,
                n = t.document,
                r = ((e) => {
    ...
    const He = (e) => {
        ...
        Ke = Re().fold(
            ...
            (e) => {
                ...
                return {
                    bind: (e) => {
                        t.set(e), o.throttle(), n.set(Ne('resize', o.throttle)), r.set(Ne('scroll', o.throttle));
                    },
                    unbind: () => {
                        t.on(() => {
                            n.clear(), r.clear();
                ...
                y = () => {
                    h &&
                        ((e) => {
                            ...
                            E(t, (t) => {
                                const n = $(t, Ve);
                                n && 'no-styles' !== n ? K(t, e.parseStyle(n)) : U(t, 'style'), U(t, Ve);
                            });
                        })(e.dom),
                        v(Ue.removeClass),
                        Ke.unbind(),
                ...
                h &&
                    ((e, t, n) => {
                        const r = (t) => (n) => {
                            ...
                            c = $e(n);
                        E(l, r('display:none!important;')), E(o, r(_e + je + c)), r((!0 === ze ? '' : _e) + je + c)(t);
                    })(e.dom, l, d),
