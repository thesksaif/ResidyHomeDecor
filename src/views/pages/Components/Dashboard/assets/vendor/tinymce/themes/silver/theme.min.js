...
!(function () {
    ...
    const M = Array.prototype.slice,
        ...
        st = (e) => A.from(e.dom.parentNode).map(Ve),
        rt = (e) => A.from(e.dom.parentElement).map(Ve),
        ...
        yt = (e) => {
            ...
            return bt(Ve(t)).fold(() => o.body.contains(t), ((n = yt), (s = vt), (e) => n(s(e))));
            var n, s;
        },
        xt = () => wt(Ve(document)),
        wt = (e) => {
        ...
        Wt = (e) => Ut.get(e),
        jt = (e) => Ut.getOuter(e),
        Gt = (e, t) => ({ left: e, top: t, translate: (o, n) => Gt(e + o, t + n) }),
        $t = Gt,
        ...
        Xt = (e) => {
            ...
            const r = qt(null == n ? void 0 : n.pageYOffset, s.scrollTop),
        ...
        Kt = Pt('width', (e) => e.dom.offsetWidth),
        Jt = (e) => Kt.get(e),
        Zt = (e) => Kt.getOuter(e),
        Qt = (e) => {
            let t,
        ...
        ao = [
            ...
            { name: 'Opera', versionRegexes: [so, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: ro('opera') },
            { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: ro('firefox') },
            {
                name: 'Safari',
        ...
        io = [
            { name: 'Windows', search: ro('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
            {
                name: 'iOS',
            ...
            { name: 'Android', search: ro('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
            { name: 'macOS', search: ro('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
            { name: 'Linux', search: ro('linux'), versionRegexes: [] },
            { name: 'Solaris', search: ro('sunos'), versionRegexes: [] },
            { name: 'FreeBSD', search: ro('freebsd'), versionRegexes: [] },
            { name: 'ChromeOS', search: ro('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] }
        ],
        lo = { browsers: x(ao), oses: x(io) },
        co = 'Edge',
        uo = 'Chromium',
        mo = 'Opera',
        go = 'Firefox',
        ...
        fo = () => ho({ current: void 0, version: oo.unknown() }),
        bo = ho,
        ...
        _o = () => Oo({ current: void 0, version: oo.unknown() }),
        To = Oo,
    ...
    const Do = () => Mo(),
        ...
        Fo = (e, t, o, n, s) => {
            ...
            return e.dom.addEventListener(t, r, s), { unbind: k(Io, e, t, r, s) };
        },
        Io = (e, t, o, n) => {
        ...
        jo = (e, t, o, n) => ({ x: e, y: t, width: o, height: n, right: e + o, bottom: t + n }),
        Go = (e) => {
    ...
    var Xo = Object.freeze({
        ...
        view: (e) => {
            var t;
            return (e.dom === document ? A.none() : A.from(null === (t = e.dom.defaultView) || void 0 === t ? void 0 : t.frameElement)).map(
                Ve
            );
        },
        owner: (e) => et(e)
    ...
    const Yo = (e) => {
        ...
        Ko = (e, t, o, n) => ({ x: e, y: t, width: o, height: n, right: e + o, bottom: t + n }),
        Jo = (e) => {
            const t = Xt(e),
                o = Zt(e),
                n = jt(e);
    ...
    const on = (e) => {
        ...
        sn = { value: on, error: nn, fromOption: (e, t) => e.fold(() => nn(t), on) };
    var rn;
    !(function (e) {
        (e[(e.Error = 0)] = 'Error'), (e[(e.Value = 1)] = 'Value');
    })(rn || (rn = {}));
    const an = (e, t, o) => (e.stype === rn.Error ? t(e.serror) : o(e.svalue)),
        ln = (e) => ({ stype: rn.Value, svalue: e }),
        cn = (e) => ({ stype: rn.Error, serror: e }),
        dn = ln,
        un = cn,
        mn = an,
        gn = (e, t, o, n) => ({ tag: 'field', key: e, newKey: t, presence: o, prop: n }),
        pn = (e, t, o) => {
            switch (e.tag) {
                case 'field':
        ...
        bn = hn((e, t) => t),
        vn = (e) => ({ tag: 'defaultedThunk', process: e }),
        yn = (e) => vn(x(e)),
        xn = (e) => ({ tag: 'mergeWithThunk', process: e }),
        wn = (e) => {
            const t = ((e) => {
                const t = [],
                    o = [];
        ...
        kn = (e, t) => un([{ path: e, getErrorInfo: t }]),
        Cn = (e) => ({
            extract: (t, o) => ((e, t) => (e.stype === rn.Error ? t(e.serror) : e))(e(o), (e) => ((e, t) => kn(e, x(t)))(t, e)),
            toString: x('val')
        }),
        On = Cn(dn),
        ...
        Tn = (e, t, o, n, s) => {
            const r = (e) => s.extract(t.concat([n]), e),
                a = (e) =>
                    e.fold(
                        () => dn(A.none()),
                        (e) =>
                            ((e, t) => (e.stype === rn.Value ? { stype: rn.Value, svalue: t(e.svalue) } : e))(
            ...
            switch (e.tag) {
                case 'required':
                    return ((e, t, o, n) =>
                        be(t, o).fold(
                            () => ((e, t, o) => kn(e, () => 'Could not find valid *required* value for "' + t + '" in ' + Sn(o)))(e, o, t),
                            n
                        ))(t, o, n, r);
                case 'defaultedThunk':
        ...
        En = (e) => ({ extract: (t, o) => e().extract(t, o), toString: () => e().toString() }),
        An = (e) => ae(ge(e, g)),
        Mn = (e) => {
            const t = Dn(e),
                o = W(e, (e, t) => pn(t, (t) => fn(e, { [t]: !0 }), x(e)), {});
            return {
                extract: (e, n) => {
                    const s = d(n) ? [] : An(n),
                        r = U(s, (e) => !ye(o, e));
                    return 0 === r.length
                        ? t.extract(e, n)
                        : ((e, t) => kn(e, () => 'There are unsupported fields: [' + t.join(', ') + '] specified'))(e, r);
                },
                toString: t.toString
            };
        },
            ...
            return {
                extract: (t, n) => {
                    ...
                    for (const r of e) {
                        ...
                        if (e.stype === rn.Value) return { stype: rn.Value, svalue: o(e.svalue) };
                        s.push(e);
                    }
                    return wn(s);
                },
        ...
        In = (e, t) => ({
            extract: (o, n) => {
                const s = ae(n),
                    r = ((t, o) => Bn(Cn(e)).extract(t, o))(o, s);
                return ((e, t) => (e.stype === rn.Value ? t(e.svalue) : e))(r, (e) => {
                    const s = H(e, (e) => gn(e, e, { tag: 'required', process: {} }, t));
        ...
        jn = (e, t) => ({
            extract: (o, n) =>
                be(n, e).fold(
                    () => ((e, t) => kn(e, () => 'Choice schema did not contain choice key: "' + t + '"'))(o, e),
                    (e) =>
                        ((e, t, o, n) =>
                            be(o, n).fold(
                                () =>
                                    ((e, t, o) => kn(e, () => 'The chosen schema: "' + o + '" did not exist in branches: ' + Sn(t)))(
                                        e,
                                        o,
                                        n
                                    ),
        ...
        qn = (e, t, o) => {
            return (
                (n = ((e, t, o) =>
                    ((e, t) => (e.stype === rn.Error ? { stype: rn.Error, serror: t(e.serror) } : e))(t.extract([e], o), (e) => ({
                        input: o,
                        errors: e
                    })))(e, t, o)),
                an(n, sn.error, sn.value)
            );
            var n;
        },
        Xn = (e) =>
        ...
        Yn = (e, t, o) => Xn(qn(e, t, o)),
        Kn = (e) =>
            'Errors: \n' +
            ((e) => {
                const t =
                    e.length > 10 ? e.slice(0, 10).concat([{ path: [], getErrorInfo: x('... (only showing first ten failures)') }]) : e;
        ...
        Qn = gn,
        es = (e, t) => ({ tag: 'custom', newKey: e, instantiator: t }),
        ts = (e) => Gn((t) => (R(e, t) ? sn.value(t) : sn.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`))),
        os = (e) => Qn(e, e, { tag: 'required', process: {} }, Nn()),
        ns = (e, t) => Qn(e, e, { tag: 'required', process: {} }, t),
        ss = (e) => ns(e, zn),
        rs = (e) => ns(e, Hn),
        as = (e, t) => Qn(e, e, { tag: 'required', process: {} }, ts(t)),
        is = (e) => ns(e, Pn),
        ls = (e, t) => Qn(e, e, { tag: 'required', process: {} }, Dn(t)),
        cs = (e, t) => Qn(e, e, { tag: 'required', process: {} }, Rn(t)),
        ds = (e, t) => Qn(e, e, { tag: 'required', process: {} }, Bn(t)),
        us = (e) => Qn(e, e, { tag: 'option', process: {} }, Nn()),
        ms = (e, t) => Qn(e, e, { tag: 'option', process: {} }, t),
        gs = (e) => ms(e, zn),
        ps = (e) => ms(e, Hn),
        hs = (e, t) => ms(e, ts(t)),
        fs = (e) => ms(e, Pn),
        bs = (e, t) => ms(e, Bn(t)),
        vs = (e, t) => ms(e, Dn(t)),
        ys = (e, t) => Qn(e, e, yn(t), Nn()),
        xs = (e, t, o) => Qn(e, e, yn(t), o),
        ws = (e, t) => xs(e, t, zn),
        Ss = (e, t) => xs(e, t, Hn),
        ks = (e, t, o) => xs(e, t, ts(o)),
        Cs = (e, t) => xs(e, t, Ln),
        Os = (e, t) => xs(e, t, Pn),
        _s = (e, t, o) => xs(e, t, Bn(o)),
        Ts = (e, t, o) => xs(e, t, Dn(o)),
        Es = (e) => {
            let t = e;
            return {
                get: () => t,
                ...
                L(e, (n, s) => {
                    ...
                    t.push(a),
                        (o[a] = (...o) => {
                            ...
                            if (n !== i.length)
                                throw new Error(
                                    'Wrong number of arguments to case ' + a + '. Expected ' + i.length + ' (' + i + '), got ' + n
                                );
                            return {
                                fold: (...t) => {
    ...
    const Ms = (e, t) => ((e, t) => ({ [e]: t }))(e, t),
        ...
        Rs = (e, t) => Ze(e.element, t.event.target),
        Ns = { can: E, abort: T, run: b },
        Vs = (e) => {
            ...
            Ur(e, (e, o) => {
                const n = o.event,
                    s = e
                        .getSystem()
                        .getByDom(n.target)
                        .getOrThunk(() => Is(n.target, (t) => e.getSystem().getByDom(t).toOptional(), T).getOr(e));
                t(e, s, o);
            }),
        qr = (e) =>
            Ur(e, (e, t) => {
    ...
    var ra,
        aa = Object.freeze({ __proto__: null, events: sa });
    let ia = 0;
    const la = (e) => {
        ...
        ma = da(),
        ga = (e, t) => {
            Object.defineProperty(e.dom, ma, { value: t, writable: !0 });
        },
        pa = (e) => {
        ...
        va = ba(),
        ya = (e) => H(e, (e) => (Ae(e, '/*') ? e.substring(0, e.length - 2) : e)),
        xa = (e, t) => {
            const o = e.toString(),
                n = o.indexOf(')') + 1,
                s = o.indexOf('('),
                r = o.substring(s + 1, n - 1).split(/,\s*/);
            return (e.toFunctionAnnotation = () => ({ name: t, parameters: ya(r) })), e;
        },
        wa = la('alloy-premade'),
        Sa = (e) => (Object.defineProperty(e.element.dom, wa, { value: e.uid, writable: !0 }), Ms(wa, e)),
        ka = (e) => be(e, wa),
        Ca = (e) =>
            ((e, t) => {
                const o = t.toString(),
                    ...
                    s = o.indexOf('('),
                    r = o.substring(s + 1, n - 1).split(/,\s*/);
                return (e.toFunctionAnnotation = () => ({ name: 'OVERRIDE', parameters: ya(r.slice(1)) })), e;
            })((t, ...o) => e(t.getApis(), t, ...o), e),
        Oa = { init: () => _a({ readState: x('No State required') }) },
        _a = (e) => e,
        Ta = (e, t) => {
            const o = {};
            return (
        ...
        Fa = (e, t) =>
            ((e, t) => {
                ...
                return o.errors.length > 0
                    ? ((n = o.errors), sn.error(q(n)))
                    : ((e, t) => (0 === e.length ? sn.value(t) : sn.value(fn(t, bn.apply(void 0, e)))))(o.values, t);
                var n;
            })(
                pe(e, (e, o) =>
                    (1 === e.length ? sn.value(e[0].handler) : Ba(e, t, o)).map((n) => {
                        const s = ((e) => {
                        ...
                        return Ms(o, ((e, t) => ({ handler: e, purpose: t }))(s, r));
                    })
                ),
                {}
            ),
        ...
        Ra = Dn([
            Qn(
                ...
                Dn([os('tag'), ys('styles', {}), ys('classes', []), ys('attributes', {}), us('value'), us('innerHtml')])
            ),
            os('components'),
            os('uid'),
            ys('events', {}),
            ...
            Qn(
                ...
                'eventOrder',
                ((ii = {
                    [ur()]: ['disabling', Ia, 'toggling', 'typeaheadevents'],
                    [ir()]: [Ia, 'focusing', 'keying'],
                    [br()]: [Ia, 'disabling', 'toggling', 'representing'],
                    [Zs()]: [Ia, 'representing', 'streaming', 'invalidating'],
                    [kr()]: [Ia, 'representing', 'item-events', 'tooltipping'],
                    [Ws()]: ['focusing', Ia, 'item-type-events'],
                    [Hs()]: ['focusing', Ia, 'item-type-events'],
                    [qs()]: ['item-type-events', 'tooltipping'],
                    [dr()]: ['receiving', 'reflecting', 'tooltipping']
                }),
                xn(x(ii))),
                Nn()
            ),
        ...
        Za = (e, t) => {
            const { class: o, style: n, ...s } = ((e) => j(e.dom.attributes, (e, t) => ((e[t.name] = t.value), e), {}))(t),
                { toSet: r, toRemove: a } = Ja(e.attributes, s),
                i = Vt(t),
                { toSet: l, toRemove: c } = Ja(e.styles, i),
                d = ((e) =>
                    za(e)
                        ? ((e) => {
        ...
        Qa = (e) => {
            ...
            return ((e, t) =>
                ((e, t) => {
                    const o = H(t, (e) => vs(e.name(), [os('config'), ys('state', Oa)])),
        ...
        ei = (e, t) => {
            const o = () => m,
                n = Es(va),
                s = Xn(((e) => qn('custom.definition', Ra, e))(e)),
                r = Qa(e),
                a = ((e) => e.list)(r),
                i = ((e) => e.data)(r),
                l = ((e, t, o) => {
                    const n = { ...(s = e).dom, uid: s.uid, domChildren: H(s.components, (e) => e.element) };
                    var s;
                    const r = ((e) => e.domModification.fold(() => Ea({}), Ea))(e),
                        ...
                        i =
                            t.length > 0
                                ? ((e, t, o, n) => {
                                      ...
                                      const r = Ta(s, (e, t) => ({ name: e, modification: t })),
                                          a = (e) => W(e, (e, t) => ({ ...t.modification, ...e }), {}),
                                          i = W(r.classes, (e, t) => t.modification.concat(e), []),
                                          l = a(r.attributes),
                                          c = a(r.styles);
                                      return Ea({ classes: i, attributes: l, styles: c });
                                  })(o, a, t, n)
                                : r;
                    return (
                        (l = n),
                ...
                d = ((e, t, o) => {
                    const n = { 'alloy.base.behaviour': Na(e) };
                    return ((e, t, o, n) => {
                        const s = ((e, t, o) => {
                            const n = { ...o, ...Da(t, e) };
                            return Ta(n, Ma);
        ...
        oi = (e) => {
            const t = Yn('external.component', Mn([os('element'), us('uid')]), e),
                o = Es(ba()),
        ...
        si = (e, t) =>
            ka(e).getOrThunk(() =>
                ((e, t) => {
                    const { events: o, ...n } = fa(e),
                        s = ((e, t) => {
                            const o = be(e, 'components').getOr([]);
                            return t.fold(
                                () => H(o, ri),
                                (e) => H(o, (t, o) => si(t, lt(e, o)))
                            );
                        })(n, t),
                        r = { ...n, events: { ...aa, ...o }, components: s };
                    return sn.value(ei(r, t));
                })(((e) => ve(e, 'uid'))(e) ? e : { uid: ni(''), ...e }, t).getOrDie()
            ),
        ri = (e) => si(e, A.none()),
        ai = Sa;
    var ii,
        li = (e, t, o, n, s) => (e(o, n) ? A.some(o) : p(s) && s(o) ? A.none() : t(o, n, s));
    const ci = (e, t, o) => {
            let n = e.dom;
            const s = p(o) ? o : T;
            for (; n.parentNode; ) {
        ...
        hi = (e, t, o) => li((e, t) => Ke(e, t), mi, e, t, o),
        fi = 'aria-controls',
        bi = () => {
            const e = la(fi);
            return {
    ...
    const xi = Es({}),
            ...
            ((e, t, o) => {
                switch (
                    be(xi.get(), e)
                        .orThunk(() => {
                            const t = ae(xi.get());
                            return re(t, (t) => (e.indexOf(t) > -1 ? A.some(xi.get()[t]) : A.none()));
                        })
                        .getOr(yi.NORMAL)
                ) {
                    case yi.NORMAL:
                        ...
                        const n = ((e, t) => {
                                ...
                                return {
                                    ...
                                    write: () => {
                                        ...
                                        R(['mousemove', 'mouseover', 'mouseout', br()], e) ||
                                            console.log(e, {
                                                event: e,
                                                time: s - n,
                                                target: t.dom,
                                                sequence: H(o, (e) =>
                                                    R(['cut', 'stopped', 'response'], e.outcome)
                                                        ? '{' + e.purpose + '} ' + e.outcome + ' at (' + na(e.target) + ')'
                                                        : e.outcome
                                                )
                                            });
                                    }
        ...
        ki = x({ logEventCut: b, logEventStopped: b, logNoParent: b, logEventNoHandlers: b, logEventResponse: b, write: b }),
        Ci = x([os('menu'), os('selectedMenu')]),
        Oi = x([os('item'), os('selectedItem')]);
    x(Dn(Oi().concat(Ci())));
    const _i = x(Dn(Oi())),
        Ti = ls('initSize', [os('numColumns'), os('numRows')]),
        Ei = () => ls('markers', [os('backgroundMenu')].concat(Ci()).concat(Oi())),
        Ai = (e) => ls('markers', H(e, os)),
        Mi = (e, t, o) => (
            (() => {
                const e = new Error();
                if (void 0 !== e.stack) {
            ...
            Qn(
                ...
                t,
                o,
                Gn((e) => sn.value((...t) => e.apply(void 0, t)))
            )
        ),
        Di = (e) => Mi(0, e, yn(b)),
        Bi = (e) => Mi(0, e, yn(A.none)),
        Fi = (e) => Mi(0, e, { tag: 'required', process: {} }),
        Ii = (e) => Mi(0, e, { tag: 'required', process: {} }),
        Ri = (e, t) => es(e, x(t)),
        Ni = (e) => es(e, w),
        Vi = x(Ti),
        zi = (e, t, o, n, s, r, a, i = !1) => ({
            x: e,
            y: t,
            bubble: o,
            direction: n,
        ...
        Yi = (e, t, o) => Math.min(Math.max(e, t), o),
        Ki = (e, t) =>
        ...
        sl = (e, t, o) => zi(Zi(e), ol(e), o.southeast(), Li(), 'southeast', Ki(e, { left: 1, top: 3 }), Ji),
        rl = (e, t, o) => zi(el(e, t), ol(e), o.southwest(), Pi(), 'southwest', Ki(e, { right: 0, top: 3 }), Ji),
        al = (e, t, o) => zi(Zi(e), tl(e, t), o.northeast(), Ui(), 'northeast', Ki(e, { left: 1, bottom: 2 }), Ji),
        il = (e, t, o) => zi(el(e, t), tl(e, t), o.northwest(), Wi(), 'northwest', Ki(e, { right: 0, bottom: 2 }), Ji),
        ll = (e, t, o) => zi(Qi(e, t), tl(e, t), o.north(), Gi(), 'north', Ki(e, { bottom: 2 }), Ji),
        cl = (e, t, o) => zi(Qi(e, t), ol(e), o.south(), ji(), 'south', Ki(e, { top: 3 }), Ji),
        dl = (e, t, o) => zi(((e) => e.x + e.width)(e), nl(e, t), o.east(), $i(), 'east', Ki(e, { left: 0 }), Ji),
        ul = (e, t, o) => zi(((e, t) => e.x - t.width)(e, t), nl(e, t), o.west(), qi(), 'west', Ki(e, { right: 1 }), Ji),
        ml = () => [sl, rl, al, il, cl, ll, dl, ul],
        gl = () => [rl, sl, il, al, cl, ll, dl, ul],
        pl = () => [al, il, sl, rl, ll, cl],
        hl = () => [il, al, rl, sl, ll, cl],
        fl = () => [sl, rl, al, il, cl, ll],
        bl = () => [rl, sl, il, al, cl, ll];
    ...
    const xl = (e, t, o) =>
        ...
        Sl = (e, t, o, n, s, r, a) => {
            const i = (e) => (ye(e, o) ? e[o]() : A.none()),
                l = ce(s, (e, t) =>
                    ((e, t, o) =>
                        ((e, t, o) => {
                            ...
                            return (e.toFunctionAnnotation = () => ({ name: t, parameters: ya(a.slice(0, 1).concat(a.slice(3))) })), e;
                        })(
                            (n, ...s) => {
                                const r = [n].concat(s);
                ...
                c = {
                    ...
                    revoke: k(wl, o),
                    config: (t) => {
                        const n = Yn(o + '-config', e, t);
                        return {
                            key: o,
                            value: { config: n, me: c, configAsRaw: Qt(() => Yn(o + '-config', e, t)), initialConfig: t, state: a }
                        };
                    },
                    schema: x(t),
        ...
        Ol = (e) => {
            const t = Yn('Creating behaviour: ' + e.name, Cl, e);
            return ((e, t, o, n, s, r) => {
                const a = Mn(e),
        ...
        Tl = (e) => {
            const t = Yn('Creating behaviour: ' + e.name, _l, e);
            return ((e, t, o, n, s, r) => {
                const a = e,
                    i = vs(t, [ms('config', e)]);
                return Sl(a, i, t, o, n, s, r);
        ...
        El = x(void 0),
        Al = Ol({ fields: yl, name: 'receiving', active: vl });
    var Ml = Object.freeze({
        __proto__: null,
        exhibit: (e, t) => Ea({ classes: [], styles: t.useFixed() ? {} : { position: 'relative' } })
    });
    const Dl = (e) => e.dom.focus(),
        ...
        Hl = As([{ none: [] }, { relative: ['x', 'y', 'width', 'height'] }, { fixed: ['x', 'y', 'width', 'height'] }]),
        Ll = (e, t, o, n, s, r) => {
            const a = t.rect,
                i = a.x - o,
                l = a.y - n,
        ...
        Pl = (e, t) =>
            e.fold(
                ...
                (e, o, n, s) => Ll('absolute', t, e, o, n, s),
                (e, o, n, s) => Ll('fixed', t, e, o, n, s)
            ),
        Ul = (e, t) => {
            const o = k(Yo, t),
                n = e.fold(o, o, () => {
    ...
    const Gl = Hl.relative,
        ...
        Xl = (e) => _t(e, ql),
        Yl = As([{ fit: ['reposition'] }, { nofit: ['reposition', 'visibleW', 'visibleH', 'isVisible'] }]),
        Kl = (e, t, o, n) => {
            const s = e.bubble,
                r = s.offset,
                a = ((e, t, o) => {
                                    ...
                                    const a = (t) => {
                                        ...
                                        i = (r) => {
                                            if (m(r) || a(r)) {
                                                ...
                                                (m(a) || a === or()) && (clearTimeout(s), Et(e, rc), ja(e, t.classes));
                                            }
                                        },
                                        l = tc(e, nr(), (t) => {
        ...
        lc = x((e, t) => {
            ic(e, t), Bt(e, { 'overflow-x': 'hidden', 'overflow-y': 'auto' });
        }),
        cc = x((e, t) => {
            ic(e, t);
        }),
        ...
        uc = (e, t, o, n) => {
            const s = ((e, t, o, n) => {
                ...
                const s = { width: Zt((r = t)), height: jt(r) };
                var r;
                return ((e, t, o, n, s, r) => {
                    const a = n.width,
                        i = n.height,
                        l = (t, l, c, d, u) => {
                            const m = t(o, n, s, e, r),
                                g = Kl(m, a, i, r);
                            return g.fold(x(g), (e, t, o, n) => ((u === n ? o > d || t > c : !u && n) ? g : Yl.nofit(l, c, d, u)));
                        };
                    return j(
                        t,
                        (e, t) => {
        ...
        gc = (e, t, o, n = 1) => {
            const s = e * n,
                ...
                i = (e, t, o) => {
                    const n = J(mc, o);
                    return { offset: $t(e, t), classesOn: X(o, a), classesOff: X(n, a) };
                };
            return {
    ...
    const yc = 'data-alloy-vertical-dir',
        ...
        wc = () => vs('layouts', [os('onLtr'), os('onRtl'), us('onBottomLtr'), us('onBottomRtl')]),
        Sc = (e, t, o, n, s, r, a) => {
    ...
    var kc = [
            ...
            Ri('placement', (e, t, o) => {
                ...
                return A.some(hc({ anchorBox: s, bubble: t.bubble.getOr(pc()), overrides: t.overrides, layouts: r }));
            })
        ],
        Cc = [
            os('x'),
            ...
            Ri('placement', (e, t, o) => {
                ...
                return A.some(hc({ anchorBox: s, bubble: t.bubble, overrides: t.overrides, layouts: r }));
            })
        ];
    const Oc = As([{ screen: ['point'] }, { absolute: ['point', 'scrollLeft', 'scrollTop'] }]),
        ...
        Ic = (e, t, o, n, s) =>
            e.map((e) => {
                ...
                var p, h, f, b;
                return hc({ anchorBox: d, bubble: o.bubble.getOr(pc()), overrides: o.overrides, layouts: g });
            });
    var Rc = [
        os('node'),
        os('root'),
        ...
        Ri('placement', (e, t, o) => {
            const n = Bc(e, 0, t);
            return t.node.filter(yt).bind((s) => {
    ...
    const Nc = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
        Vc = As([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
        zc = (Vc.before, Vc.on, Vc.after, (e) => e.fold(w, w, w)),
        Hc = As([{ domRange: ['rng'] }, { relative: ['startSitu', 'finishSitu'] }, { exact: ['start', 'soffset', 'finish', 'foffset'] }]),
        Lc = {
            ...
            getWin: (e) => {
                const t = ((e) => e.match({ domRange: (e) => Ve(e.startContainer), relative: (e, t) => zc(e), exact: (e, t, o, n) => e }))(
                    e
                );
                return nt(t);
            },
        ...
        Wc = (e) => ({ left: e.left, top: e.top, right: e.right, bottom: e.bottom, width: e.width, height: e.height }),
        jc = As([{ ltr: ['start', 'soffset', 'finish', 'foffset'] }, { rtl: ['start', 'soffset', 'finish', 'foffset'] }]),
            ...
            ((e, t) => {
                const o = ((e, t) =>
                    t.match({
                        ...
                        relative: (t, o) => ({ ltr: Qt(() => Pc(e, t, o)), rtl: Qt(() => A.some(Pc(e, o, t))) }),
                        exact: (t, o, n, s) => ({ ltr: Qt(() => Uc(e, t, o, n, s)), rtl: Qt(() => A.some(Uc(e, n, s, t, o))) })
                    }))(e, t);
                return ((e, t) => {
                    const o = t.ltr();
                    return o.collapsed
                        ? t
                              ...
                              .map((e) => jc.rtl(Ve(e.endContainer), e.endOffset, Ve(e.startContainer), e.startOffset))
                              .getOrThunk(() => Gc(0, jc.ltr, o))
                        : Gc(0, jc.ltr, o);
                })(0, o);
            })(e, t).match({
                ltr: (t, o, n, s) => {
                ...
                : ((e, t) => {
                      ...
                      if (t < o.length) return Qc(o[t], 0);
                      {
                          const e = o[o.length - 1],
                              t = $e(e) ? ((e) => Zc.get(e))(e).length : it(e).length;
                          return Qc(e, t);
                      }
                  })(e, t),
        td = (e) => void 0 !== e.foffset,
        od = (e, t) =>
            t.getSelection
                .getOrThunk(
                    () => () =>
                ...
                .map((e) => {
                    if (td(e)) {
                        const t = ed(e.start, e.soffset),
                            o = ed(e.finish, e.foffset);
            ...
            const n = nt(t.root).dom,
                ...
                r = od(n, t).bind((e) => {
                    ...
                    }
                    {
                        ...
                        return Fc(o.left, o.top, o.right - o.left, o.bottom - o.top);
                    }
                }),
                a = od(n, t)
                    .bind((e) => (td(e) ? (Ge(e.start) ? A.some(e.start) : rt(e.start)) : A.some(e.firstCell)))
                    .getOr(e.element);
            return Ic(r, s, t, o, a);
        })
    ];
    const sd = 'link-layout',
        rd = (e) => e.x + e.width,
        ad = (e, t) => e.x - t.width,
        id = (e, t) => e.y - t.height + e.height,
        ld = (e) => e.y,
        cd = (e, t, o) => zi(rd(e), ld(e), o.southeast(), Li(), 'southeast', Ki(e, { left: 0, top: 2 }), sd),
        dd = (e, t, o) => zi(ad(e, t), ld(e), o.southwest(), Pi(), 'southwest', Ki(e, { right: 1, top: 2 }), sd),
        ud = (e, t, o) => zi(rd(e), id(e, t), o.northeast(), Ui(), 'northeast', Ki(e, { left: 0, bottom: 3 }), sd),
        md = (e, t, o) => zi(ad(e, t), id(e, t), o.northwest(), Wi(), 'northwest', Ki(e, { right: 1, bottom: 3 }), sd),
        gd = () => [cd, dd, ud, md],
        pd = () => [dd, cd, md, ud];
    var hd = [
            os('item'),
            ...
            Ri('placement', (e, t, o) => {
                ...
                return A.some(hc({ anchorBox: n, bubble: pc(), overrides: t.overrides, layouts: s }));
            })
        ],
        fd = Jn('type', { selection: nd, node: Rc, hotspot: kc, submenu: hd, makeshift: Cc });
    const bd = [ds('classes', Hn), ks('mode', 'all', ['all', 'layout', 'placement'])],
        vd = [ys('useFixed', T), us('getBounds')],
        yd = [ns('anchor', fd), vs('transition', bd)],
        xd = (e, t, o, n, s, r) => {
            const a = Yn('placement.info', Dn(yd), s),
                i = a.anchor,
                l = n.element,
                c = o.get(n.uid);
            Nl(() => {
                Dt(l, 'position', 'fixed');
                const s = Nt(l, 'visibility');
    ...
    var wd = Object.freeze({
        ...
        reset: (e, t, o, n) => {
            const s = n.element;
            L(['position', 'left', 'right', 'top', 'bottom'], (e) => Ht(s, e)),
                ((e) => {
                    Et(e, ql);
                })(s),
                o.clear(n.uid);
    ...
    const Sd = Ol({
        ...
        Bd = (e) => {
            const t = st(e.element).bind((t) => e.getSystem().getByDom(t).toOptional());
            Dd(e),
                t.each((e) => {
                    e.syncComponents();
                });
        ...
        Ud = (e, t, o) => {
            ...
            Dt(e.element, 'position', Sd.getMode(n)),
                ((e, t, o, n) => {
                    Nt(e.element, t).fold(
                        () => {
                            Et(e.element, o);
        ...
        Wd = (e, t, o) => {
            ((e) => N(['top', 'left', 'right', 'bottom'], (t) => Nt(e, t).isSome()))(e.element) || Ht(e.element, 'position'),
                ((e, t, o) => {
                    _t(e.element, o).fold(
                        () => Ht(e.element, t),
                        (o) => Dt(e.element, t, o)
    ...
    var jd = Object.freeze({
            ...
            close: Ld,
            isOpen: Pd,
            isPartOf: (e, t, o, n) => Pd(0, 0, o) && o.get().exists((o) => t.isPartOf(e, o, n)),
            getState: (e, t, o) => o.get(),
            setContent: (e, t, o, n) => o.get().map(() => zd(e, t, o, n))
        }),
        Gd = Object.freeze({
            __proto__: null,
            events: (e, t) =>
        ...
        qd = Object.freeze({
            ...
            init: () => {
                const e = Ql(),
                    t = x('not-implemented');
                return _a({ readState: t, isOpen: e.isSet, clear: e.clear, set: e.set, get: e.get });
            }
        });
    const Xd = Ol({ fields: $d, name: 'sandboxing', active: Gd, apis: jd, state: qd }),
        Yd = x('dismiss.popups'),
        Kd = x('reposition.popups'),
        Jd = x('mouse.released'),
        Zd = Mn([ys('isExtraPart', T), vs('fireEventInstead', [ys('event', Cr())])]),
        Qd = (e) => {
            const t = Yn('Dismissal', Zd, e);
            return {
                [Yd()]: {
                    schema: Mn([os('target')]),
                    onReceive: (e, o) => {
                        Xd.isOpen(e) &&
                            (Xd.isPartOf(e, o.target) ||
    ...
    var du = [
        ...
        gu = [xs('store', { mode: 'memory' }, Jn('mode', { memory: mu, manual: uu, dataset: du })), Di('onSetValue'), ys('resetOnDom', !1)];
    const pu = Ol({
            fields: gu,
            name: 'representing',
            active: ru,
        ...
        yu = bu,
        xu = 'placeholder',
        wu = As([{ single: ['required', 'valueThunk'] }, { multiple: ['required', 'valueThunks'] }]),
        Su = (e) => ve(e, 'uiType'),
        ku = (e, t, o, n) =>
            ((e, t, o, n) =>
                Su(o) && o.uiType === xu
                    ...
                    : wu.single(!1, x(o)))(e, 0, o, n).fold(
                (s, r) => {
                    const a = Su(o) ? r(t, o.config, o.validated) : r(t),
        ...
        Ou = wu.multiple,
        _u = x(xu),
        Tu = As([{ required: ['data'] }, { external: ['data'] }, { optional: ['data'] }, { group: ['data'] }]),
        Eu = ys('factory', { sketch: w }),
        Au = ys('schema', []),
        Mu = os('name'),
        Du = Qn(
            'pname',
            'pname',
            vn((e) => '<alloy.' + la(e.name) + '>'),
            Nn()
        ),
        Bu = es('schema', () => [us('preprocess')]),
        Fu = ys('defaults', x({})),
        Iu = ys('overrides', x({})),
        ...
        Hu = (e) => e.fold(A.some, A.none, A.some, A.some),
        Lu = (e) => {
            const t = (e) => e.name;
            return e.fold(t, t, t, t);
        },
        Pu = (e, t) => (o) => {
            const n = Yn('Converting part type', t, o);
            return e(n);
        },
    ...
    const Xu = (e, t, o, n) => fn(t.defaults(e, o, n), o, { uid: e.partUids[t.name] }, t.overrides(e, o, n)),
        Yu = (e, t) => {
            const o = {};
            return (
                L(t, (t) => {
                    Hu(t).each((t) => {
                        const n = Ku(e, t.pname);
                        o[t.name] = (o) => {
                            const s = Yn('Part: ' + t.name + ' in ' + e, Dn(t.schema), o);
        ...
        Ku = (e, t) => ({ uiType: _u(), owner: e, name: t }),
        Ju = (e, t, o) => ({ uiType: _u(), owner: e, name: t, config: o, validated: {} }),
        Zu = (e) =>
            X(e, (e) =>
                e
                    .fold(A.none, A.some, A.none, A.none)
                    .map((e) => ls(e.name, e.schema.concat([Ni($u())])))
                    .toArray()
            ),
        Qu = (e) => H(e, Lu),
        em = (e, t, o) =>
            ((e, t, o) => {
                ...
                return (
                    L(o, (e) => {
                        e.fold(
                            (e) => {
                                n[e.pname] = Cu(!0, (t, o, n) => e.factory.sketch(Xu(t, e, o, n)));
                            },
                            (e) => {
                            ...
                            (e) => {
                                n[e.pname] = Cu(!1, (t, o, n) => e.factory.sketch(Xu(t, e, o, n)));
                            },
                            (e) => {
                                n[e.pname] = Ou(!0, (t, o, n) => {
                                    const s = t[e.name];
                                    return H(s, (o) => e.factory.sketch(fn(e.defaults(t, o, n), o, e.overrides(t, o))));
                                });
                            }
                        );
                    }),
        ...
        tm = (e, t, o) =>
            ((e, t, o, n) => {
                const s = ce(n, (e, t) =>
                    ...
                    r = ((e, t, o, n) => X(o, (o) => ku(e, t, o, n)))(e, t, o, s);
                return (
                    le(s, (o) => {
        ...
        nm = (e, t, o) => om(e, t, o).getOrDie('Could not find part: ' + o),
        sm = (e, t, o) => {
            const n = {},
                s = t.partUids,
                r = e.getSystem();
        ...
        lm = (e, t) => {
            const o = Qu(t);
            return Ds(H(o, (t) => ({ key: t, value: e + '-' + t })));
        },
        cm = (e) =>
            Qn(
                'partUids',
    ...
    const um = (e, t, o, n, s) => {
            const r = ((e, t) =>
                (e.length > 0 ? [ls('parts', e)] : [])
                    .concat([os('uid'), ys('dom', {}), ys('components', []), Ni('originalSpec'), ys('debug.sketcher', {})])
                    .concat(t))(n, s);
        ...
        gm = (e) => (((e) => ve(e, 'uid'))(e) ? e : { ...e, uid: ha('uid') }),
        ...
        fm = (e) => {
            const t = Yn('Sketcher for ' + e.name, pm, e),
                o = ce(t.apis, Ca),
        ...
        bm = (e) => {
            const t = Yn('Sketcher for ' + e.name, hm, e),
                o = Yu(t.name, t.partFields),
                n = ce(t.apis, Ca),
                s = ce(t.extraApis, (e, t) => xa(e, t));
            return {
                name: t.name,
                partFields: t.partFields,
                configFields: t.configFields,
                sketch: (e) => mm(t.name, t.configFields, t.partFields, t.factory, e),
                parts: o,
                ...n,
                ...s
            };
        },
        vm = (e) => (Ye('input')(e) && 'radio' !== Ot(e, 'type')) || Ye('textarea')(e);
    var ym = Object.freeze({ __proto__: null, getCurrent: (e, t, o) => t.find(e) });
    const xm = [os('find')],
        wm = Ol({ fields: xm, name: 'composing', apis: ym }),
        Sm = ['input', 'button', 'textarea', 'select'],
        km = (e, t, o) => {
            (t.disabled() ? Am : Mm)(e, t);
        },
        Cm = (e, t) => !0 === t.useNative && R(Sm, Ue(e.element)),
        Om = (e) => {
        ...
        Dm = (e, t) => (Cm(e, t) ? ((e) => Tt(e.element, 'disabled'))(e) : ((e) => 'true' === Ot(e.element, 'aria-disabled'))(e));
    var Bm = Object.freeze({
        ...
        Fm = Object.freeze({
            __proto__: null,
            exhibit: (e, t) => Ea({ classes: t.disabled() ? t.disableClass.toArray() : [] }),
            events: (e, t) => Hr([Lr(ur(), (t, o) => Dm(t, e)), xl(e, t, km)])
        }),
        Im = [Os('disabled', T), ys('useNative', !0), us('disableClass'), Di('onDisabled'), Di('onEnabled')];
    const Rm = Ol({ fields: Im, name: 'disabling', active: Fm, apis: Bm }),
        Nm = (e, t, o, n) => {
            const s = Xc(e.element, '.' + t.highlightClass);
            L(s, (o) => {
                N(n, (e) => Ze(e.element, o)) ||
                    (Pa(o, t.highlightClass),
                    e
                        .getSystem()
                        .getByDom(o)
                        .each((o) => {
        ...
        zm = (e, t, o, n) => Ua(n.element, t.highlightClass),
        Hm = (e, t, o) => pi(e.element, '.' + t.itemClass).bind((t) => e.getSystem().getByDom(t).toOptional()),
        Lm = (e, t, o) => {
            const n = Xc(e.element, '.' + t.itemClass);
            return (n.length > 0 ? A.some(n[n.length - 1]) : A.none()).bind((t) => e.getSystem().getByDom(t).toOptional());
        },
        Pm = (e, t, o, n) => {
            const s = Xc(e.element, '.' + t.itemClass);
            return $(s, (e) => Ua(e, t.highlightClass)).bind((t) => {
                const o = Xi(t, n, 0, s.length - 1);
    ...
    var Wm = Object.freeze({
            ...
            highlightAt: (e, t, o, n) => {
                ((e, t, o, n) => {
                    const s = Xc(e.element, '.' + t.itemClass);
                    return A.from(s[n]).fold(() => sn.error(new Error('No element found with index ' + n)), e.getSystem().getByDom);
                })(e, t, 0, n).fold(
                    (e) => {
                        throw e;
                    },
            ...
            getFirst: Hm,
            getLast: Lm,
            getPrevious: (e, t, o) => Pm(e, t, 0, -1),
            getNext: (e, t, o) => Pm(e, t, 0, 1),
            getCandidates: Um
        }),
        jm = [os('highlightClass'), os('itemClass'), Di('onHighlight'), Di('onDehighlight')];
    const Gm = Ol({ fields: jm, name: 'highlighting', apis: Wm }),
        $m = [8],
        qm = [9],
        Xm = [13],
        Ym = [27],
        ...
        ag = (e) => (t) => Y(e, (e) => e(t)),
        ig = (e) => !0 === e.raw.shiftKey,
        lg = (e) => !0 === e.raw.ctrlKey,
        cg = C(ig),
        dg = (e, t) => ({ matches: e, classification: t }),
        ug = (e, t, o) => {
            t.exists((e) => o.exists((t) => Ze(t, e))) || Ir(e, _r(), { prevFocus: t, newFocus: o });
        },
        mg = () => {
        ...
        gg = () => {
            const e = (e) => Gm.getHighlighted(e).map((e) => e.element);
            return {
                get: e,
                set: (t, o) => {
                    const n = e(t);
    ...
    const hg = (e, t, o, n, s) => {
            const r = (e, t, o, n, s) => {
                    return ((r = o(e, t, n, s)), (a = t.event), G(r, (e) => e.matches(a)).map((e) => e.classification)).bind((o) =>
                        o(e, t, n, s)
                    );
                    var r, a;
                },
                    ...
                    schema: () =>
                        e.concat([
                            ...
                            xs(
                                ...
                                'onFocus',
                                Gn((e) =>
                                    R(['onFocus', 'onEnterOrSpace', 'onApi'], e) ? sn.value(e) : sn.error('Invalid value for focusInside')
                                )
                            ),
                            Ri('handler', a),
                            Ri('state', t),
                            ...
                            i = [
                                Ur(Ks(), (n, a) => {
                                    r(n, a, o, e, t).fold(
                                        () => {
                                            ((o, n) => {
                                                const r = rg(Km.concat(Xm))(n.event);
                                                e.focusInside === pg.OnEnterOrSpaceMode &&
                                                    r &&
                                                    Rs(o, n) &&
                                                    s(e).each((s) => {
                                                        s(o, e, t), n.stop();
        ...
        fg = (e) => {
            const t = [
                    us('onEscape'),
                    us('onEnter'),
                    ys('selector', '[data-alloy-tabstop="true"]:not(:disabled)'),
                    ys('firstTabstop', 0),
                    ys('useTabstopAt', E),
                    us('visibilitySelector')
                ].concat([e]),
                o = (e, t) => {
                    const o = e.visibilitySelector.bind((e) => hi(t, e)).getOr(t);
                    return Wt(o) > 0;
                },
                n = (e, t) => t.focusManager.get(e).bind((e) => hi(e, t.selector)),
                s = (e, t, n) => {
                    ((e, t) => {
                        const n = Xc(e.element, t.selector),
                            s = U(n, (e) => o(t, e));
                ...
                r = (e, t, s, r) => {
                    const a = Xc(e.element, s.selector);
                    return n(e, s).bind((t) =>
                        $(a, k(Ze, t)).bind((t) =>
                            ((e, t, n, s, r) =>
                ...
                i = (e, t, o) => {
                    const n = o.cyclic ? ng : sg;
                    return r(e, 0, o, n);
                },
                l = x([dg(ag([ig, rg(qm)]), a), dg(rg(qm), i), dg(ag([cg, rg(Xm)]), (e, t, o) => o.onEnter.bind((o) => o(e, t)))]),
                c = x([
                    dg(rg(Ym), (e, t, o) => o.onEscape.bind((o) => o(e, t))),
                    dg(rg(qm), (e, t, o) =>
                        n(e, o)
            ...
            return hg(t, Oa.init, l, c, () => A.some(s));
        };
    var bg = fg(es('cyclic', T)),
        vg = fg(es('cyclic', E));
    const yg = (e, t, o) => (vm(o) && rg(Km)(t.event) ? A.none() : ((e, t, o) => (Nr(e, o, ur()), A.some(!0)))(e, 0, o)),
        xg = (e, t) => A.some(!0),
        wg = [ys('execute', yg), ys('useSpace', !1), ys('useEnter', !0), ys('useControlEnter', !1), ys('useDown', !1)],
        Sg = (e, t, o) => o.execute(e, t, e.element);
    var kg = hg(
        wg,
        Oa.init,
        (e, t, o, n) => {
            const s = o.useSpace && !vm(e.element) ? Km : [],
                r = o.useEnter ? Xm : [],
                a = o.useDown ? eg : [],
                i = s.concat(r).concat(a);
            return [dg(rg(i), Sg)].concat(o.useControlEnter ? [dg(ag([lg, rg(Xm)]), Sg)] : []);
        },
        (e, t, o, n) => (o.useSpace && !vm(e.element) ? [dg(rg(Km), xg)] : []),
        () => A.none()
    );
    const Cg = () => {
        const e = Ql();
    ...
    var Og = Object.freeze({ __proto__: null, flatgrid: Cg, init: (e) => e.state(e) });
    const _g = (e) => (t, o, n, s) => {
            const r = e(t.element);
            return Mg(r, t, o, n, s);
        },
        ...
        Bg = Ag,
        Fg = Ag,
        Ig = (e) => !((e) => e.offsetWidth <= 0 && e.offsetHeight <= 0)(e.dom),
        Rg = (e, t, o) => {
            const n = Xc(e, o);
            return ((e, o) => $(e, (e) => Ze(e, t)).map((t) => ({ index: t, candidates: e })))(U(n, Ig));
        },
        Ng = (e, t) => $(e, (e) => Ze(t, e)),
        Vg = (e, t, o, n) =>
        ...
        Ug = (e) => (t, o, n, s) =>
            Rg(t, o, n.selector).bind((t) =>
                e(t.candidates, t.index, s.getNumRows().getOr(n.initSize.numRows), s.getNumColumns().getOr(n.initSize.numColumns))
            ),
        Wg = (e, t, o) => (o.captureTab ? A.some(!0) : A.none()),
        jg = Ug((e, t, o, n) => zg(e, t, o, n, -1)),
        Gg = Ug((e, t, o, n) => zg(e, t, o, n, 1)),
        $g = Ug((e, t, o, n) => Hg(e, t, o, n, -1)),
        qg = Ug((e, t, o, n) => Hg(e, t, o, n, 1)),
        Xg = x([
            dg(rg(Jm), Tg(jg, Gg)),
            dg(rg(Qm), Eg(jg, Gg)),
            dg(rg(Zm), Dg($g)),
            ...
            dg(ag([ig, rg(qm)]), Wg),
            dg(ag([cg, rg(qm)]), Wg),
            dg(rg(Km.concat(Xm)), (e, t, o, n) =>
                ((e, t) => t.focusManager.get(e).bind((e) => hi(e, t.selector)))(e, o).bind((n) => o.execute(e, t, n))
            )
        ]),
        Yg = x([dg(rg(Ym), (e, t, o) => o.onEscape(e, t)), dg(rg(Km), xg)]);
    var Kg = hg(Lg, Cg, Xg, Yg, () => A.some(Pg));
    const Jg = (e, t, o, n, s) => {
            const r = (e, t, o) =>
        ...
        ep = [
            os('selector'),
            ys('getInitial', A.none),
            ys('execute', yg),
            Bi('onEscape'),
            ys('executeOnMove', !1),
            ys('allowVertical', !0),
            ys('allowHorizontal', !0),
            ys('cycles', !0)
        ],
        tp = (e, t, o) => ((e, t) => t.focusManager.get(e).bind((e) => hi(e, t.selector)))(e, o).bind((n) => o.execute(e, t, n)),
        op = (e, t, o) => {
            t.getInitial(e)
                .orThunk(() => pi(e.element, t.selector))
                .each((o) => {
                    t.focusManager.set(e, o);
                });
        },
        np = (e, t, o) => (o.cycles ? Qg : Zg)(e, o.selector, t, -1),
        sp = (e, t, o) => (o.cycles ? Qg : Zg)(e, o.selector, t, 1),
        rp = (e) => (t, o, n, s) => e(t, o, n, s).bind(() => (n.executeOnMove ? tp(t, o, n) : A.some(!0))),
        ap = x([dg(rg(Km), xg), dg(rg(Ym), (e, t, o) => o.onEscape(e, t))]);
    var ip = hg(
        ep,
        Oa.init,
        (e, t, o, n) => {
            const s = [...(o.allowHorizontal ? Jm : [])].concat(o.allowVertical ? Zm : []),
                r = [...(o.allowHorizontal ? Qm : [])].concat(o.allowVertical ? eg : []);
            return [dg(rg(s), rp(Tg(np, sp))), dg(rg(r), rp(Eg(np, sp))), dg(rg(Xm), tp), dg(rg(Km), tp)];
        },
        ap,
        () => A.some(op)
    );
    const lp = (e, t, o) => A.from(e[t]).bind((e) => A.from(e[o]).map((e) => ({ rowIndex: t, columnIndex: o, cell: e }))),
        cp = (e, t, o, n) => {
            const s = e[t].length,
                r = Xi(o, n, 0, s - 1);
            return lp(e, t, r);
        ...
        hp = (e, t) => (o, n, s) => {
            ...
            return hi(n, s.selectors.row).bind((e) => {
                const t = Xc(e, s.selectors.cell);
                return Ng(t, n).bind((t) => {
                    const n = Xc(o, s.selectors.row);
                    return Ng(n, e).bind((e) => {
                        const o = ((e, t) => H(e, (e) => Xc(e, t.selectors.cell)))(n, s);
        ...
        xp = x([
            ...
            dg(rg(Zm), Dg(vp)),
            dg(rg(eg), Bg(yp)),
            dg(rg(Km.concat(Xm)), (e, t, o) => Rl(e.element).bind((n) => o.execute(e, t, n)))
        ]),
        wp = x([dg(rg(Km), xg)]);
    var Sp = hg(gp, Oa.init, xp, wp, () => A.some(pp));
    const kp = [os('selector'), ys('execute', yg), ys('moveOnTab', !1)],
        Cp = (e, t, o) => o.focusManager.get(e).bind((n) => o.execute(e, t, n)),
        Op = (e, t, o) => {
            pi(e.element, t.selector).each((o) => {
                t.focusManager.set(e, o);
            });
        },
        _p = (e, t, o) => Qg(e, o.selector, t, -1),
        Tp = (e, t, o) => Qg(e, o.selector, t, 1),
        Ep = x([
            dg(rg(Zm), Fg(_p)),
            dg(rg(eg), Fg(Tp)),
            dg(ag([ig, rg(qm)]), (e, t, o, n) => (o.moveOnTab ? Fg(_p)(e, t, o, n) : A.none())),
            dg(ag([cg, rg(qm)]), (e, t, o, n) => (o.moveOnTab ? Fg(Tp)(e, t, o, n) : A.none())),
            dg(rg(Xm), Cp),
            dg(rg(Km), Cp)
        ]),
        Ap = x([dg(rg(Km), xg)]);
    var Mp = hg(kp, Oa.init, Ep, Ap, () => A.some(Op));
    const Dp = [
        Bi('onSpace'),
        Bi('onEnter'),
        Bi('onShiftEnter'),
    ...
    var Bp = hg(
        ...
        (e, t, o) => [
            dg(rg(Km), o.onSpace),
            dg(ag([cg, rg(Xm)]), o.onEnter),
            dg(ag([ig, rg(Xm)]), o.onShiftEnter),
            dg(ag([ig, rg(qm)]), o.onShiftTab),
            dg(ag([cg, rg(qm)]), o.onTab),
            dg(rg(Zm), o.onUp),
            dg(rg(eg), o.onDown),
            dg(rg(Jm), o.onLeft),
            dg(rg(Qm), o.onRight),
        ...
        (e, t, o) => [...(o.stopSpaceKeyup ? [dg(rg(Km), xg)] : []), dg(rg(Ym), o.onEscape)],
        (e) => e.focusIn
    );
    const Fp = bg.schema(),
        Ip = vg.schema(),
        ...
        Wp = (e, t) => {
            Nl(() => {
                ((o, n, s) => {
                    ...
                    const i = ((e, t, o) => Ya(e, t, (t, n) => Ka(e, n, t, o)))(e.element, t, e.getSystem().buildOrPatch),
                        l = J(r, i);
                    L(l, (e) => {
                        kd(e) && Td(e);
                    }),
        ...
        jp = (e, t, o, n) => {
            Td(t);
            const s = Ka(e.element, o, n, e.getSystem().buildOrPatch);
    ...
    var Yp = Object.freeze({
        ...
        remove: (e, t, o, n) => {
            const s = qp(e),
                r = G(s, (e) => Ze(n.element, e.element));
            r.each(Bd);
        },
        replaceAt: Xp,
        replaceBy: (e, t, o, n, s) => {
            const r = qp(e);
            return $(r, n).bind((o) => Xp(e, t, 0, o, s));
        },
        set: (e, t, o, n) => (t.reuseDom ? Wp : Up)(e, n),
        contents: qp
    });
    const Kp = Ol({ fields: [Cs('reuseDom', !0)], name: 'replacing', apis: Yp }),
        Jp = (e, t) => {
            const o = ((e, t) => {
                const o = Hr(t);
                return Ol({ fields: [os('enabled')], name: e, active: { events: x(o) } });
            })(e, t);
            return { key: e, value: { config: {}, me: o, configAsRaw: x({}), initialConfig: {}, state: Oa } };
        },
        Zp = (e, t) => {
    ...
    const oh = Ol({ fields: th, name: 'focusing', active: eh, apis: Qp }),
        nh = (e, t, o, n) => {
            const s = o.get();
            o.set(n),
                ((e, t, o) => {
    ...
    const uh = () => {
        ...
        fh = (e) => {
            (Rl(e.element).isNone() || oh.isFocused(e)) && (oh.isFocused(e) || oh.focus(e), Ir(e, gh, { item: e }));
        },
        bh = (e) => {
            Ir(e, ph, { item: e });
        },
        ...
        yh = x(ph),
        xh = x(hh),
        wh = (e) => e.toggling.map((e) => (e.exclusive ? 'menuitemradio' : 'menuitemcheckbox')).getOr('menuitem'),
        Sh = [
            os('data'),
            os('components'),
            os('dom'),
            ...
            Ri('builder', (e) => ({
                ...
                behaviours: yu(e.itemBehaviours, [
                    e.toggling.fold(dh.revoke, (e) =>
                        dh.config(
                            ((e) => ({
                                aria: { mode: 'checked' },
                    ...
                    Pp.config({ mode: 'execution' }),
                    pu.config({ store: { mode: 'memory', initialValue: e.data } }),
                    Jp('item-type-events', [...uh(), Ur(qs(), fh), Ur(mr(), oh.focus)])
                ]),
        ...
        kh = [os('dom'), os('components'), Ri('builder', (e) => ({ dom: e.dom, components: e.components, events: Hr([Xr(mr())]) }))],
        Ch = x('item-widget'),
        Oh = x([
            Uu({
                name: 'widget',
                overrides: (e) => ({ behaviours: kl([pu.config({ store: { mode: 'manual', getValue: (t) => e.data, setValue: b } })]) })
            })
        ]),
        _h = [
            os('uid'),
            ...
            ys('autofocus', !1),
            ys('ignoreFocus', !1),
            vu('widgetBehaviours', [pu, oh, Pp]),
            ys('domModification', {}),
            cm(Oh()),
            Ri('builder', (e) => {
                const t = em(Ch(), e, Oh()),
                    o = tm(Ch(), e, t.internals()),
                    n = (t) => om(t, e, 'widget').map((e) => (Pp.focusIn(e), e)),
                    s = (t, o) => (vm(o.event.target) ? A.none() : e.autofocus ? (o.setSource(t.element), A.none()) : A.none());
                return {
                    dom: e.dom,
                    components: o,
                    ...
                    behaviours: yu(e.widgetBehaviours, [
                        pu.config({ store: { mode: 'memory', initialValue: e.data } }),
                        oh.config({
                            ignore: e.ignoreFocus,
                            onFocus: (e) => {
        ...
        Th = Jn('type', { widget: _h, item: Sh, separator: kh }),
        Eh = x([
            Gu({
                factory: {
                    sketch: (e) => {
                        const t = Yn('menu.spec item', Th, e);
                        return t.builder(t);
                    }
                },
                name: 'items',
                unit: 'item',
                defaults: (e, t) => (ve(t, 'uid') ? t : { ...t, uid: ha('item') }),
        ...
        Dh = bm({
            ...
            factory: (e, t, o, n) => ({
                ...
                dom: e.dom,
                markers: e.markers,
                behaviours: bu(e.menuBehaviours, [
                    Gm.config({
                    ...
                    pu.config({ store: { mode: 'memory', initialValue: e.value } }),
                    wm.config({ find: A.some }),
                ...
                events: Hr([
                    Ur(yh(), (e, t) => {
                        ...
                        e.getSystem()
                            .getByDom(o.target)
                            .each((o) => {
                                Gm.highlight(e, o), t.stop(), Ir(e, Mh(), { menu: e, item: o });
                            });
                    }),
                    Ur(vh(), (e, t) => {
                    ...
                    Ur(xh(), (e, t) => {
                        ...
                        n &&
                            'menuitemradio' === Ot(o.element, 'role') &&
                            ((e, t) => {
                                const o = Xc(e.element, '[role="menuitemradio"][aria-checked="true"]');
                                L(o, (o) => {
                                    Ze(o, t.element) ||
                                        e
                                            .getSystem()
        ...
        Bh = (e, t, o, n) =>
            be(o, n)
                ...
                .getOr([]),
        Fh = (e) => ('prepared' === e.type ? A.some(e.menu) : A.none()),
        Ih = () => {
            const e = Es({}),
                t = Es({}),
                o = Es({}),
            ...
            return {
                ...
                setContents: (r, a, i, l) => {
                    ...
                    const c = ((e, t) => {
                        ...
                        const n = t,
                            s = de(t, (e, t) => ({ k: e, v: t })),
                            r = ce(s, (e, t) => [t].concat(Bh(o, n, s, t)));
    ...
    const Hh = x('collapse-item'),
        Lh = fm({
            ...
            configFields: [
                ...
                Di('onRepositionMenu'),
                Di('onCollapseMenu'),
                ys('highlightOnOpen', zh.HighlightMenuAndItem),
                ls('data', [os('primary'), os('menus'), os('expansions')]),
                ys('fakeFocus', !1),
                Di('onHighlightItem'),
                Di('onDehighlightItem'),
                Di('onHover'),
                Ei(),
                os('dom'),
                ys('navigateOnHover', !0),
                ys('stayInDom', !1),
                hu('tmenuBehaviours', [Pp, Gm, wm, Kp]),
                ys('eventOrder', {})
            ],
            apis: {
                collapseMenu: (e, t) => {
            ...
            factory: (e, t) => {
                const o = Ql(),
                    ...
                    d = (t, n) => {
                        const r = ((t) =>
                            o.get().getOrThunk(() => {
                                const n = {},
                                    r = Xc(t.element, `.${e.markers.item}`),
                                    a = U(r, (e) => 'true' === Ot(e, 'aria-haspopup'));
                                return (
                                    L(a, (e) => {
                                        t.getSystem()
                                            .getByDom(e)
                            ...
                            o.lookupMenu(s).bind((s) => {
                                if ('notbuilt' === s.type) return A.none();
                                {
                                    ...
                                    return (
                                        ...
                                        yt(r.element) || Kp.append(t, ai(r)),
                                        ja(r.element, [e.markers.backgroundMenu]),
                                        i(t, r),
                                        c(t, o, n),
                                        A.some(r)
                                    );
                ...
                const g = (t, o, r = m.HighlightSubmenu) => {
                                ...
                                (s) => (
                                    ...
                                    A.from(s[0]).bind((a) =>
                                        n.lookupMenu(a).bind((i) => {
                                            ...
                                            return (
                                                yt(l.element) || Kp.append(t, ai(l)),
                                                e.onOpenSubmenu(t, o, l, K(s)),
                                                r === m.HighlightSubmenu
                                                    ? (Gm.highlightFirst(l), u(t, n, s))
                                                    : (Gm.dehighlightAll(l), A.some(o))
                                            );
                                        })
                                    )
                                )
                    ...
                    h = (t) => (o, n) =>
                        hi(n.getSource(), `.${e.markers.item}`).bind((e) =>
                            o
                                .getSystem()
                                .getByDom(e)
                                .toOptional()
                    ...
                    f = Hr([
                        ...
                        Kr((t, o) => {
                            ((t) => {
                                        ...
                                        ce(n, (n, s) => {
                                            const r = () =>
                                                Dh.sketch({
                                                    ...
                                                    onHighlight: (e, t) => {
                                                        Ir(e, Nh, { menuComp: e, itemComp: t });
                                                    },
                                                    onDehighlight: (e, t) => {
                                                        Ir(e, Vh, { menuComp: e, itemComp: t });
                                                    },
                                ...
                                Kp.append(t, ai(o)),
                                    e.onOpenMenu(t, o),
                                    e.highlightOnOpen === zh.HighlightMenuAndItem
                                        ? i(t, o)
                                        : e.highlightOnOpen === zh.HighlightJustMenu && a(t, o);
                            });
                        }),
                        Ur(Nh, (t, o) => {
                    ...
                    v = (e) => Gm.getHighlighted(e).bind(Gm.getHighlighted),
                    y = {
                        collapseMenu: (e) => {
                            v(e).each((t) => {
                                p(e, t);
                ...
                return {
                    ...
                    dom: e.dom,
                    markers: e.markers,
                    behaviours: bu(e.tmenuBehaviours, [
                        Pp.config({
                            mode: 'special',
                            onRight: h((e, t) => (vm(t.element) ? A.none() : g(e, t, m.HighlightSubmenu))),
                            onLeft: h((e, t) => (vm(t.element) ? A.none() : p(e, t))),
                        ...
                        Gm.config({ highlightClass: e.markers.selectedMenu, itemClass: e.markers.menu }),
                        wm.config({ find: (e) => Gm.getHighlighted(e) }),
                        Kp.config({})
                    ]),
                    eventOrder: e.eventOrder,
                    apis: y,
            ...
            extraApis: {
                ...
                singleData: (e, t) => ({ primary: e, menus: Ms(e, t), expansions: {} }),
                collapseItem: (e) => ({ value: la(Hh()), meta: { text: e } })
            }
        }),
        Ph = fm({
            name: 'InlineView',
            configFields: [
                ...
                Di('onHide'),
                fs('onEscape'),
                hu('inlineBehaviours', [Xd, pu, Al]),
                vs('fireDismissalEventInstead', [ys('event', Cr())]),
                vs('fireRepositionEventInstead', [ys('event', Or())]),
                ys('getRelated', A.none),
                ys('isExtraPart', T),
                ys('eventOrder', A.none)
            ],
            factory: (e, t) => {
                const o = (t, o, n, s) => {
                        const r = e.lazySink(t).getOrDie();
                        Xd.openWhileCloaked(t, o, () => Sd.positionWithinBounds(r, t, n, s())),
                            pu.setValue(t, A.some({ mode: 'position', config: n, getBounds: s }));
                    },
                    n = (t, o, n, s) => {
                        const r = ((e, t, o, n, s) => {
                            const r = () => e.lazySink(t),
                                a = 'horizontal' === n.type ? { layouts: { onLtr: () => fl(), onRtl: () => bl() } } : {},
                            ...
                            return Lh.sketch({
                                ...
                                onEscape: () => (Xd.close(t), e.onEscape.map((e) => e(t)), A.some(!0)),
                                onExecute: () => A.some(!0),
                                onOpenMenu: (e, t) => {
                                ...
                                onOpenSubmenu: (e, t, o, n) => {
                                    const s = r().getOrDie();
                                    Sd.position(s, o, { anchor: { type: 'submenu', item: t, ...i(n) } });
                                },
                                onRepositionMenu: (e, t, n) => {
                                    const a = r().getOrDie();
                                    Sd.positionWithinBounds(a, t, o, s()),
                                        L(n, (e) => {
                                            const t = i(e.triggeringPath);
                                            Sd.position(a, e.triggeredMenu, { anchor: { type: 'submenu', item: e.triggeringItem, ...t } });
                                        });
                                }
                            });
                        })(e, t, o, n, s);
                        Xd.open(t, r), pu.setValue(t, A.some({ mode: 'menu', menu: r }));
                    },
                    s = (t) => {
                        Xd.isOpen(t) &&
                            pu.getValue(t).each((o) => {
                                switch (o.mode) {
                                    case 'menu':
                                    ...
                                    case 'position':
                                        ...
                                        Sd.positionWithinBounds(n, t, o.config, o.getBounds());
                                }
                            });
                    },
                    r = {
                ...
                return {
                    uid: e.uid,
                    dom: e.dom,
                    behaviours: bu(e.inlineBehaviours, [
                        Xd.config({
                        ...
                        pu.config({ store: { mode: 'memory', initialValue: A.none() } }),
                        Al.config({
                            channels: {
                                ...Qd({
    ...
    const Wh = fm({
            ...
            factory: (e) => {
                ...
                return {
                    ...
                    components: e.components,
                    events: t,
                    behaviours: yu(e.buttonBehaviours, [oh.config({}), Pp.config({ mode: 'execution', useSpace: !0, useEnter: !0 })]),
                    domModification: {
                        attributes:
                            'button' === o
                                ? {
    ...
    const $h = {
        ...
        Qh = (e, t, o, n) => {
            var s, r;
            const a = ((e) => !!Gh.isRtl() && ve($h, e))(t) ? ['tox-icon--flip'] : [],
            ...
            return {
                ...
                behaviours: kl([...(null !== (r = e.behaviours) && void 0 !== r ? r : []), Zh()])
            };
        },
        ef = (e, t, o, n = A.none()) => Qh(t, e, o(), n),
        tf = { success: 'checkmark', error: 'warning', err: 'error', warning: 'warning', warn: 'warning', info: 'info' },
        of = fm({
            name: 'Notification',
            factory: (e) => {
                const t = jh({ dom: { tag: 'p', innerHtml: e.translationProvider(e.text) }, behaviours: kl([Kp.config({})]) }),
                    ...
                    r = {
                        updateProgress: (e, t) => {
                            e.getSystem().isConnected() &&
                                s.getOpt(e).each((e) => {
                                    Kp.set(e, [{ dom: { tag: 'div', classes: ['tox-bar-container'] }, components: [o(t)] }, n(t)]);
                                });
                        },
                        updateText: (e, o) => {
                    ...
                    a = q([e.icon.toArray(), e.level.toArray(), e.level.bind((e) => A.from(tf[e])).toArray()]),
                    i = jh(
                        Wh.sketch({
                            dom: {
                                tag: 'button',
                            ...
                            components: [
                                ef(
                                    'close',
                                    { tag: 'span', classes: ['tox-icon'], attributes: { 'aria-label': e.translationProvider('Close') } },
                                    e.iconProvider
                                )
                            ],
                            action: (t) => {
                    ...
                    l = ((e, t, o) => {
                        const n = o(),
                            s = G(e, (e) => ve(n, Yh(e, n)));
                        return Qh({ tag: 'div', classes: ['tox-notification__icon'] }, s.getOr(qh), n, A.none());
                    })(a, 0, e.iconProvider),
                    c = [
                        l,
                        {
    ...
    const cf = (e) => (t) => t.options.get(e),
        df = (e) => (t) => A.from(e(t)),
        uf = (e) => {
            const t = lf.deviceType.isPhone(),
            ...
            n('skin', { processor: (e) => r(e) || !1 === e, default: 'oxide' }),
                ...
                n('width', { processor: a, default: rf.DOM.getStyle(e.getElement(), 'width') }),
                ...
                n('toolbar_location', { processor: 'string', default: sf.auto }),
                ...
                n('resize', { processor: (e) => 'both' === e || d(e), default: !lf.deviceType.isTouch() }),
        ...
        Yf = (e) => !1 === e.options.get('skin'),
        Kf = (e) => !1 !== e.options.get('menubar'),
        Jf = (e) => {
            ...
            if (t) return e.documentBaseURI.toAbsolute(t);
            {
                ...
                return af.baseURL + '/skins/ui/' + t;
            }
        },
        Zf = (e) => e.options.get('line_height_formats').split(' '),
        Qf = (e) => {
            const t = Bf(e),
                o = r(t),
                n = l(t) && t.length > 0;
        ...
        nb = (e) => {
            ...
            const o = null !== (t = Tf(e)) && void 0 !== t ? t : '';
            if (o.length > 0) return pi(xt(), o);
            const n = Ef(e);
            return g(n) ? A.some(Ve(n)) : A.none();
        },
        sb = (e) => e.inline && nb(e).isSome(),
        rb = (e) => nb(e).getOrThunk(() => ft(ht(Ve(e.getElement())))),
        ab = (e) => e.inline && !Kf(e) && !Qf(e) && !tb(e),
        ib = (e) => (e.options.get('toolbar_sticky') || e.inline) && !sb(e) && !ab(e),
        lb = (e) => !sb(e) && 'split' === e.options.get('ui_mode'),
        cb = (e) => {
    ...
    const ub = '[data-mce-autocompleter]',
        mb = (e) => hi(e, ub);
    var gb;
    !(function (e) {
    ...
    var pb = gb;
    const hb = 'tox-menu-nav__js',
        fb = 'tox-collection__item',
        bb = 'tox-swatch',
        vb = { normal: hb, color: bb },
        ...
        Bb = (e, t, o) => {
            const n = Eb(o);
            return { dom: { tag: 'div', classes: q([[n.tieredMenu]]) }, markers: Ab(o) };
        },
        Fb = x([
            us('data'),
            ys('inputAttributes', {}),
        ...
        Nb = (e) => ({ tag: e.tag, attributes: { type: 'text', ...e.inputAttributes }, styles: e.inputStyles, classes: e.inputClasses }),
        Vb = fm({
            name: 'Input',
            configFields: Fb(),
            factory: (e, t) => ({ uid: e.uid, dom: Nb(e), components: [], behaviours: Rb(e), eventOrder: e.eventOrder })
        }),
        zb = la('refetch-trigger-event'),
        Hb = la('redirect-menu-item-interaction'),
        Lb = 'tox-menu__searcher',
        Pb = (e) => pi(e.element, `.${Lb}`).bind((t) => e.getSystem().getByDom(t).toOptional()),
        Ub = Pb,
        Wb = (e) => ({
                ...
                components: [
                    Vb.sketch({
                        ...
                        inputBehaviours: kl([
                            ...
                            Pp.config({ mode: 'special', onLeft: t, onRight: t, onSpace: t, onEnter: o, onEscape: o, onUp: o, onDown: o })
                        ]),
                        eventOrder: { keydown: [n, Pp.name()] }
                    })
                ]
            };
        },
        ...
        qb = (e, t) => (o) => {
            const n = z(o, t);
            return H(n, (t) => ({ dom: e, components: t }));
        },
        Xb = (e, t) => {
            const o = [];
            let n = [];
            return (
                ...
                n.length > 0 && o.push(n),
                H(o, (e) => ({ dom: { tag: 'div', classes: ['tox-collection__group'] }, components: e }))
            );
        },
        Yb = (e, t, o) =>
            Dh.parts.items({
                preprocess: (n) => {
                    const s = H(n, o);
                    return 'auto' !== e && e > 1
                        ? qb({ tag: 'div', classes: ['tox-collection__group'] }, e)(s)
                        : Xb(s, (e, o) => 'separator' === t[o].type);
                }
            }),
        Kb = (e, t, o = !0) => ({
            dom: {
        ...
        Jb = (e) => N(e, (e) => 'icon' in e && void 0 !== e.icon),
        Zb = (e) => (console.error(Kn(e)), console.log(e), A.none()),
        Qb = (e, t, o, n, s) => {
            const r =
                ((a = o),
                {
                    dom: { tag: 'div', classes: ['tox-collection', 'tox-collection--horizontal'] },
                    components: [Dh.parts.items({ preprocess: (e) => Xb(e, (e, t) => 'separator' === a[t].type) })]
                });
            var a;
        ...
        ev = (e, t, o, n, s) => {
                    ...
                    components: [
                        {
                            ...
                            components: [
                                Dh.parts.items({ preprocess: 'auto' !== e ? qb({ tag: 'div', classes: ['tox-swatches__row'] }, e) : w })
                            ]
                        }
                    ]
                }))(n);
                    ...
                    'searchable' !== s.menuType
                        ...
                        ? ((e, t, o) => {
                              ...
                              return {
                                  ...
                                  components: [
                                      jb({ i18n: Gh.translate, placeholder: o.placeholder }),
                                      {
                                          dom: {
                                              tag: 'div',
                                              classes: [...(1 === e ? ['tox-collection--list'] : ['tox-collection--grid']), Gb],
                                              attributes: { id: n }
                                          },
                                          components: [Yb(e, t, $b)]
                                      }
                        ...
                        : ((e, t, o = !0) => {
                              ...
                              return {
                                  dom: {
                                      tag: 'div',
                                      classes: ['tox-menu', 'tox-collection', Gb].concat(
                                          1 === e ? ['tox-collection--list'] : ['tox-collection--grid']
                                      ),
                                      attributes: { id: n }
                                  },
            ...
            if ('listpreview' === s.menuType && 'auto' !== n) {
                const t = ((e) => ({
                    ...
                    components: [Dh.parts.items({ preprocess: qb({ tag: 'div', classes: ['tox-collection__group'] }, e) })]
                }))(n);
                return { value: e, dom: t.dom, components: t.components, items: o };
            }
            return { value: e, dom: Mb(t, n, s.menuType), components: Db, items: o };
        },
        tv = rs('type'),
        ov = rs('name'),
        nv = rs('label'),
        ...
        Fv = (e) => qn('toolbarbutton', Bv, e),
        Iv = [xv].concat(Dv),
        Rv = Dn(Iv.concat([tv, dv])),
        Nv = (e) => qn('ToggleButton', Rv, e),
        ...
        Uv = Jn('type', { contextformbutton: zv, contextformtogglebutton: Hv }),
        Wv = Dn(
            [
                Tv('contextform'),
                Os('initValue', x('')),
                bv,
                ds('commands', Uv),
                ms('launch', Jn('type', { contextformbutton: Lv, contextformtogglebutton: Pv }))
            ].concat(Vv)
        ),
        ...
        Xv = Dn(qv),
        Yv = En(() => jn('type', { cardimage: $v, cardtext: Xv, cardcontainer: Kv })),
        ...
        Jv = [
            ...
            Qn(
                'value',
                'value',
                vn(() => la('menuitem-value')),
                Nn()
            )),
            Ov
        ];
    const Zv = Dn([tv, bv, ds('items', Yv), mv, _v].concat(Jv)),
        ...
        ly = (e) => ((e, t) => kl([Jp(e, t)]))(la('unnamed-events'), e),
    ...
    var gy = Object.freeze({
                                ...
                                t.resetTimer(() => {
                                    ((o) => {
                                        if (!t.isShowing()) {
                                            ...
                                            t.setTooltip(s), Ad(n, s), e.onShow(o, s), Sd.position(n, s, { anchor: e.anchor(o) });
                                        }
                                    })(o);
                                }, e.delay);
                            }),
        ...
        hy = [
            ...
            os('tooltipDom'),
            ys('exclusive', !0),
            ys('tooltipComponents', []),
            ys('delay', 300),
            ks('mode', 'normal', ['normal', 'follow-highlight']),
            ys('anchor', (e) => ({
                type: 'hotspot',
                hotspot: e,
                layouts: { onLtr: x([cl, ll, sl, al, rl, il]), onRtl: x([cl, ll, sl, al, rl, il]) }
            })),
            Di('onHide'),
            Di('onShow')
        ],
    ...
    const by = Ol({ fields: hy, name: 'tooltipping', active: py, state: fy, apis: gy }),
        vy = 'silver.readonly',
    ...
    const xy = (e, t) => {
            ...
            t &&
                L(n, (e) => {
                    e.broadcastOn([Yd()], { target: o });
                }),
                L(n, (e) => {
                    e.broadcastOn([vy], { readonly: t });
                });
        },
        wy = (e, t) => {
            e.on('init', () => {
                ...
                e.on('SwitchMode', () => xy(t, e.mode.isReadOnly())),
        ...
        ky = (e) => Rm.config({ disabled: e }),
        Cy = (e) => Rm.config({ disabled: e, disableClass: 'tox-tbtn--disabled' }),
        Oy = (e) => Rm.config({ disabled: e, disableClass: 'tox-tbtn--disabled', useNative: !1 }),
        _y = (e, t) => {
            const o = e.getApi(t);
            return (e) => {
                e(o);
        ...
        Ey = (e, t) => Jr((o) => _y(e, o)(t.get())),
        Ay = (e, t) =>
            Qr((o, n) => {
                _y(e, o)(e.onAction),
                    e.triggersSubmenu || t !== pb.CLOSE_ON_EXECUTE || (o.getSystem().isConnected() && Fr(o, hr()), n.stop());
            }),
        My = { [ur()]: ['disabling', 'alloy.base.behaviour', 'toggling', 'item-events'] },
        Dy = we,
        By = (e, t, o, n) => {
            const s = Es(b);
            return {
                ...
                itemBehaviours: kl(
                    [
                        Jp('item-events', [Ay(e, o), Ty(e, s), Ey(e, s)]),
                        ((r = () => !e.enabled || n.isDisabled()),
                        Rm.config({ disabled: r, disableClass: 'tox-collection__item--state-disabled' })),
                        Sy(),
                        Kp.config({})
        ...
        Fy = (e) => ({ value: e.value, meta: { text: e.text.getOr(''), ...e.meta } }),
        Iy = (e) => {
            const t = lf.os.isMacOS() || lf.os.isiOS(),
                o = t
        ...
        Ry = (e, t, o = [xb]) => ef(e, { tag: 'div', classes: o }, t),
        Ny = (e) => ({ dom: { tag: 'div', classes: [wb] }, components: [ti(Gh.translate(e))] }),
        Vy = (e, t) => ({ dom: { tag: 'div', classes: t, innerHtml: e } }),
        zy = (e, t) => ({
            dom: { tag: 'div', classes: [wb] },
            components: [{ dom: { tag: e.tag, styles: e.styles }, components: [ti(Gh.translate(t))] }]
        }),
        Hy = (e) => ({ dom: { tag: 'div', classes: ['tox-collection__item-accessory'] }, components: [ti(Iy(e))] }),
        Ly = (e) => Ry('checkmark', e, ['tox-collection__item-checkmark']),
        Py = (e) => {
            const t = e.map((e) => ({ attributes: { title: Gh.translate(e), id: la('menu-item') } })).getOr({});
            return { tag: 'div', classes: [hb, fb], ...t };
        },
        Uy = (e, t, o, n = A.none()) =>
            'color' === e.presets
                ? ((e, t, o) => {
                      ...
                      return {
                          dom: (() => {
                              ...
                              return 'custom' === s
                                  ? { ...i, tag: 'button', classes: [...i.classes, 'tox-swatches__picker-btn'], innerHtml: o }
                                  : 'remove' === s
                                  ? { ...i, classes: [...i.classes, 'tox-swatch--remove'], innerHtml: o }
                                  : g(s)
                                  ? {
                                        ...i,
                ...
                : ((e, t, o, n) => {
                      const s = { tag: 'div', classes: [xb] },
                          r = o ? e.iconContent.map((e) => ef(e, s, t.icons, n)).orThunk(() => A.some({ dom: s })) : A.none(),
                          a = e.checkMark,
                          i = A.from(e.meta).fold(
                              () => Ny,
                              (e) => (ve(e, 'style') ? k(zy, e.style) : Ny)
                          ),
                          l = e.htmlContent.fold(
                              () => e.textContent.map(i),
                              (e) => A.some(Vy(e, [wb]))
                          );
                      return { dom: Py(e.ariaLabel), optComponents: [r, l, e.shortcutContent.map(Hy), a, e.caret] };
                  })(e, t, o, n),
        Wy = (e, t) =>
            be(e, 'tooltipWorker')
                .map((e) => [
                    by.config({
                        ...
                        tooltipComponents: [],
                        anchor: (e) => ({ type: 'submenu', item: e, overrides: { maxHeightFunction: cc } }),
                        mode: 'follow-highlight',
                        onShow: (t, o) => {
                            e((e) => {
                                by.setComponents(t, [oi({ element: Ve(e) })]);
                            });
                        }
                    })
                ])
                .getOr([]),
        jy = (e, t) => {
            const o = ((e) => rf.DOM.encode(e))(Gh.translate(e));
            if (t.length > 0) {
        ...
        Gy = (e, t) =>
            H(e, (e) => {
                switch (e.type) {
                    case 'cardcontainer':
                        return ((e, t) => {
                            const o = 'vertical' === e.direction ? 'tox-collection__item-container--column' : Ob,
                                n =
                                    'left' === e.align
                    ...
                    case 'cardtext':
                        ...
                        return Vy(jy(e.text, n), e.classes);
                }
            }),
        $y = Yu(Ch(), Oh()),
        qy = (e) => ({ value: Jy(e) }),
        ...
        Ky = (e) => Xy.test(e) || Yy.test(e),
        Jy = (e) => _e(e, '#').toUpperCase(),
        Zy = (e) => {
            const t = e.toString(16);
            return (1 === t.length ? '0' + t : t).toUpperCase();
        },
        Qy = (e) => {
            const t = Zy(e.red) + Zy(e.green) + Zy(e.blue);
            return qy(t);
        },
        ex = Math.min,
        tx = Math.max,
        ...
        rx = (e, t, o, n) => ({ red: e, green: t, blue: o, alpha: n }),
        ax = (e) => {
        ...
        lx = (e) => {
            const t = ((e) => {
                    const t = ((e) => {
                            const t = e.value.replace(Xy, (e, t, o, n) => t + t + o + o + n + n);
                            return { value: t };
                        })(e),
                        o = Yy.exec(t.value);
        ...
        ux = (e) => `rgba(${e.red},${e.green},${e.blue},${e.alpha})`,
        mx = rx(255, 0, 0, 1),
        gx = (e, t) => {
        ...
        hx = (e, t) => e.dispatch('ResolveName', { name: t.nodeName.toLowerCase(), target: t }),
        fx = (e, t) => () => {
            e(), t();
        },
        bx = (e) =>
    ...
    const kx = {},
        Cx = (e) =>
            be(kx, e).getOrThunk(() => {
                const t = `tinymce-custom-colors-${e}`,
                    o = Sx.getItem(t);
                if (m(o)) {
                    const e = Sx.getItem('tinymce-custom-colors');
                    Sx.setItem(t, g(e) ? e : '[]');
                }
                const n = ((e, t = 10) => {
                    const o = Sx.getItem(e),
                        n = r(o) ? JSON.parse(o) : [],
        ...
        _x = (e, t, o) => ({ hue: e, saturation: t, value: o }),
        Tx = (e) => {
            let t = 0,
                o = 0,
                n = 0;
            ...
            return i === l
                ...
                : ((t = s === i ? 3 : a === i ? 1 : 5),
                  ...
                  (o = (l - i) / l),
                  (n = l),
                  _x(Math.round(t), Math.round(100 * o), Math.round(100 * n)));
        },
        Ex = (e) => Qy(ix(e)),
        Ax = (e) => {
            return ((t = e), Ky(t) ? A.some({ value: Jy(t) }) : A.none())
                .orThunk(() => dx(e).map(Qy))
                .getOrThunk(() => {
        ...
        Bx = (e) => {
            ...
            for (let o = 0; o < e.length; o += 2)
                t.push({ text: e[o + 1], value: '#' + Ax(e[o]).value, icon: 'checkmark', type: 'choiceitem' });
            return t;
        },
        Fx = (e) => (t) => t.options.get(e),
        Ix = '#000000',
        Rx = (e, t) =>
            t === Mx && e.options.isSet('color_map_foreground')
                ? Fx('color_map_foreground')(e)
                : t === Dx && e.options.isSet('color_map_background')
                ? Fx('color_map_background')(e)
                : Fx('color_map')(e),
        Nx = (e, t = 'default') => Math.max(5, Math.ceil(Math.sqrt(Rx(e, t).length))),
        Vx = (e, t) => {
            const o = Fx('color_cols')(e),
                n = Nx(e, t);
            return o === Nx(e) ? n : o;
        },
        zx = (e, t = 'default') =>
            Math.round(t === Mx ? Fx('color_cols_foreground')(e) : t === Dx ? Fx('color_cols_background')(e) : Fx('color_cols')(e)),
        Hx = Fx('custom_colors'),
        ...
        Gx = (e, t, o) =>
            e.concat(((e) => H(Cx(e).state(), (e) => ({ type: 'choiceitem', text: e, icon: 'checkmark', value: e })))(t).concat(Wx(o))),
        $x = (e, t, o) => (n) => {
            n(Gx(e, t, o));
        },
        qx = (e, t, o) => {
        ...
        Zx = (e, t, o, n, s, r, a, i) => {
            ...
            return ev(e, l, c, n, { menuType: s });
        },
        Qx = (e, t, o, n, s, r, a) =>
            we(
                H(e, (i) => {
                    return 'choiceitem' === i.type
                        ? ((l = i), qn('choicemenuitem', Qv, l)).fold(Zb, (i) =>
                              A.some(
                                  ((e, t, o, n, s, r, a, i = !0) => {
                                      const l = Uy(
                                          {
                                      ...
                                      return fn(
                                          By(
                                              {
                                                  ...
                                                  getApi: (e) => ({
                                                      ...
                                                      isActive: () => dh.isOn(e),
                                                      isEnabled: () => !Rm.isDisabled(e),
                                                      setEnabled: (t) => Rm.set(e, !t)
                                                  }),
                                          ...
                                          { toggling: { toggleClass: yb, toggleOnExecute: !1, selected: e.active, exclusive: !0 } }
                                      );
        ...
        nw = (e, t, o) => {
            ...
            return ri({
                ...
                behaviours: kl([
                    Jp('insert-table-picker-cell', [Ur(qs(), oh.focus), Ur(ur(), n), Ur(er(), s), Ur(gr(), s)]),
                    dh.config({ toggleClass: 'tox-insert-table-picker__selected', toggleOnExecute: !1 }),
                    oh.config({ onFocus: (o) => Ir(o, tw, { row: e, col: t }) })
                ])
            });
        },
        sw = (e) => X(e, (e) => H(e, ai)),
        ...
        aw = {
            inserttable: (e, t) => {
                const o = (
                        (e) => (t, o) =>
                            e.shared.providers.translate(`${o} columns, ${t} rows`)
                    )(t),
                    n = ((e, t, o) => {
                        const n = [];
                        for (let t = 0; t < 10; t++) {
                            ...
                            behaviours: kl([
                                Jp('insert-table-picker', [
                                    ...
                                    $r(tw, (e, t, o) => {
                                        ...
                                        ((e, t, o, n, s) => {
                                            for (let n = 0; n < 10; n++) for (let s = 0; s < 10; s++) dh.set(e[n][s], n <= t && s <= o);
                                        })(n, s, a),
                                            Kp.set(r.get(e), [rw(s + 1, a + 1)]);
                                    }),
                                    $r(ow, (t, o, n) => {
                                        const { row: s, col: r } = n.event;
                                        e.onAction({ numRows: s + 1, numColumns: r + 1 }), Fr(t, hr());
                                    })
                                ]),
                                Pp.config({ initSize: { numRows: 10, numColumns: 10 }, mode: 'flatgrid', selector: '[role="button"]' })
                            ])
                        })
                    ]
                };
            ...
            colorswatch: (e, t) => {
                const o = ((e, t) => {
                        ...
                        return e.initData.colors.fold(
                            () => Gx(t.colorinput.getColors(e.initData.storageKey), e.initData.storageKey, o),
                            (e) => e.concat(Wx(o))
                        );
                    })(e, t),
        ...
        iw = (e) => ({
            type: 'separator',
            dom: { tag: 'div', classes: [fb, 'tox-collection__group-heading'] },
        ...
        dw = Object.freeze({
            ...
            init: () => {
                ...
                return _a({
                    readState: o,
                    getExisting: (e, o, n) =>
                        t(o, n).orThunk(() => (be(o.others, n).getOrDie('No information found for coupled component: ' + n), A.none())),
                    getOrCreate: (o, n, s) =>
                        t(n, s).getOrThunk(() => {
    ...
    const uw = Ol({ fields: cw, name: 'coupling', apis: lw, state: dw }),
        mw = (e) => {
            let t = A.none(),
                o = [];
            const n = (e) => {
        ...
        hw = (e) => {
            ...
            return {
                map: (t) => hw(() => e().then(t)),
                bind: (t) => hw(() => e().then((e) => t(e).toPromise())),
                anonBind: (t) => hw(() => e().then(() => t.toPromise())),
                toLazy: () => gw.nu(t),
                toCached: () => {
                    let t = null;
                    return hw(() => (null === t && (t = e()), t));
                },
                toPromise: e,
                get: t
            };
        },
        fw = (e) => hw(() => new Promise(e)),
        bw = (e) => hw(() => Promise.resolve(e)),
        vw = x('sink'),
        yw = x(
            ju({
                name: vw(),
                overrides: x({
                    dom: { tag: 'div' },
                    behaviours: kl([Sd.config({ useFixed: E })]),
                    ...
                    e.bind((e) =>
                        A.from(
                            Lh.sketch({
                                ...
                                onOpenMenu: (e, t) => {
                                    const n = l().getOrDie();
                                    Sd.position(n, t, { anchor: o }), Xd.decloak(s);
                                },
                                onOpenSubmenu: (e, t, o) => {
                                    const n = l().getOrDie();
                                    Sd.position(n, o, { anchor: { type: 'submenu', item: t } }), Xd.decloak(s);
                                },
                                onRepositionMenu: (e, t, n) => {
                                    const s = l().getOrDie();
                                    Sd.position(s, t, { anchor: o }),
                                        L(n, (e) => {
                                            Sd.position(s, e.triggeredMenu, { anchor: { type: 'submenu', item: e.triggeringItem } });
                                        });
                                },
                                onEscape: () => (oh.focus(n), Xd.close(s), A.some(!0))
                            })
                        )
                    )
                );
        ...
        Sw = (e, t, o, n, s, r, a) => (Xd.close(n), bw(n)),
        kw = (e, t, o, n, s, r) => {
            const a = uw.getCoupled(o, 'sandbox');
        ...
        Cw = (e, t) =>
            e
                ...
                .getOrThunk(() =>
                    t.lazySink.fold(
                        () => () => sn.error(new Error('No internal sink is specified, nor could an external sink be found')),
                        (t) => () => t(e)
                    )
                ),
        Ow = (e) => {
            Xd.getState(e).each((e) => {
        ...
        _w = (e, t, o) => {
            ...
            return {
                ...
                behaviours: yu(e.sandboxBehaviours, [
                    pu.config({ store: { mode: 'memory', initialValue: t } }),
                    Xd.config({
                        onOpen: (s, r) => {
                            const a = xw(e, t);
                            n.link(t.element),
                                e.matchWidth &&
                                    ((e, t, o) => {
                                        const n = wm.getCurrent(t).getOr(t),
                                            s = Jt(e.element);
                                        o
                                            ? Dt(n.element, 'min-width', s + 'px')
                                            : ((e, t) => {
                                                  Kt.set(e, t);
                                              })(n.element, s);
                    ...
                    wm.config({ find: (e) => Xd.getState(e).bind((e) => wm.getCurrent(e)) }),
                    Al.config({ channels: { ...Qd({ isExtraPart: T }), ...tu({ doReposition: Ow }) } })
                ])
            };
        },
        Tw = (e) => {
            const t = uw.getCoupled(e, 'sandbox');
            Ow(t);
        },
        Ew = () => [ys('sandboxClasses', []), vu('sandboxBehaviours', [wm, Al, Xd, pu])],
        Aw = x(
            [
                os('dom'),
                os('fetch'),
                Di('onOpen'),
                Bi('onExecute'),
                ys('getHotspot', A.some),
                ys('getAnchorOverrides', x({})),
                wc(),
                hu('dropdownBehaviours', [dh, uw, Pp, oh]),
                os('toggleClass'),
                ys('eventOrder', {}),
                us('lazySink'),
                ys('matchWidth', !1),
        ...
        Mw = x([Wu({ schema: [Ei(), ys('fakeFocus', !1)], name: 'menu', defaults: (e) => ({ onExecute: e.onExecute }) }), yw()]),
        Dw = bm({
            name: 'Dropdown',
            configFields: Aw(),
            partFields: Mw(),
            factory: (e, t, o, n) => {
                const s = (e) => {
                    ...
                    a = {
                        ...
                        refetch: (t) =>
                            uw.getExistingCoupled(t, 'sandbox').fold(
                                () => r(t, b, zh.HighlightMenuAndItem).map(b),
                                (o) => ww(e, w, t, o, n, b, zh.HighlightMenuAndItem).map(b)
                            ),
                        isOpen: dh.isOn,
                        close: (e) => {
                            dh.isOn(e) && r(e, b, zh.HighlightMenuAndItem).get(b);
                ...
                return {
                    ...
                    dom: e.dom,
                    components: t,
                    behaviours: bu(e.dropdownBehaviours, [
                        dh.config({ toggleClass: e.toggleClass, aria: { mode: 'expanded' } }),
                        uw.config({ others: { sandbox: (t) => _w(e, t, { onOpen: () => dh.on(t), onClose: () => dh.off(t) }) } }),
                        Pp.config({
                            mode: 'special',
                            onSpace: i,
                            onEnter: i,
                            ...
                            onEscape: (e, t) => (Dw.isOpen(e) ? (Dw.close(e), A.some(!0)) : A.none())
                        }),
                        oh.config({})
                    ]),
                    events: mh(
                    ...
                    eventOrder: { ...e.eventOrder, [ur()]: ['disabling', 'toggling', 'alloy.base.behaviour'] },
                    apis: a,
                    domModification: {
                        attributes: {
                            'aria-haspopup': 'true',
        ...
        Bw = (e, t, o) => {
            Ub(e).each((e) => {
                ...
                ((e, t) => {
                    ...
                    (Ua((n = t).element, Gb) ? A.some(n.element) : pi(n.element, '.' + Gb)).each((t) => {
    ...
    const Nw = (e, t, o, n, s) => {
            ...
            switch (e.type) {
                case 'menuitem':
                    return ((i = e), qn('menuitem', sy, i)).fold(Zb, (e) =>
                        A.some(
                            ((e, t, o, n = !0) => {
                                const s = Uy(
                                    {
                                ...
                                return By(
                                    {
                                        data: Fy(e),
                                        getApi: (e) => ({ isEnabled: () => !Rm.isDisabled(e), setEnabled: (t) => Rm.set(e, !t) }),
                                        enabled: e.enabled,
                                        onAction: e.onAction,
                                        onSetup: e.onSetup,
                                        triggersSubmenu: !1,
                ...
                case 'nestedmenuitem':
                    return ((e) => qn('nestedmenuitem', ry, e))(e).fold(Zb, (e) =>
                        A.some(
                            ((e, t, o, n = !0, s = !1) => {
                                const r = s ? ((a = o.icons), Ry('chevron-down', a, [Sb])) : ((e) => Ry('chevron-right', e, [Sb]))(o.icons);
                                var a;
                                const i = Uy(
                                    {
                                        presets: 'normal',
                                ...
                                return By(
                                    {
                                        ...
                                        getApi: (e) => ({
                                            ...
                                            setEnabled: (t) => Rm.set(e, !t),
                                            setIconFill: (t, o) => {
                                                pi(e.element, `svg path[class="${t}"], rect[class="${t}"]`).each((e) => {
                                                    kt(e, 'fill', o);
                                                });
                                            }
                                        }),
                ...
                case 'togglemenuitem':
                    return ((e) => qn('togglemenuitem', ay, e))(e).fold(Zb, (e) =>
                        A.some(
                            ((e, t, o, n = !0) => {
                                const s = Uy(
                                    {
                                ...
                                return fn(
                                    ...
                                    { toggling: { toggleClass: yb, toggleOnExecute: !1, selected: e.active } }
                                );
                            })(a(e), t, r, n)
                        )
                    );
                case 'separator':
                    return ((e) => qn('separatormenuitem', Av, e))(e).fold(Zb, (e) => A.some(iw(e)));
                case 'fancymenuitem':
                    return ((e) => qn('fancymenuitem', ny, e))(e).fold(Zb, (e) =>
                        ((e, t) => be(aw, e.fancytype).map((o) => o(e, t)))(e, o)
                    );
                default:
        ...
        Vw = (e, t, o, n, s, r, a) => {
            ...
            return we(
                H(e, (e) => {
                    switch (e.type) {
                        case 'separator':
                            return ((n = e), qn('Autocompleter.Separator', Av, n)).fold(Zb, (e) => A.some(iw(e)));
                        case 'cardmenuitem':
                            return ((e) => qn('cardmenuitem', Zv, e))(e).fold(Zb, (e) =>
                                A.some(
                                    ((e, t, o, n) => {
                                        const s = {
                                            dom: Py(e.label),
                                            optComponents: [A.some({ dom: { tag: 'div', classes: [Cb, Ob] }, components: Gy(e.items, n) })]
                                        };
                                        return By(
                                            {
                                                data: Fy({ text: A.none(), ...e }),
                                                enabled: e.enabled,
                                                getApi: (e) => ({
                                                    isEnabled: () => !Rm.isDisabled(e),
                                                    setEnabled: (t) => {
                                        ...
                                        s,
                                        r,
                                        { itemBehaviours: Wy(e.meta, r), cardText: { matchText: t, highlightOn: a } }
                                    )
                                )
                            );
                        default:
                            return ((e) => qn('Autocompleter.Item', Mv, e))(e).fold(Zb, (e) =>
                                A.some(
                                    ((e, t, o, n, s, r, a, i = !0) => {
                                        const l = Uy(
                                            {
                                                presets: n,
                                                textContent: A.none(),
                                                htmlContent: o ? e.text.map((e) => jy(e, t)) : A.none(),
                                                ariaLabel: e.text,
                                                iconContent: e.icon,
        ...
        zw = (e, t, o, n, s, r) => {
            const a = Jb(t),
                i = we(
                    H(t, (e) => {
                        const t = (e) => Nw(e, o, n, ((e) => (s ? !ve(e, 'text') : a))(e), s);
        ...
        Lw = (e, t) => {
            const o = Es(!1),
                ...
                s = ri(
                    Ph.sketch({
                        ...
                        inlineBehaviours: kl([Jp('dismissAutocompleter', [Ur(Cr(), () => c())])]),
                        lazySink: t.getSink
                    })
                ),
                r = () => Ph.isOpen(s),
                ...
                l = () => Ph.getContent(s).bind((e) => te(e.components(), 0)),
                c = () => e.execCommand('mceAutocompleterClose'),
                d = (n) => {
                    const r = ((n) => {
                        const s = re(n, (e) => A.from(e.columns)).getOr(1);
                        return X(n, (n) => {
                            const r = n.items;
                            return Vw(
                                r,
                    ...
                    r.length > 0
                        ? ((t, o) => {
                              var n;
                              ((n = Ve(e.getBody())), pi(n, ub)).each((n) => {
                                  const r = re(t, (e) => A.from(e.columns)).getOr(1);
                                  Ph.showMenuAt(
                                      s,
                                      { anchor: { type: 'node', root: Ve(e.getBody()), node: A.from(n) } },
                                      ((e, t, o, n) => {
                                          const s = ew(t, n),
                                              r = Ab(n);
                                          return {
                                              data: Hw({
                                                  ...
                                                  menuBehaviours: ly(
                                                      'auto' !== t
                                                          ...
                                                          : [
                                                                Kr((e, t) => {
                                                                    iy(e, 4, r.item).each(({ numColumns: t, numRows: o }) => {
                                              ...
                                              menu: { markers: Ab(n), fakeFocus: o === Rw.ContentFocus }
                                          };
                                      })(ev('autocompleter-value', !0, o, r, { menuType: 'normal' }), r, Rw.ContentFocus, 'normal')
                                  );
                              }),
            ...
            ((e, t) => {
                const o = (e, t) => {
                    ...
                    n = () => e.getMenu().bind(Gm.getHighlighted);
                t.on('keydown', (t) => {
                    const s = t.which;
                    e.isActive() &&
                        (e.isMenuOpen()
                            ? 13 === s
                                ? (n().each(Rr), t.preventDefault())
                                : 40 === s
                                ? (n().fold(
                                      () => {
            ...
            })({ cancelIfNecessary: c, isMenuOpen: r, isActive: a, isProcessingAction: o.get, getMenu: l }, e);
        },
        Pw = ['visible', 'hidden', 'clip'],
        Uw = (e) => Me(e).length > 0 && !R(Pw, e),
        Ww = (e) => {
            if (je(e)) {
                            ...
                            },
                            {
                                ...
                                value: (s) => (
                                    ...
                                    t
                                        ...
                                        .map((t) => (o.get() ? (s.prevent(), !1) : e.triggerEvent(gr(), s)))
                                )
                            }
                        ]);
                ...
                i = tc(e, 'keydown', (e) => {
                    o.triggerEvent('keydown', e)
                        ...
                        : o.stopBackspace &&
                          ((e) =>
                              e.raw.which === $m[0] &&
                              !R(['input', 'textarea'], Ue(e.target)) &&
                              !$w(e.target, '[contenteditable="true"]'))(e) &&
                          e.prevent();
                }),
                l = tc(e, 'focusin', (e) => {
        ...
        Jw = As([{ stopped: [] }, { resume: ['element'] }, { complete: [] }]),
        Zw = (e, t, o, n, s, r) => {
            const a = e(t, n),
                i = ((e, t) => {
                    const o = Es(!1),
            ...
            return a.fold(
                () => (r.logEventNoHandlers(t, n), Jw.complete()),
                (e) => {
                    const o = e.descHandler;
                    return (
                        Aa(o)(i),
                        i.isStopped()
                            ? (r.logEventStopped(t, e.element, o.purpose), Jw.stopped())
                            : i.isCut()
                            ? (r.logEventCut(t, e.element, o.purpose), Jw.complete())
                            : st(e.element).fold(
                                  () => (r.logNoParent(t, e.element, o.purpose), Jw.complete()),
                                  (n) => (r.logEventResponse(t, e.element, o.purpose), Jw.resume(n))
                              )
                    );
                }
            );
        },
        Qw = (e, t, o, n, s, r) => Zw(e, t, o, n, s, r).fold(E, (n) => Qw(e, t, o, n, s, r), T),
        eS = (e, t, o, n, s) => {
            const r = Kw(o, n);
                    ...
                    return {
                        registerId: (t, o, n) => {
                            le(n, (n, s) => {
                                ...
                                (r[o] = ((e, t) => ({ cHandler: k.apply(void 0, [e.handler].concat(t)), purpose: e.purpose }))(n, t)),
                                    (e[s] = r);
                            });
                        },
                        unregisterId: (t) => {
        ...
        nS = (e) => {
            const t = (t) => st(e.element).fold(E, (e) => Ze(t, e)),
                o = tS(),
                n = (e, n) => o.find(t, e, n),
                s = Yw(e.element, {
                    triggerEvent: (e, t) => Si(e, t.target, (o) => ((e, t, o, n) => eS(e, t, o, o.target, n))(n, e, t, o))
                }),
                r = {
                    debugInfo: x('real'),
                    triggerEvent: (e, t, o) => {
                        Si(e, t, (s) => eS(n, e, o, t, s));
                    },
                    triggerFocus: (e, t) => {
                        pa(e).fold(
                            () => {
                                ...
                                Si(
                                    ...
                                    (o) => (
                                        ((e, t, o, n, s) => {
                                            const r = Kw(o, n);
                                            Zw(e, t, o, n, r, s);
                                        })(n, ir(), { originator: t, kill: b, prevent: b, target: e }, e, o),
                                        !1
                                    )
                                );
                            }
                ...
                a = (e) => {
                    e.connect(r),
                        $e(e.element) || (o.register(e), L(e.components(), a), r.triggerEvent(br(), e.element, { target: e.element }));
                },
                i = (e) => {
                ...
                p = (e) =>
                    o.getById(e).fold(() => sn.error(new Error('Could not find component with uid: "' + e + '" in system.')), sn.value),
                h = (e) => {
        ...
        aS = bm({
            ...
            partFields: rS(),
            factory: (e, t, o, n) => {
                const s = bu(e.fieldBehaviours, [
                        wm.config({ find: (t) => om(t, e, 'field') }),
                        pu.config({
                            store: {
                                mode: 'manual',
                                getValue: (e) => wm.getCurrent(e).bind(pu.getValue),
                                setValue: (e, t) => {
                                    wm.getCurrent(e).each((e) => {
                                        pu.setValue(e, t);
                                    });
                                }
                            }
                    ...
                    r = Hr([
                        Kr((t, o) => {
                            const n = sm(t, e, ['label', 'field', 'aria-descriptor']);
                            n.field().each((t) => {
                                const o = la(e.prefix);
                                n.label().each((e) => {
                    ...
                    a = { getField: (t) => om(t, e, 'field'), getLabel: (t) => om(t, e, 'label') };
    ...
    var iS = Object.freeze({ __proto__: null, exhibit: (e, t) => Ea({ attributes: Ds([{ key: t.tabAttr, value: 'true' }]) }) }),
        lS = [ys('tabAttr', 'data-alloy-tabstop')];
    const cS = Ol({ fields: lS, name: 'tabstopping', active: iS });
    var dS = tinymce.util.Tools.resolve('tinymce.html.Entities');
    const uS = (e, t, o, n) => {
            const s = mS(e, t, o, n);
            return aS.sketch(s);
        },
        mS = (e, t, o, n) => ({ dom: gS(o), components: e.toArray().concat([t]), fieldBehaviours: kl(n) }),
        gS = (e) => ({ tag: 'div', classes: ['tox-form__group'].concat(e) }),
        pS = (e, t) => aS.parts.label({ dom: { tag: 'label', classes: ['tox-label'] }, components: [ti(t.translate(e))] }),
        ...
        _S = (e, t) => {
            ...
            Pa(o, t.invalidClass),
                t.notify.each((t) => {
                    OS(e.element) && kt(e.element, 'aria-invalid', !1),
        ...
        TS = (e, t, o, n) => {
            ...
            La(s, t.invalidClass),
                t.notify.each((t) => {
                    OS(e.element) && kt(e.element, 'aria-invalid', !0),
                        t.getContainer(e).each((e) => {
                            ta(e, n);
                        }),
                        t.onInvalid(e, n);
    ...
    var MS = Object.freeze({
        ...
        BS = [
            ...
            vs('notify', [
                ys('aria', 'alert'),
                ys('getContainer', A.none),
                ys('validHtml', ''),
                Di('onValid'),
                Di('onInvalid'),
                Di('onValidate')
            ]),
            vs('validator', [os('validate'), ys('onEvent', 'input'), ys('validateOnLoad', !0)])
        ];
    const FS = Ol({
            fields: BS,
            name: 'invalidating',
        ...
        zS = ju({ schema: [os('dom')], name: 'label' }),
        HS = (e) =>
            ju({
                name: e + '-edge',
                overrides: (t) =>
    ...
    const XS = x('slider.change.value'),
        YS = (e) => {
            const t = e.event.raw;
        ...
        uk = (e) => e.snapStart,
        mk = (e) => e.rounded,
        gk = (e, t) => void 0 !== e[t + '-edge'],
        pk = (e) => gk(e, 'left'),
        hk = (e) => gk(e, 'right'),
        fk = (e) => gk(e, 'top'),
        bk = (e) => gk(e, 'bottom'),
        vk = (e) => e.model.value.get(),
        yk = (e, t) => ({ x: e, y: t }),
        xk = (e, t) => {
            Ir(e, XS(), { value: t });
        },
        wk = (e, t, o, n) => (e < t ? e : e > o ? o : e === t ? t - 1 : Math.max(t, e - n)),
        Sk = (e, t, o, n) => (e > o ? e : e < t ? t : e === o ? o + 1 : Math.min(o, e + n)),
        kk = (e, t, o) => Math.max(t, Math.min(o, e)),
        Ck = (e) => {
            const {
                    min: t,
                    max: o,
        ...
        Ek = 'bottom',
        Ak = 'left',
        Mk = (e) => e.element.dom.getBoundingClientRect(),
        Dk = (e, t) => e[t],
        Bk = (e) => {
            const t = Mk(e);
            return Dk(t, Ak);
        ...
        Wk = (e) => (t, o) =>
            ((e, t, o) => {
                const n = (e > 0 ? Sk : wk)(vk(o), KS(o), ek(o), ck(o));
                return Pk(t, n), A.some(n);
            })(e, t, o).map(E),
        jk = (e, t, o, n, s, r) => {
            const a = ((e, t, o, n, s) => {
                const r = Nk(e),
                    a = n.bind((t) => A.some(Hk(t, e))).getOr(0),
                    i = s.bind((t) => A.some(Hk(t, e))).getOr(r),
                    l = {
                        min: KS(t),
                        max: ek(t),
                        range: rk(t),
    ...
    var Kk = Object.freeze({
        ...
        getValueFromEvent: (e) => YS(e).map((e) => e.left),
    ...
    const Jk = (e, t) => {
        ...
        Qk = (e) => (t, o) =>
            ((e, t, o) => {
                const n = (e > 0 ? Sk : wk)(vk(o), JS(o), tk(o), ck(o));
                return Jk(t, n), A.some(n);
            })(e, t, o).map(E),
        eC = (e, t, o, n, s, r) => {
            const a = ((e, t, o, n, s) => {
                const r = Vk(e),
                    a = n.bind((t) => A.some(Lk(t, e))).getOr(0),
                    i = s.bind((t) => A.some(Lk(t, e))).getOr(r),
                    l = {
                        min: JS(t),
                        max: tk(t),
                        range: ak(t),
    ...
    var aC = Object.freeze({
        ...
        getValueFromEvent: (e) => YS(e).map((e) => e.top),
    ...
    const fC = bm({
            ...
            configFields: [
                ...
                ns(
                    'model',
                    Jn('mode', {
                        x: [ys('minX', 0), ys('maxX', 100), es('value', (e) => Es(e.mode.minX)), os('getInitialValue'), Ri('manager', Kk)],
                        y: [ys('minY', 0), ys('maxY', 100), es('value', (e) => Es(e.mode.minY)), os('getInitialValue'), Ri('manager', aC)],
                        xy: [
                            ys('minX', 0),
                            ys('maxX', 100),
                            ys('minY', 0),
                            ys('maxY', 100),
                            es('value', (e) => Es({ x: e.mode.minX, y: e.mode.minY })),
                            os('getInitialValue'),
                            Ri('manager', hC)
                        ]
                    })
                ),
                hu('sliderBehaviours', [Pp, pu]),
                es('mouseIsDown', () => Es(!1))
            ],
            partFields: qS,
            factory: (e, t, o, n) => {
                const s = (t) => nm(t, e, 'thumb'),
                    r = (t) => nm(t, e, 'spectrum'),
                    a = (t) => om(t, e, 'left-edge'),
                    i = (t) => om(t, e, 'right-edge'),
                    l = (t) => om(t, e, 'top-edge'),
                    c = (t) => om(t, e, 'bottom-edge'),
                    d = e.model,
                    u = d.manager,
                    m = (t, o) => {
                ...
                return {
                    ...
                    dom: e.dom,
                    components: t,
                    behaviours: bu(e.sliderBehaviours, [
                        Pp.config({ mode: 'special', focusIn: (t) => om(t, e, 'spectrum').map(Pp.focusIn).map(E) }),
                        pu.config({ store: { mode: 'manual', getValue: (e) => d.value.get(), setValue: g } }),
                        Al.config({ channels: { [Jd()]: { onReceive: p } } })
                    ]),
                    events: Hr([
                        Ur(XS(), (t, o) => {
                            ((t, o) => {
        ...
        kC = (e, t) => ({
            ...
            dom: e.dom,
            components: t,
            behaviours: bu(e.formBehaviours, [
                pu.config({
                    store: {
                        mode: 'manual',
                        getValue: (t) => {
            ...
            apis: { getField: (t, o) => om(t, e, o).bind(wm.getCurrent) }
        }),
        CC = {
            ...
            sketch: (e) => {
                const t = (() => {
                        const e = [];
                        return { field: (t, o) => (e.push(t), Ju(xC, SC(t), o)), record: x(e) };
                    })(),
                    o = e(t),
                    n = t.record(),
                    s = H(n, (e) => Uu({ name: e, pname: SC(e) }));
            ...
            const s = (o, n) =>
                    FS.config({
                        ...
                        notify: {
                            ...
                            onValid: (e) => {
                                Ir(e, OC, { type: o, value: pu.getValue(e) });
                            },
                            onInvalid: (e) => {
                                Ir(e, _C, { type: o, value: pu.getValue(e) });
                            }
                        },
                        validator: {
                            validate: (t) => {
                ...
                r = (o, n, r, a, i) => {
                    const l = e(EC + 'range'),
                        c = aS.parts.label({ dom: { tag: 'label', attributes: { 'aria-label': a } }, components: [ti(r)] }),
                        d = aS.parts.field({
                            data: i,
                            factory: Vb,
                        ...
                        u = [c, d],
                        m = 'hex' !== n ? [aS.parts['aria-descriptor']({ text: l })] : [];
                ...
                a = (e, t) => {
                    const o = t.red,
                        n = t.green,
                        s = t.blue;
                    pu.setValue(e, { red: o, green: n, blue: s });
                },
                i = jh({
                    dom: {
                        tag: 'div',
                ...
                c = fm({
                    factory: () => {
                        const s = { red: Es(A.some(255)), green: Es(A.some(255)), blue: Es(A.some(255)), hex: Es(A.some('ffffff')) },
                            c = (e) => s[e].get(),
                            d = (e, t) => {
                                s[e].set(t);
                            },
                            ...
                            g = (e, t) => {
                                ...
                                ((e) => 'hex' === e.type)(n)
                                    ? ((e, t) => {
                                          ...
                                          const s = lx(n);
                                          a(e, s), u(s), Ir(e, bC, { hex: n }), l(e, n);
                                      })(e, n.value)
                                    : ((e, t, o) => {
                                          const n = parseInt(o, 10);
                                          d(t, A.some(n)),
                                              c('red')
                                                  .bind((e) => c('green').bind((t) => c('blue').map((o) => rx(e, t, o, 1))))
                                                  .each((t) => {
                                                      const o = ((e, t) => {
                                                          const o = Qy(t);
                                                          return (
                                                              CC.getField(e, 'hex').each((t) => {
                                                                  oh.isFocused(t) || pu.setValue(e, { hex: o.value });
                                                              }),
                                                              o
                                                          );
                                                      })(e, t);
                            ...
                            p = (t) => ({ label: e(EC + t + '.label'), description: e(EC + t + '.description') }),
                            h = p('red'),
                            f = p('green'),
                            b = p('blue'),
                            v = p('hex');
                        return fn(
                            CC.sketch((o) => ({
                                ...
                                components: [
                                    o.field('red', aS.sketch(r(ax, 'red', h.label, h.description, 255))),
                                    o.field('green', aS.sketch(r(ax, 'green', f.label, f.description, 255))),
                                    o.field('blue', aS.sketch(r(ax, 'blue', b.label, b.description, 255))),
                                    o.field('hex', aS.sketch(r(Ky, 'hex', v.label, v.description, 'ffffff'))),
                                    i.asSpec()
                                ],
                                formBehaviours: kl([
                                    FS.config({ invalidClass: t('form-invalid') }),
        ...
        MC = (e, t) => {
            const o = fm({
                ...
                factory: (o) => {
                    const n = AC(e, t, o.onValidHex, o.onInvalidHex),
                        s = ((e, t) => {
                            const o = fC.parts.spectrum({
                            ...
                            return fm({
                                factory: (e) => {
                                    const r = x({ x: 0, y: 0 }),
                                        a = kl([wm.config({ find: A.some }), oh.config({})]);
                                    return fC.sketch({
                                        dom: { tag: 'div', attributes: { role: 'presentation' }, classes: [t('sv-palette')] },
                                ...
                                apis: {
                                    ...
                                    setThumb: (e, t, o) => {
                                        ((e, t) => {
                                            const o = Tx(lx(t));
                                            fC.setValue(e, { x: o.saturation, y: 100 - o.value });
                                        })(t, o);
                                    }
                                },
                                extraApis: {}
                        ...
                        r = { paletteRgba: Es(mx), paletteHue: Es(0) },
                        a = jh(
                            ((e, t) => {
                                const o = fC.parts.spectrum({
                        ...
                        u = (e, t, o) => {
                            a.getOpt(e).each((e) => {
                                fC.setValue(e, ((e) => 100 - (e / 360) * 100)(o));
                            });
                        },
                        m = (e, t) => {
                            i.getOpt(e).each((e) => {
                    ...
                    return {
                        ...
                        behaviours: kl([
                            ...
                            wm.config({ find: (e) => l.getOpt(e) }),
                            Pp.config({ mode: 'acyclic' })
                        ])
                    };
                }
            });
        ...
        DC = () => wm.config({ find: A.some }),
        BC = (e) => wm.config({ find: (t) => lt(t.element, e).bind((e) => t.getSystem().getByDom(e).toOptional()) }),
        FC = Dn([ys('preprocess', w), ys('postprocess', w)]),
        IC = (e, t) => {
            const o = Yn('RepresentingConfigs.memento processors', FC, t);
            return pu.config({
                store: {
                    mode: 'manual',
                    getValue: (t) => {
        ...
        RC = (e, t, o) =>
            pu.config({ store: { mode: 'manual', ...e.map((e) => ({ initialValue: e })).getOr({}), getValue: t, setValue: o } }),
        NC = (e, t, o) =>
            RC(
                e,
                (e) => t(e.element),
        ...
        VC = (e) => pu.config({ store: { mode: 'memory', initialValue: e } }),
        zC = {
    ...
    const PC = (e, t) => {
        ...
        jC = (e) => ({
            ...
            behaviours: kl([oh.config({ ignore: !0 }), cS.config({})])
        }),
        GC = (e, t) => ({
        ...
        $C = (e, t) => {
            Ir(e, Ks(), { raw: { which: 9, shiftKey: t } });
        },
        qC = (e, t) => {
            const o = t.element;
            Ua(o, UC) ? $C(e, !0) : Ua(o, WC) && $C(e, !1);
        },
        XC = (e) => $w(e, ['.' + UC, '.' + WC].join(','), T),
        YC = la('update-dialog'),
        KC = la('update-title'),
        JC = la('update-body'),
        ZC = la('update-footer'),
        ...
        sO = oO || nO,
        rO = tO.isChromium(),
        aO = ({ scrollTop: e, scrollHeight: t, clientHeight: o }) => Math.ceil(e) + o >= t,
        iO = (e, t) => e.scrollTo(0, 'bottom' === t ? 99999999 : t),
        lO = (e, t, o) => {
            const n = e.dom;
            A.from(n.contentDocument).fold(o, (e) => {
                ...
                const s = ((e, t) => {
                        ...
                        return A.from(
                            !/^<!DOCTYPE (html|HTML)/.test(t) &&
                                ((!rO && !oO) || (g(o) && (0 !== o.scrollTop || Math.abs(o.scrollHeight - o.clientHeight) > 1)))
                                ? o
                                : e.documentElement
                        );
                    })(e, t)
                ...
                oO && n.addEventListener('load', r, { once: !0 }), e.open(), e.write(t), e.close(), oO || r();
            });
        },
        cO = Ce(sO, oO ? 500 : 200).map((e) =>
            ((e, t) => {
                let o = null,
                    n = null;
                return {
        ...
        mO = {
            [ur()]: ['disabling', 'alloy.base.behaviour', 'toggling', 'toolbar-button-events'],
            [Sr()]: ['toolbar-button-events', uO],
            [Ws()]: ['focusing', 'alloy.base.behaviour', uO]
        },
        gO = (e) => Dt(e.element, 'width', It(e.element, 'width')),
        pO = (e, t, o) => ef(e, { tag: 'span', classes: ['tox-icon', 'tox-tbtn__icon-wrap'], behaviours: o }, t),
        hO = (e, t) => pO(e, t, []),
        fO = (e, t) => pO(e, t, [Kp.config({})]),
        bO = (e, t, o) => ({
        ...
        xO = (e, t, o) => {
            const n = Es(b),
                s = e.text.map((e) => jh(bO(e, t, o.providers))),
                r = e.icon.map((e) => jh(fO(e, o.providers.icons))),
                a = (e, t) => {
                    const o = pu.getValue(e);
                    return oh.focus(o), Ir(o, 'keydown', { raw: t.event.raw }), Dw.close(o), A.some(!0);
                },
                i = e.role.fold(
                    () => ({}),
                    (e) => ({ role: e })
                ...
                c = ef('chevron-down', { tag: 'div', classes: [`${t}__select-chevron`] }, o.providers.icons),
                ...
                u = jh(
                    Dw.sketch({
                        ...
                        components: Dy([r.map((e) => e.asSpec()), s.map((e) => e.asSpec()), A.some(c)]),
                        matchWidth: !0,
                        useMinWidth: !0,
                        onOpen: (t, o, n) => {
                            e.searchable &&
                                ((e) => {
                                    Ub(e).each((e) => oh.focus(e));
                                })(n);
                        },
                        dropdownBehaviours: kl([
                            ...e.dropdownBehaviours,
                            ky(() => e.disabled || o.providers.isDisabled()),
                            Sy(),
                            IS.config({}),
                            Kp.config({}),
                            Jp('dropdown-events', [Ty(e, n), Ey(e, n)]),
                            Jp(d, [Kr((e, t) => gO(e))]),
                            Jp('menubutton-update-display-text', [
                                Ur(vO, (e, t) => {
                        ...
                        sandboxBehaviours: kl([
                            Pp.config({ mode: 'special', onLeft: a, onRight: a }),
                            Jp('dropdown-sandbox-events', [
                                Ur(zb, (e, t) => {
                                    ((e) => {
                                        const t = pu.getValue(e),
                                            o = Pb(e).map(Wb);
                                        Dw.refetch(t).get(() => {
                                            const e = uw.getCoupled(t, 'sandbox');
                                            o.each((t) =>
                                                Pb(e).each((e) =>
                                                    ((e, t) => {
                                                        pu.setValue(e, t.fetchPattern),
                                ...
                                Ur(Hb, (e, t) => {
                                    ((e, t) => {
                                        ((e) => Xd.getState(e).bind(Gm.getHighlighted).bind(Gm.getHighlighted))(e).each((o) => {
                                            ((e, t, o, n) => {
                                                const s = { ...n, target: t };
                                                e.getSystem().triggerEvent(o, t, s);
                        ...
                        parts: {
                            menu: {
                                ...Bb(0, e.columns, e.presets),
                                fakeFocus: e.searchable,
                                onHighlightItem: Bw,
                                onCollapseMenu: (e, t, o) => {
                                    Gm.getHighlighted(o).each((t) => {
                                        Bw(e, o, t);
                                    });
                                },
                        ...
                        fetch: (t) => fw(k(e.fetch, t))
                    })
                );
            return u.asSpec();
        },
        wO = (e) => 'separator' === e.type,
        SO = { type: 'separator' },
        kO = (e, t) => {
            const o = ((e, t) => {
                const o = j(
                    ...
                    if (((e) => ve(e, 'getSubmenuItems'))(o)) {
                        const n = ((e) => {
                            ...
                            s = ((e, t) => {
                                ...
                                return {
                                    item: e,
                                    menus: fn(n.menus, { [e.value]: n.items }),
                                    expansions: fn(n.expansions, { [e.value]: e.value })
                                };
                            })(n, t);
                        return { menus: fn(e.menus, s.menus), items: [s.item, ...e.items], expansions: fn(e.expansions, s.expansions) };
                    }
        ...
        CO = (e, t, o, n) => {
            ...
            const a = ((e) =>
                ...
                c = ce(r.menus, (e, n) => zw(n, e, t, o, !1, l)),
                d = fn(c, Ms(s, i));
            ...
            H(o, (o) =>
                OO(o)
                    ? {
                          ...
                          active: o.value === n,
                          onAction: () => {
                              pu.setValue(e, o.value), Ir(e, hS, { name: t }), oh.focus(e);
                          }
                      }
                    : { type: 'nestedmenuitem', text: o.text, getSubmenuItems: () => TO(e, t, o.items, n) }
            ),
        EO = (e, t) => re(e, (e) => (OO(e) ? Ce(e.value === t, e) : EO(e.items, t))),
        AO = fm({
            name: 'HtmlSelect',
            configFields: [
                os('options'),
                hu('selectBehaviours', [oh, pu]),
                ys('selectClasses', []),
                ys('selectAttributes', {}),
                us('data')
            ],
            factory: (e, t) => {
                const o = H(e.options, (e) => ({ dom: { tag: 'option', value: e.value, innerHtml: e.text } })),
                    n = e.data.map((e) => Ms('initialValue', e)).getOr({});
                return {
                    uid: e.uid,
                    dom: { tag: 'select', classes: e.selectClasses, attributes: e.selectAttributes },
                    components: o,
                    behaviours: bu(e.selectBehaviours, [
                        oh.config({}),
                        pu.config({
                            store: {
                                mode: 'manual',
                                ...
                                setValue: (t, o) => {
                                    ...
                                    G(e.options, (e) => e.value === o).isSome()
                                        ? qa(t.element, o)
                                        : -1 === t.element.dom.selectedIndex && '' === o && n.each((e) => qa(t.element, e.value));
                                },
                                ...n
                            }
                        })
        ...
        MO = x([
            ys('field1Name', 'field1'),
            ys('field2Name', 'field2'),
            Fi('onLockedChange'),
            Ai(['lockClass']),
            ys('locked', !1),
            vu('coupledFieldBehaviours', [wm, pu])
        ]),
        DO = (e, t) =>
            Uu({
                factory: aS,
                ...
                overrides: (e) => ({
                    fieldBehaviours: kl([
                        Jp('coupled-input-behaviour', [
                            Ur(Zs(), (o) => {
                                ((e, t, o) => om(e, t, o).bind(wm.getCurrent))(o, e, t).each((t) => {
                                    om(o, e, 'lock').each((n) => {
        ...
        BO = x([
            ...
            Uu({
                ...
                name: 'lock',
                overrides: (e) => ({
                    buttonBehaviours: kl([dh.config({ selected: e.locked, toggleClass: e.markers.lockClass, aria: { mode: 'pressed' } })])
                })
            })
        ]),
        FO = bm({
            ...
            factory: (e, t, o, n) => ({
                ...
                dom: e.dom,
                components: t,
                behaviours: yu(e.coupledFieldBehaviours, [
                    wm.config({ find: A.some }),
                    pu.config({
                        store: {
                            mode: 'manual',
                            getValue: (t) => {
                                const o = im(t, e, ['field1', 'field2']);
                                return { [e.field1Name]: pu.getValue(o.field1()), [e.field2Name]: pu.getValue(o.field2()) };
                            },
                            setValue: (t, o) => {
                                const n = im(t, e, ['field1', 'field2']);
                                ye(o, e.field1Name) && pu.setValue(n.field1(), o[e.field1Name]),
                                    ye(o, e.field2Name) && pu.setValue(n.field2(), o[e.field2Name]);
                            }
                        }
                    })
                ]),
                apis: { getField1: (t) => om(t, e, 'field1'), getField2: (t) => om(t, e, 'field2'), getLock: (t) => om(t, e, 'lock') }
            }),
        ...
        IO = (e) => {
            ...
            if (null !== t) {
                const e = parseFloat(t[1]),
                    o = t[2];
                return sn.value({ value: e, unit: o });
            }
            return sn.error(e);
        },
        RO = (e, t) => {
        ...
        NO = (e) => A.none(),
        VO = (e, t) => {
            const o = e.label.map((e) => pS(e, t)),
                n = [
                    Rm.config({ disabled: () => e.disabled || t.isDisabled() }),
                    Sy(),
                    Pp.config({
                        mode: 'execution',
                        useEnter: !0 !== e.multiline,
                        useControlEnter: !0 === e.multiline,
                        execute: (e) => (Fr(e, yS), A.some(!0))
                    }),
                    Jp('textfield-change', [
                        Ur(Zs(), (t, o) => {
                            Ir(t, hS, { name: e.name });
        ...
        HO = (e) => e.dimension.property,
        LO = (e, t) => e.dimension.getDimension(t),
        PO = (e, t) => {
            const o = zO(e, t);
    ...
    var KO = Object.freeze({
            ...
            isGrowing: XO,
            isShrinking: YO,
            isTransitioning: (e, t, o) => XO(e, t) || YO(e, t),
            toggleGrow: (e, t, o) => {
            ...
            immediateGrow: (e, t, o) => {
                o.isExpanded() ||
                    (WO(e, t), Dt(e.element, HO(t), LO(t, e.element)), PO(e, t), o.setExpanded(), t.onStartGrow(e), t.onGrown(e));
            }
        }),
        JO = Object.freeze({
            __proto__: null,
            exhibit: (e, t, o) => {
                const n = t.expanded;
                return Ea(
                    n ? { classes: [t.openClass], styles: {} } : { classes: [t.closedClass], styles: Ms(t.dimension.property, '0px') }
                );
            },
            events: (e, t) =>
                Hr([
                    Yr(or(), (o, n) => {
                        n.event.raw.propertyName === e.dimension.property &&
                            (PO(o, e), t.isExpanded() && Ht(o.element, e.dimension.property), (t.isExpanded() ? e.onGrown : e.onShrunk)(o));
                    })
                ])
        }),
        ZO = [
    ...
    const QO = Ol({
            ...
            xO(
                {
                    ...
                    role: n,
                    fetch: (t, n) => {
                        const s = { pattern: e.search.isSome() ? Iw(t) : '' };
                        e.fetch(
                            (t) => {
                                n(CO(t, pb.CLOSE_ON_EXECUTE, o, { isHorizontalMenu: !1, search: e.search }));
                            },
                            s,
                            e_(t)
                        );
                    ...
                    presets: 'normal',
                    classes: [],
                    dropdownBehaviours: [...(s ? [cS.config({})] : [])]
                },
                t,
                o.shared
            ),
                    ...
                    n.setActive(s),
                        ...
                        o.shared.getSink().each((o) => {
                            t()
                                .getOpt(o)
                                .each((t) => {
                                    Dl(t.element), Ir(t, vS, { name: e.name, value: e.storage.get() });
                                });
                        });
                },
                s = (e) => (t) => {
        ...
        n_ = (e) => ({
            dom: { tag: 'span', classes: ['tox-tree__label'], attributes: { title: e, 'aria-label': e } },
            components: [ti(e)]
        }),
        s_ = la('leaf-label-event-id'),
        r_ = ({ leaf: e, onLeafAction: t, visible: o, treeId: n, selectedId: s, backstage: r }) => {
            const a = e.menu.map((e) => t_(e, 'tox-mbtn', r, A.none(), o)),
                i = [n_(e.title)];
            return (
                a.each((e) => i.push(e)),
                Wh.sketch({
                    ...
                    eventOrder: { [Ks()]: [s_, 'keying'] },
                    buttonBehaviours: kl([
                        ...(o ? [cS.config({})] : []),
                        dh.config({ toggleClass: 'tox-trbtn--enabled', toggleOnExecute: !1, aria: { mode: 'selected' } }),
                        Al.config({
                            channels: {
        ...
        i_ = ({ directory: e, visible: t, noChildren: o, backstage: n }) => {
            const s = e.menu.map((e) => t_(e, 'tox-mbtn', n, A.none())),
                r = [
                    {
                        ...
                        components: [
                            ...
                            ((e, t, o) => ef(e, { tag: 'span', classes: ['tox-tree__icon-wrap', 'tox-icon'], behaviours: [] }, t))(a, i))
                        ]
                    },
                    n_(e.title)
                ];
            ...
            const l = (t) => {
                mi(t.element, '.tox-tree--directory').each((o) => {
                    t.getSystem()
                        .getByDom(o)
                        .each((o) => {
                            const n = !dh.isOn(o);
                            dh.toggle(o), Ir(t, 'expand-tree-node', { expanded: n, node: e.id });
                        });
                });
            };
            return Wh.sketch({
                ...
                buttonBehaviours: kl([
                    ...
                    Jp(a_, [
                        Ur(Ks(), (e, t) => {
                            ...
                            n && o && t.stop(),
                                (n || s) &&
                                    mi(e.element, '.tox-tree--directory').each((o) => {
                                        e.getSystem()
                                            .getByDom(o)
                                            .each((o) => {
                                                (!dh.isOn(o) && n) || (dh.isOn(o) && s)
                                                    ? (l(e), t.stop())
                                                    : s &&
                                                      !dh.isOn(o) &&
                                                      (mi(o.element, '.tox-tree--directory').each((e) => {
        ...
        l_ = ({ children: e, onLeafAction: t, visible: o, treeId: n, expandedIds: s, selectedId: r, backstage: a }) => ({
            dom: { tag: 'div', classes: ['tox-tree--directory__children'] },
            components: e.map((e) =>
                'leaf' === e.type
                    ? r_({ leaf: e, selectedId: r, onLeafAction: t, visible: o, treeId: n, backstage: a })
                    : d_({ directory: e, expandedIds: s, selectedId: r, onLeafAction: t, labelTabstopping: o, treeId: n, backstage: a })
            ),
            behaviours: kl([
                QO.config({
        ...
        d_ = ({ directory: e, onLeafAction: t, labelTabstopping: o, treeId: n, backstage: s, expandedIds: r, selectedId: a }) => {
            const { children: i } = e,
                l = Es(r),
                c = r.includes(e.id);
            return {
                ...
                components: [
                    i_({ directory: e, visible: o, noChildren: 0 === e.children.length, backstage: s }),
                    l_({ children: i, expandedIds: r, selectedId: a, onLeafAction: t, visible: c, treeId: n, backstage: s })
                ],
                behaviours: kl([
                    Jp(c_, [
                        Kr((e, t) => {
                        ...
                        onToggled: (e, o) => {
                            const r = e.components()[1],
                                c =
                                    ...
                                    i.map((e) =>
                                        'leaf' === e.type
                                            ? r_({ leaf: e, selectedId: a, onLeafAction: t, visible: d, treeId: n, backstage: s })
                                            : d_({
                                                  directory: e,
                                                  expandedIds: l.get(),
                                                  selectedId: a,
    ...
    var m_ = Object.freeze({
        ...
        events: (e, t) => {
            ...
            return Hr([Ur(e.event, o), Jr(() => t.cancel())].concat(e.cancelEvent.map((e) => [Ur(e, () => t.cancel())]).getOr([])));
        }
    });
    const g_ = (e) => {
        const t = Es(null);
    ...
    var p_ = Object.freeze({ __proto__: null, throttle: g_, init: (e) => e.stream.streams.state(e) }),
        h_ = [
            ns(
                'stream',
                Jn('mode', {
    ...
    const f_ = Ol({ fields: h_, name: 'streaming', active: m_, state: p_ }),
        b_ = (e, t, o) => {
            const n = pu.getValue(o);
        ...
        y_ = (e) => {
            v_(e, (e, t) => e.setSelectionRange(t.length, t.length));
        },
        ...
        w_ = x(
            [
                ...
                ys('eventOrder', {}),
                Ts('model', {}, [
                    ys('getDisplayText', (e) => (void 0 !== e.meta && void 0 !== e.meta.text ? e.meta.text : e.value)),
                    ys('selectsOver', !0),
                    ys('populateFromBrowse', !0)
                ]),
                Di('onSetValue'),
                Bi('onExecute'),
                Di('onItemExecute'),
                ...
                Ai(['openClass']),
                us('initialData'),
                hu('typeaheadBehaviours', [oh, pu, f_, Pp, dh, uw]),
                es('lazyTypeaheadComp', () => Es(A.none)),
                es('previewing', () => Es(!0))
            ]
                .concat(Fb())
                .concat(Ew())
                ...
                overrides: (e) => ({
                    ...
                    onHighlightItem: (t, o, n) => {
                        e.previewing.get()
                                      ...
                                      if (e.selectsOver) {
                                          ...
                                          return 0 === e.getDisplayText(r).indexOf(s)
                                              ? A.some(() => {
                                                    b_(0, t, o),
                                                        ((e, t) => {
                                                            v_(e, (e, o) => e.setSelectionRange(t, o.length));
                                                        })(t, s.length);
                                                })
                                              : A.none();
                                      }
                            ...
                            : e.lazyTypeaheadComp.get().each((t) => {
                                  e.model.populateFromBrowse && b_(e.model, t, n),
                                      _t(n.element, 'id').each((e) => kt(t.element, 'aria-activedescendant', e));
                              });
                    },
                    onExecute: (t, o) => e.lazyTypeaheadComp.get().map((e) => (Ir(e, x_(), { item: o }), !0)),
                    onHover: (t, o) => {
                        e.previewing.set(!1),
                            e.lazyTypeaheadComp.get().each((t) => {
        ...
        k_ = bm({
            ...
            factory: (e, t, o, n) => {
                const s = (t, o, s) => {
                        e.previewing.set(!1);
                        const r = uw.getCoupled(t, 'sandbox');
                        if (Xd.isOpen(r))
                            wm.getCurrent(r).each((e) => {
                                Gm.getHighlighted(e).fold(
                                    () => {
                                        s(e);
                                    },
                                    () => {
                            ...
                            const o = (e) => {
                                wm.getCurrent(e).each(s);
                            };
                            ww(e, a(t), t, r, n, o, zh.HighlightMenuAndItem).get(b);
                        }
                    },
                    r = Ib(e),
                    a = (e) => (t) =>
                        t.map((t) => {
                            ...
                            return pu.getState(e).update(H(n, (e) => e.data)), t;
                        }),
                    i = (e) => wm.getCurrent(e),
                    l = 'typeaheadevents',
                    c = [
                        ...
                        pu.config({
                            ...
                            store: {
                                ...
                                ...e.initialData.map((e) => Ms('initialValue', e)).getOr({})
                            }
                        }),
                        f_.config({
                            stream: { mode: 'throttle', delay: e.responseTime, stopEvent: !1 },
                            onStream: (t, o) => {
                                const s = uw.getCoupled(t, 'sandbox');
                                if (oh.isFocused(t) && $a(t.element).length >= e.minChars) {
                                    const o = i(s).bind((e) => Gm.getHighlighted(e).map(pu.getValue));
                                    e.previewing.set(!0);
                                    const r = (t) => {
                                        i(s).each((t) => {
                                            o.fold(
                                                ...
                                                (e) => {
                                                    Gm.highlightBy(t, (t) => pu.getValue(t).value === e.value),
                                                        Gm.getHighlighted(t).orThunk(() => (Gm.highlightFirst(t), A.none()));
                                                }
                                            );
                                        });
                                    };
                                    ww(e, a(t), t, s, n, r, zh.HighlightJustMenu).get(b);
                                }
                            },
                            cancelEvent: fr()
                        }),
                        Pp.config({
                            mode: 'special',
                            onDown: (e, t) => (s(e, t, Gm.highlightFirst), A.some(!0)),
                            onEscape: (e) => {
                                const t = uw.getCoupled(e, 'sandbox');
                                return Xd.isOpen(t) ? (Xd.close(t), A.some(!0)) : A.none();
                            },
                            onUp: (e, t) => (s(e, t, Gm.highlightLast), A.some(!0)),
                            onEnter: (t) => {
                                const o = uw.getCoupled(t, 'sandbox'),
                                    n = Xd.isOpen(o);
                                if (n && !e.previewing.get())
                                    return i(o)
                                        .bind((e) => Gm.getHighlighted(e))
                                        .map((e) => (Ir(t, x_(), { item: e }), !0));
                                {
                                    const s = pu.getValue(t);
                                    return Fr(t, fr()), e.onExecute(o, t, s), n && Xd.close(o), A.some(!0);
                                }
                            }
                        }),
                        dh.config({ toggleClass: e.markers.openClass, aria: { mode: 'expanded' } }),
                        uw.config({
                            others: {
                                sandbox: (t) =>
                                    _w(e, t, {
                                        onOpen: () => dh.on(t),
                                        onClose: () => {
                                            e.lazyTypeaheadComp.get().each((e) => Et(e.element, 'aria-activedescendant')), dh.off(t);
                                        }
                                    })
                            }
                        }),
                        Jp(
                            ...
                            [
                                ...
                                Ur(x_(), (t, o) => {
                                    const n = uw.getCoupled(t, 'sandbox');
                                    b_(e.model, t, o.event.item),
                                        Fr(t, fr()),
                                        e.onItemExecute(t, n, o.event.item, pu.getValue(t)),
                                        Xd.close(n),
                                        y_(t);
                                })
                            ].concat(
                    ...
                    d = { [kr()]: [pu.name(), f_.name(), l], ...e.eventOrder };
                return {
                    uid: e.uid,
                    dom: Nb(fn(e, { inputAttributes: { role: 'combobox', 'aria-autocomplete': 'list', 'aria-haspopup': 'true' } })),
                    behaviours: { ...r, ...bu(e.typeaheadBehaviours, c) },
                    eventOrder: d
                };
            }
        }),
        C_ = (e) => ({
            ...
            bindResult: (t) => C_(e.map((e) => e.bind(t))),
            mapResult: (t) => C_(e.map((e) => e.map(t))),
            mapError: (t) => C_(e.map((e) => e.mapError(t))),
        ...
        __ = (e, t, o = [], n, s, r) => {
            const a = t.fold(
                ...
                i = {
                    buttonBehaviours: kl(
                        [
                            ky(() => !e.enabled || r.isDisabled()),
                            Sy(),
                            cS.config({}),
                            Jp('button press', [Pr('click'), Pr('mousedown')])
                        ].concat(o)
                    ),
        ...
        A_ = (e, t, o, n = [], s = []) => {
            const r = o.translate(e.text),
                a = e.icon.map((e) => hO(e, o.icons)),
                i = [a.getOrThunk(() => ti(r))],
                l = e.buttonType.getOr(e.primary || e.borderless ? 'primary' : 'secondary'),
                c = [...E_(l), ...(a.isSome() ? ['tox-button--icon'] : []), ...(e.borderless ? ['tox-button--naked'] : []), ...s];
            return __(e, t, n, { tag: 'button', classes: c, attributes: { title: r } }, i, o);
        },
        M_ = (e, t, o, n = [], s = []) => {
            const r = A_(e, A.some(t), o, n, s);
            return Wh.sketch(r);
        },
        D_ = (e, t) => (o) => {
            'custom' === t
                ? Ir(o, vS, { name: e, value: {} })
                : 'submit' === t
                ? Fr(o, yS)
                : 'cancel' === t
                ? Fr(o, bS)
            ...
            if (((e, t) => 'menu' === t)(0, t)) {
                const t = () => r,
                    ...
                    s = {
                        ...
                        fetch: o_(n.items, t, o)
                    },
                    r = jh(t_(s, 'tox-tbtn', o, A.none()));
                return r.asSpec();
            }
            if (((e, t) => 'custom' === t || 'cancel' === t || 'submit' === t)(0, t)) {
                const n = D_(e.name, t),
                    s = { ...e, borderless: !1 };
                return M_(s, n, o.shared.providers, []);
            }
            if (((e, t) => 'togglebutton' === t)(0, t))
                return ((e, t) => {
                    var o, n;
                    const s = e.icon.map((e) => fO(e, t.icons)).map(jh),
                        ...
                        i = a.tooltip.map((e) => ({ 'aria-label': t.translate(e), title: t.translate(e) })).getOr({}),
                        ...
                        m = ti(u),
                        g = [...Dy([s.map((e) => e.asSpec())]), ...(e.text.isSome() ? [m] : [])],
                        p = __(
                            a,
                            A.some((o) => {
                                Ir(o, vS, {
        ...
        F_ = { type: 'separator' },
        I_ = (e) => ({ type: 'menuitem', value: e.url, text: e.title, meta: { attach: e.attach }, onAction: b }),
        R_ = (e, t) => ({ type: 'menuitem', value: t, text: e, meta: { attach: void 0 }, onAction: b }),
        N_ = (e, t) => ((e) => H(e, I_))(((e, t) => U(t, (t) => t.type === e))(e, t)),
        V_ = (e) => N_('header', e.targets),
        z_ = (e) => N_('anchor', e.targets),
        H_ = (e) =>
            A.from(e.anchorTop)
                .map((e) => R_('<top>', e))
                .toArray(),
        ...
        $_ = {
            ...
            collection: G_((e, t, o) =>
                ((e, t, o) => {
                    const n = e.label.map((e) => pS(e, t)),
                        ...
                        r = s((o, n, s, r) => {
                            n.stop(), t.isDisabled() || Ir(o, vS, { name: e.name, value: r });
                        }),
                        a = [
                            Ur(
                                qs(),
                            ...
                            Qr(
                                s((t, o, n, s) => {
                                    Ir(t, vS, { name: e.name, value: s });
                                })
                            )
                        ],
                        i = (e, t) => H(Xc(e.element, '.tox-collection__item'), t),
                        l = aS.parts.field({
                            dom: {
                                tag: 'div',
                            ...
                            behaviours: kl([
                                    ...
                                    onSetValue: (o, n) => {
                                        ((o, n) => {
                                            const s = H(n, (o) => {
                                                    ...
                                                    }" tabindex="-1" data-collection-item-value="${dS.encodeAllRaw(
                                                        o.value
                                                    )}" title="${i}" aria-label="${i}">${r}${s}</div>`;
                                                }),
                                                r = 'auto' !== e.columns && e.columns > 1 ? z(s, e.columns) : [s],
                                                a = H(r, (e) => `<div class="tox-collection__group">${e.join('')}</div>`);
                                            ta(o.element, a.join(''));
                                        })(o, n),
                                            'auto' === e.columns &&
                                                iy(o, 5, 'tox-collection__item').each(({ numRows: e, numColumns: t }) => {
                                ...
                                Pp.config(
                                    ...
                                    1 === c
                                        ...
                                        : { mode: 'matrix', selectors: { row: '.tox-collection__group', cell: `.${fb}` } })
                                ),
                                Jp('collection-events', a)
                            ]),
                            eventOrder: { [ur()]: ['disabling', 'alloy.base.behaviour', 'collection-events'] }
                        });
                    var c;
                                ...
                                components: e.url
                                    ? [
                                          Wh.sketch({
                                              ...
                                              action: (t) => Ir(t, vS, { name: 'alert-banner', value: e.url }),
            ...
            label: G_((e, t) =>
                ((e, t) => {
                    ...
                    return {
                        ...
                        behaviours: kl([DC(), Kp.config({}), ((n = A.none()), NC(n, ea, ta)), Pp.config({ mode: 'acyclic' })])
                    };
                    var n;
                })(e, t.shared)
            ),
            iframe:
                                ...
                                return {
                                    ...
                                    setValue: (e, n) => {
                                        if (o.get() !== n) {
                                            const o = e.element,
                                                s = () => kt(o, 'srcdoc', n);
                                            t ? cO.fold(x(lO), (e) => e.throttle)(o, n, s) : s();
                                        }
                                        o.set(n);
                                    }
                                };
                            })(o, e.streamContent),
                            l = e.label.map((e) => pS(e, t)),
                            c = aS.parts.field({
                                factory: {
                                    sketch: (e) =>
                                        GC(A.from(r), {
                ...
                (e, t, o, n) => {
                    const s = fn(t, { source: 'dynamic' });
                    return G_(vE)(e, s, o, n);
                }),
            button: G_((e, t) =>
                ((e, t) => {
                    const o = D_(e.name, 'custom');
                    return (n = A.none()), (s = aS.parts.field({ factory: Wh, ...A_(e, A.some(o), t, [VC(''), DC()]) })), uS(n, s, [], []);
                    var n, s;
                })(e, t.shared.providers)
            ),
            checkbox: G_((e, t, o) =>
                ((e, t, o) => {
                    const n = (e) => (e.element.dom.click(), A.some(!0)),
                        s = aS.parts.field({
                            ...
                            behaviours: kl([
                                ...
                                Rm.config({
                                    ...
                                    onDisabled: (e) => {
                                        rt(e.element).each((e) => La(e, 'tox-checkbox--disabled'));
                                    },
                                    onEnabled: (e) => {
                                        rt(e.element).each((e) => Pa(e, 'tox-checkbox--disabled'));
                                    }
                                }),
                                cS.config({}),
                                oh.config({}),
                                NC(o, j_, W_),
                                Pp.config({ mode: 'special', onEnter: n, onSpace: n, stopSpaceKeyup: !0 }),
                                Jp('checkbox-events', [
                                    Ur(Qs(), (t, o) => {
                                        Ir(t, hS, { name: e.name });
                                    })
                        ...
                        i = jh({ dom: { tag: 'div', classes: ['tox-checkbox__icons'] }, components: [a('checked'), a('unchecked')] });
                    return aS.sketch({
                        dom: { tag: 'label', classes: ['tox-checkbox'] },
                        components: [s, i.asSpec(), r],
                        fieldBehaviours: kl([Rm.config({ disabled: () => !e.enabled || t.isDisabled() }), Sy()])
                    });
                })(e, t.shared.providers, o)
            ),
            colorinput: G_((e, t, o) =>
                ((e, t, o, n) => {
                    const s = aS.parts.field({
                            factory: Vb,
                            inputClasses: ['tox-textfield'],
                            data: n,
                            onSetValue: (e) => FS.run(e).get(b),
                            inputBehaviours: kl([
                                Rm.config({ disabled: t.providers.isDisabled }),
                                Sy(),
                                cS.config({}),
                                FS.config({
                                    ...
                                    validator: {
                                        ...
                                        validate: (e) => {
                                            ...
                                            if (0 === t.length) return bw(sn.value(!0));
                                            {
                                                ...
                                                const o = Nt(e, 'background-color').fold(
                                                    () => sn.error('blah'),
                                                    (e) => sn.value(t)
                                                );
                                                return bw(o);
                        ...
                        r = e.label.map((e) => pS(e, t.providers)),
                        a = (e, t) => {
                            Ir(e, NS, { value: t });
                        },
                        i = jh(
                    ...
                    return aS.sketch({
                        ...
                        components: r
                            .toArray()
                            .concat([{ dom: { tag: 'div', classes: ['tox-color-input'] }, components: [s, i.asSpec()] }]),
                        fieldBehaviours: kl([
                            Jp('form-field-events', [
                                Ur(RS, (t, o) => {
                                    i.getOpt(t).each((e) => {
                    ...
                    const n = (e) => 'tox-' + e,
                        ...
                        r = jh(
                            s.sketch({
                                ...
                                onValidHex: (e) => {
                                    Ir(e, vS, { name: 'hex-valid', value: !0 });
                                },
                                onInvalidHex: (e) => {
                                    Ir(e, vS, { name: 'hex-valid', value: !1 });
                                }
                            })
                        );
                    return {
                            ...
                            RC(
                                ...
                                (e, t) => {
                                    const o = A.from(/^#([a-fA-F0-9]{3}(?:[a-fA-F0-9]{3})?)/.exec(t)).bind((e) => te(e, 1)),
                                        n = r.get(e);
                                    wm.getCurrent(n).fold(
                                        () => {
                                            console.log('Can not find form');
                                        },
                                        (e) => {
                                            pu.setValue(e, { hex: o.getOr('') }),
                                                CC.getField(e, 'hex').each((e) => {
                                                    Fr(e, Zs());
                                                });
                                        }
                                    );
                            ...
                            factory: {
                                sketch: (e) => ({
                                    ...
                                    behaviours: kl([
                                        ...
                                        DC(),
                                        Rm.config({}),
                                        dh.config({ toggleClass: 'dragenter', toggleOnExecute: !1 }),
                                        Jp('dropzone-events', [
                                            Ur('dragenter', s([n, dh.toggle])),
                                            Ur('dragleave', s([n, dh.toggle])),
                                            Ur('dragover', n),
                                            Ur('drop', s([n, r])),
                                            Ur(Qs(), a)
                                        ])
                                    ...
                                    components: [
                                        {
                                            ...
                                            components: [
                                                { dom: { tag: 'p' }, components: [ti(t.translate('Drop an image here'))] },
                                                Wh.sketch({
                                                    dom: {
                                                        tag: 'button',
            ...
            listbox: G_((e, t, o) =>
                ((e, t, o) => {
                    const n = t.shared.providers,
                        s = o.bind((t) => EO(e.items, t)).orThunk(() => oe(e.items).filter(OO)),
                        r = e.label.map((e) => pS(e, n)),
                        a = aS.parts.field({
                            dom: {},
                            factory: {
                                sketch: (o) =>
                                    xO(
                                        {
                                            ...
                                            role: A.none(),
                                            fetch: (o, n) => {
                                                const s = TO(o, e.name, e.items, pu.getValue(o));
                                                n(CO(s, pb.CLOSE_ON_EXECUTE, t, { isHorizontalMenu: !1, search: A.none() }));
                                            },
                                            onSetup: x(b),
                                            getApi: x({}),
                                            columns: 1,
                                            ...
                                            dropdownBehaviours: [
                                                ...
                                                RC(
                                                    ...
                                                    (t, o) => {
                                                        EO(e.items, o).each((e) => {
                                                            kt(t.element, _O, e.value), Ir(t, vO, { text: e.text });
                                                        });
                                                    }
                                                )
                                            ]
            ...
            selectbox: G_((e, t, o) =>
                ((e, t, o) => {
                    const n = H(e.items, (e) => ({ text: t.translate(e.text), value: e.value })),
                        s = e.label.map((e) => pS(e, t)),
                        r = aS.parts.field({
                            dom: {},
                            ...
                            factory: AO,
                            selectBehaviours: kl([
                                Rm.config({ disabled: () => !e.enabled || t.isDisabled() }),
                                cS.config({}),
                                Jp('selectbox-change', [
                                    Ur(Qs(), (t, o) => {
                                        Ir(t, hS, { name: e.name });
                        ...
                        a =
                            e.size > 1
                                ? A.none()
                                : A.some(ef('chevron-down', { tag: 'div', classes: ['tox-selectfield__icon-js'] }, t.icons)),
            ...
            sizeinput: G_((e, t) =>
                ((e, t) => {
                    ...
                    const n = la('ratio-event'),
                        s = (e) => ef(e, { tag: 'span', classes: ['tox-icon', 'tox-lock-icon__' + e] }, t.icons),
                        r = FO.parts.lock({
                            dom: {
                                tag: 'button',
                            ...
                            buttonBehaviours: kl([Rm.config({ disabled: () => !e.enabled || t.isDisabled() }), Sy(), cS.config({})])
                        }),
                        ...
                        l = (e) => ({ dom: { tag: 'label', classes: ['tox-label'] }, components: [ti(t.translate(e))] }),
                        c = FO.parts.field1(a([aS.parts.label(l('Width')), i(!0)])),
                        d = FO.parts.field2(a([aS.parts.label(l('Height')), i(!1)]));
                    return FO.sketch({
                        dom: { tag: 'div', classes: ['tox-form__group'] },
                        components: [
                            { dom: { tag: 'div', classes: ['tox-form__controls-h-stack'] }, components: [c, d, a([l('\xa0'), r])] }
                        ],
                        field1Name: 'width',
                        field2Name: 'height',
                        locked: !0,
                        ...
                        coupledFieldBehaviours: kl([
                            Rm.config({
                                disabled: () => !e.enabled || t.isDisabled(),
                                onDisabled: (e) => {
                                    FO.getField1(e).bind(aS.getField).each(Rm.disable),
                                        FO.getField2(e).bind(aS.getField).each(Rm.disable),
                                        FO.getLock(e).each(Rm.disable);
                                },
                                onEnabled: (e) => {
                                    FO.getField1(e).bind(aS.getField).each(Rm.enable),
                                        FO.getField2(e).bind(aS.getField).each(Rm.enable),
                                        FO.getLock(e).each(Rm.enable);
                                }
                            }),
                            Sy(),
                            Jp('size-input-events2', [
                                Ur(n, (e, t) => {
                                    ...
                                    o = ((e, t) => {
                                        const o = IO(e).toOptional(),
                                            n = IO(t).toOptional();
                                        return Se(o, n, (e, t) =>
                                            RO(e, t.unit)
                                                .map((e) => t.value / e)
                                                .map((e) => {
                                                    return (o = e), (n = t.unit), (e) => RO(e, n).map((e) => ({ value: e * o, unit: n }));
                                                    var o, n;
                                                })
                                                .getOr(NO)
                                        ).getOr(NO);
            ...
            slider: G_((e, t, o) =>
                ((e, t, o) => {
                    const n = fC.parts.label({ dom: { tag: 'label', classes: ['tox-label'] }, components: [ti(t.translate(e.label))] }),
                        s = fC.parts.spectrum({ dom: { tag: 'div', classes: ['tox-slider__rail'], attributes: { role: 'presentation' } } }),
                        r = fC.parts.thumb({ dom: { tag: 'div', classes: ['tox-slider__handle'], attributes: { role: 'presentation' } } });
                    return fC.sketch({
                ...
                ((e, t, o, n) => {
                    const s = t.shared.providers,
                        ...
                        a = {
                            ...
                            fetch: (n) => {
                                const s = ((e, t, o) => {
                                        var n, s;
                                        const r = pu.getValue(t),
                                            a =
                                                null !==
                                                    (s = null === (n = null == r ? void 0 : r.meta) || void 0 === n ? void 0 : n.text) &&
                                                void 0 !== s
                                                    ? s
                                                    : r.value;
                                        return o.getLinkInformation().fold(
                                            () => [],
                                            (t) => {
                                                const n = P_(a, ((e) => H(e, (e) => R_(e, e)))(o.getHistory(e)));
                                                return 'file' === e
                                                    ? ((s = [n, P_(a, V_(t)), P_(a, q([H_(t), z_(t), L_(t)]))]),
                                                      j(
                                                          s,
                                                          (e, t) => (0 === e.length || 0 === t.length ? e.concat(t) : e.concat(F_, t)),
                                                          []
                                                      ))
                                                    : n;
                                                var s;
                                    ...
                                    r = CO(s, pb.BUBBLE_TO_SANDBOX, t, { isHorizontalMenu: !1, search: A.none() });
                                return bw(r);
                            },
                            ...
                            typeaheadBehaviours: kl([
                                ...o
                                                ...
                                                validate: (o) => {
                                                    ...
                                                    return O_((o) => {
                                                        t({ type: e.filetype, url: n.value }, (e) => {
                                                            if ('invalid' === e.status) {
                                                                const t = sn.error(e.message);
                                                                o(t);
                                                            } else {
                                                                const t = sn.value(e.message);
                                                                o(t);
                                                            }
                                                        });
                                                    });
                                    ...
                                    .toArray(),
                                Rm.config({ disabled: () => !e.enabled || s.isDisabled() }),
                                cS.config({}),
                                Jp('urlinput-events', [
                                    Ur(Zs(), (t) => {
                                        const o = $a(t.element),
                                            n = o.trim();
                                        n !== o && qa(t.element, n), 'file' === e.filetype && Ir(t, hS, { name: e.name });
                                    }),
                                    Ur(Qs(), (t) => {
                                        Ir(t, hS, { name: e.name }), r(t);
                                    }),
                                    Ur(cr(), (t) => {
                                        Ir(t, hS, { name: e.name }), r(t);
                                    })
                            ...
                            eventOrder: { [Zs()]: ['streaming', 'urlinput-events', 'invalidating'] },
                            model: { getDisplayText: (e) => e.value, selectsOver: !1, populateFromBrowse: !1 },
                            markers: { openClass: 'tox-textfield--popup-open' },
                            lazySink: t.shared.getSink,
                            parts: { menu: Bb(0, 0, 'normal') },
                            onExecute: (e, t, o) => {
                                Ir(t, yS, {});
                            },
                            onItemExecute: (t, o, n, s) => {
                                r(t), Ir(t, hS, { name: e.name });
                            }
                        },
                        i = aS.parts.field({ ...a, factory: k_ }),
                        l = e.label.map((e) => pS(e, s)),
                        c = jh(
                            ((e, t, o = e, n = e) =>
                                ef(
                                    o,
                        ...
                        d = jh({ dom: { tag: 'div', classes: ['tox-control-wrap__status-icon-wrap'] }, components: [c.asSpec()] }),
                        u = o.getUrlPicker(e.filetype),
                        m = la('browser.url.event'),
                        g = jh({
                            dom: { tag: 'div', classes: ['tox-control-wrap'] },
                            components: [i, d.asSpec()],
                            behaviours: kl([Rm.config({ disabled: () => !e.enabled || s.isDisabled() })])
                        }),
                        p = jh(
                            M_(
                                {
                    ...
                    return aS.sketch({
                        ...
                        fieldBehaviours: kl([
                            ...
                            Jp('url-input-events', [
                                Ur(m, (t) => {
                                    wm.getCurrent(t).each((o) => {
                                        const n = pu.getValue(o),
                                            s = { fieldname: e.name, ...n };
                                        u.each((n) => {
                                            n(s).get((n) => {
                                                pu.setValue(o, n), Ir(t, hS, { name: e.name });
                                            });
                                        });
                                    });
                                })
            ...
            customeditor: G_((e) => {
                ...
                return {
                    ...
                    behaviours: kl([
                        Jp('custom-editor-events', [
                            Kr((s) => {
                                o.getOpt(s).each((o) => {
                                    (((e) => ve(e, 'init'))(e)
                                        ? e.init(o.element.dom)
                                        : HC.load(e.scriptId, e.scriptUrl).then((t) => t(o.element.dom, e.settings))
                                    ).then((e) => {
                                        n.on((t) => {
                                            e.setValue(t);
                                        }),
                            ...
                            RC(
                                ...
                                (e, t) => {
                                    ...
                                    n.getOpt(e).each((o) => {
                                        const n = o.element;
                                        var s;
                                        t.url !== Ot(n, 'src') && (kt(n, 'src', t.url), Pa(e.element, 'tox-imagepreview__loaded')),
                                            a(),
                                            ((s = n),
                                            new Promise((e, t) => {
                                                const o = () => {
                                                ...
                                                e.getSystem().isConnected() &&
                                                    (La(e.element, 'tox-imagepreview__loaded'),
                    ...
                    return {
                        ...
                        components: [
                            ((s = e.header),
                            {
                                dom: { tag: 'thead' },
                                components: [
                                    { dom: { tag: 'tr' }, components: H(s, (e) => ({ dom: { tag: 'th', innerHtml: t.translate(e) } })) }
                                ]
                            }),
                            ((n = e.cells),
                            { dom: { tag: 'tbody' }, components: H(n, (e) => ({ dom: { tag: 'tr' }, components: H(e, o) })) })
                        ],
                ...
                ((e, t) => {
                    const o = e.onLeafAction.getOr(b),
                        ...
                        l = (n, s) =>
                            e.items.map((e) =>
                                'leaf' === e.type
                                    ? r_({ leaf: e, selectedId: n, onLeafAction: o, visible: !0, treeId: i, backstage: t })
                                    : d_({
                                          directory: e,
                                          selectedId: n,
                                          onLeafAction: o,
            ...
            panel: G_((e, t) =>
                ((e, t) => ({ dom: { tag: 'div', classes: e.classes }, components: H(e.items, t.shared.interpreter) }))(e, t)
            )
        },
        q_ = { field: (e, t) => t, record: x([]) },
        X_ = (e, t, o, n) => {
            const s = fn(n, { shared: { interpreter: (t) => Y_(e, t, o, s) } });
            return Y_(e, t, o, s);
        },
        Y_ = (e, t, o, n) =>
            be($_, t.type).fold(
        ...
        K_ = (e, t, o) => Y_(q_, e, t, o),
        J_ = 'layout-inset',
        Z_ = (e) => e.x,
        Q_ = (e, t) => e.x + e.width / 2 - t.width / 2,
        eT = (e, t) => e.x + e.width - t.width,
        tT = (e) => e.y,
        oT = (e, t) => e.y + e.height - t.height,
        nT = (e, t) => e.y + e.height / 2 - t.height / 2,
        sT = (e, t, o) => zi(eT(e, t), oT(e, t), o.insetSouthwest(), Wi(), 'southwest', Ki(e, { right: 0, bottom: 3 }), J_),
        rT = (e, t, o) => zi(Z_(e), oT(e, t), o.insetSoutheast(), Ui(), 'southeast', Ki(e, { left: 1, bottom: 3 }), J_),
        aT = (e, t, o) => zi(eT(e, t), tT(e), o.insetNorthwest(), Pi(), 'northwest', Ki(e, { right: 0, top: 2 }), J_),
        iT = (e, t, o) => zi(Z_(e), tT(e), o.insetNortheast(), Li(), 'northeast', Ki(e, { left: 1, top: 2 }), J_),
        lT = (e, t, o) => zi(Q_(e, t), tT(e), o.insetNorth(), ji(), 'north', Ki(e, { top: 2 }), J_),
        cT = (e, t, o) => zi(Q_(e, t), oT(e, t), o.insetSouth(), Gi(), 'south', Ki(e, { bottom: 3 }), J_),
        dT = (e, t, o) => zi(eT(e, t), nT(e, t), o.insetEast(), qi(), 'east', Ki(e, { right: 0 }), J_),
        uT = (e, t, o) => zi(Z_(e), nT(e, t), o.insetWest(), $i(), 'west', Ki(e, { left: 1 }), J_),
        mT = (e) => {
            switch (e) {
                case 'north':
                    return lT;
        ...
        gT = (e, t, o, n, s) => Xl(n).map(mT).getOr(lT)(e, t, o, n, s),
        pT = (e) => {
            switch (e) {
                case 'north':
                    return cT;
        ...
        hT = (e, t, o, n, s) => Xl(n).map(pT).getOr(lT)(e, t, o, n, s),
        fT = { valignCentre: [], alignCentre: [], alignLeft: [], alignRight: [], right: [], left: [], bottom: [], top: [] },
        bT = (e, t, o) => {
            const n = { maxHeightFunction: cc() };
            return () =>
                o()
                    ? {
                          type: 'node',
                    ...
                    : {
                          ...
                          hotspot: t(),
                          bubble: gc(-12, 12, fT),
                          layouts: { onRtl: () => [sl, rl, cl], onLtr: () => [rl, sl, cl] },
                          overrides: n
                      };
        },
        vT = (e, t, o, n) => {
            const s = { maxHeightFunction: cc() };
            return () =>
                n()
                    ? {
                          type: 'node',
        ...
        yT = (e, t, o) => () =>
            o()
                ? { type: 'node', root: ft(ht(e())), node: A.from(e()), layouts: { onRtl: () => [lT], onLtr: () => [lT] } }
                : { type: 'hotspot', hotspot: t(), layouts: { onRtl: () => [cl], onLtr: () => [cl] } },
        xT = (e, t) => () => ({
            type: 'selection',
            root: t(),
            getSelection: () => {
                ...
                if (o.length > 1) {
                    const e = o[0],
                        t = o[o.length - 1],
                        n = { firstCell: Ve(e), lastCell: Ve(t) };
                    return A.some(n);
                }
                return A.some(Lc.range(Ve(t.startContainer), t.startOffset, Ve(t.endContainer), t.endOffset));
            }
        }),
        wT = (e) => (t) => ({ type: 'node', root: e(), node: t }),
        ST = (e, t, o, n) => {
            const s = sb(e),
                r = () => Ve(e.getBody()),
                a = () => Ve(e.getContentAreaContainer()),
                i = () => s || !n();
            return {
        ...
        BT = (e) =>
            yf(e)
                ...
                .getOr(MT),
        FT = (e, t, o) => ({ ...e, type: 'formatter', isSelected: t(e.format), getStylePreview: o(e.format) }),
        IT = (e, t, o, n) => {
            const s = (t) =>
                H(t, (t) =>
                    ET(t)
                        ...
                        ? { ...t, type: 'separator' }
                        : ((t) => {
                              const s = r(t.name) ? t.name : la(t.title),
                                  a = `custom-${s}`,
        ...
        VT = NT('true'),
        zT = NT('false'),
        HT = (e, t, o, n, s) => ({ type: e, title: t, url: o, level: n, attach: s }),
        LT = (e) => e.innerText || e.textContent,
        PT = (e) => ((e) => e && 'A' === e.nodeName && void 0 !== (e.id || e.name))(e) && WT(e),
        UT = (e) => e && /^(H[1-6])$/.test(e.nodeName),
        WT = (e) =>
            ((e) => {
                let t = e;
                for (; (t = t.parentNode); ) {
                    const e = t.contentEditable;
                    if (e && 'inherit' !== e) return VT(t);
                }
                return !1;
            })(e) && !zT(e),
        jT = (e) => UT(e) && WT(e),
        GT = (e) => {
            ...
            return HT(
                'header',
                null !== (t = LT(e)) && void 0 !== t ? t : '',
                '#' + o,
                ((e) => (UT(e) ? parseInt(e.nodeName.substr(1), 10) : 0))(e),
                () => {
                    e.id = o;
                }
            );
        ...
        qT = (e) => RT(e.title).length > 0,
        XT = (e) => {
            const t = ((e) => {
                const t = H(Xc(Ve(e), 'h1,h2,h3,h4,h5,h6,a:not([href])'), (e) => e.dom);
                return t;
            })(e);
            return U(((e) => H(U(e, jT), GT))(t).concat(((e) => H(U(e, PT), $T))(t)), qT);
        },
        YT = 'tinymce-url-history',
        KT = (e) => r(e) && /^https?/.test(e),
        JT = (e) =>
            a(e) &&
            he(e, (e) => {
        ...
        tE = (e) => !!e,
        oE = (e) => ce(LC.makeMap(e, /[, ]/), tE),
        nE = (e) => A.from(Ff(e)),
        sE = (e) => A.from(e).filter(r).getOrUndefined(),
        rE = (e) => ({
            getHistory: QT,
            addToHistory: eE,
            getLinkInformation: () =>
                ((e) => (Vf(e) ? A.some({ targets: XT(e.getBody()), anchorTop: sE(zf(e)), anchorBottom: sE(Hf(e)) }) : A.none()))(e),
            getValidationHandler: () => ((e) => A.from(If(e)))(e),
            getUrlPicker: (t) =>
                ((e, t) =>
                    ((e, t) => {
                        const o = ((e) => {
                            const t = A.from(Nf(e)).filter(tE).map(oE);
                            return nE(e).fold(T, (e) => t.fold(E, (e) => ae(e).length > 0 && e));
                        })(e);
        ...
        cE = ju({ name: 'items', overrides: () => ({ behaviours: kl([Kp.config({})]) }) }),
        dE = x([cE]),
        uE = bm({
            name: x('CustomList')(),
            configFields: lE(),
            partFields: dE(),
            factory: (e, t, o, n) => {
                const s = e.shell ? { behaviours: [Kp.config({})], components: [] } : { behaviours: [], components: t };
                return {
                    uid: e.uid,
                    dom: e.dom,
                    ...
                    apis: {
                        setItems: (t, o) => {
                            var n;
                            ((n = t), e.shell ? A.some(n) : om(n, e, 'items')).fold(
                                () => {
                                    throw (
                                        (console.error(
                                ...
                                (n) => {
                                    const s = Kp.contents(n),
                                        r = o.length,
                                        a = r - s.length,
                                        i = a > 0 ? V(a, () => e.makeItem()) : [],
                                        l = s.slice(r);
                                    L(l, (e) => Kp.remove(n, e)), L(i, (e) => Kp.append(n, e));
                                    const c = Kp.contents(n);
                                    L(c, (n, s) => {
        ...
        gE = x([ju({ name: 'groups', overrides: () => ({ behaviours: kl([Kp.config({})]) }) })]),
        pE = bm({
            name: 'Toolbar',
            configFields: mE(),
            partFields: gE(),
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    apis: {
                        setGroups: (t, o) => {
                            var n;
                            ((n = t), e.shell ? A.some(n) : om(n, e, 'groups')).fold(
                                () => {
                                    throw (
                                        (console.error(
        ...
        bE = x([]);
    var vE,
        yE = Object.freeze({ __proto__: null, setup: hE, isDocked: fE, getBehaviours: bE });
    const xE = (e) =>
            (xe(Nt(e, 'position'), 'fixed') ? A.none() : at(e)).orThunk(() => {
                const t = Re('span');
                return st(e).bind((e) => {
                    zo(e, t);
                    const o = at(t);
        ...
        CE = (e, t) => e.y >= t.y,
        OE = (e, t) => e.bottom <= t.bottom,
        _E = (e, t, o) => ({ location: 'top', leftX: t, topY: o.bounds.y - e.y }),
        TE = (e, t, o) => ({ location: 'bottom', leftX: t, bottomY: e.bottom - o.bounds.bottom }),
        ...
        AE = (e, t, o) =>
            o.getInitialPos().map((o) => {
                ...
                return { box: Ko(n.left, n.top, Jt(e), Wt(e)), location: o.location };
            }),
        ME = (e, t, o, n, s) => {
            const r = ((e, t) => {
            ...
            n.setInitialPos({ style: Vt(e), position: It(e, 'position') || 'static', bounds: a, location: s.location });
        },
        DE = (e, t, o) =>
        ...
        BE = (e) => {
            switch (e.location) {
                case 'top':
                    return A.some({ morph: 'fixed', positionCss: Vl('fixed', A.some(e.leftX), A.some(e.topY), A.none(), A.none()) });
                case 'bottom':
                    return A.some({ morph: 'fixed', positionCss: Vl('fixed', A.some(e.leftX), A.none(), A.none(), A.some(e.bottomY)) });
                default:
                    return A.none();
            }
        },
                ...
                ? ((e, t, o) =>
                      ((e, t, o) =>
                          AE(e, t, o)
                              ...
                              .bind(({ box: t }) => DE(e, t, o)))(e, t, o).orThunk(() =>
                          t.optScrollEnv
                              .bind((n) => AE(e, t, o))
        ...
        NE = (e, t, o, n, s = !1) => {
            t.contextual.each((t) => {
                t.lazyContext(e).each((r) => {
                    ...
                    a !== o.isVisible() &&
                        (o.setVisible(a), s && !a ? (Wa(e.element, [t.fadeOutClass]), t.onHide(e)) : (a ? SE : kE)(e, t));
                });
            });
        },
        VE = (e, t, o, n, s) => {
        ...
        HE = (e, t, o) => {
            o.isDocked() &&
                ((e, t, o) => {
                    ...
                    ((e, t, o) => {
                        const n = e.element;
                        return AE(n, t, o).bind(({ box: e }) => DE(n, e, o));
                    })(e, s, o).each((n) => {
                        switch (n.morph) {
                            case 'static':
                                IE(e, t, o);
    ...
    var WE = Object.freeze({
        ...
        jE = Object.freeze({
            ...
            events: (e, t) =>
                Hr([
                    Yr(or(), (o, n) => {
                        e.contextual.each((e) => {
                            Ua(o.element, e.transitionClass) &&
                                (ja(o.element, [e.transitionClass, e.fadeInClass]), (t.isVisible() ? e.onShown : e.onHidden)(o)),
                                n.stop();
                        });
                    }),
                    Ur(xr(), (o, n) => {
        ...
        GE = [
            ...
            Os('lazyViewport', () => ({ bounds: en(), optScrollEnv: A.none() })),
            _s('modes', ['top', 'bottom'], Hn),
            Di('onDocked'),
            Di('onUndocked')
        ];
    const $E = Ol({
        ...
        JE = (e, t) => R($E.getModes(e), t),
        ZE = (e) => {
            const t = e.element;
            rt(t).each((o) => {
                const n = 'padding-' + $E.getModes(e)[0];
                if ($E.isDocked(e)) {
                    const e = Jt(o);
                    Dt(t, 'width', e + 'px'),
                        Dt(
                            o,
                            n,
                            ((e) => jt(e) + (parseInt(It(e, 'margin-top'), 10) || 0) + (parseInt(It(e, 'margin-bottom'), 10) || 0))(t) +
                                'px'
                        );
        ...
        QE = (e, t) => {
            t
                ? (Pa(e, XE.fadeOutClass), Wa(e, [XE.transitionClass, XE.fadeInClass]))
                : (Pa(e, XE.fadeInClass), Wa(e, [XE.fadeOutClass, XE.transitionClass]));
        },
        eA = (e, t) => {
        ...
        tA = (e, t) => {
            const o = Ql(),
                ...
                r = (t) => {
                    e.inline || ZE(t),
                        eA(e, $E.isDocked(t)),
                        t.getSystem().broadcastOn([Kd()], {}),
                        n().each((e) => e.getSystem().broadcastOn([Kd()], {}));
                },
                a = e.inline ? [] : [Al.config({ channels: { [qE()]: { onReceive: ZE } } })];
            return [
                oh.config({}),
                $E.config({
                    contextual: {
                        ...
                        onShown: (e) => {
                            s((e) => ja(e, [XE.transitionClass, XE.fadeInClass])),
                                o.get().each((t) => {
                                    ((e, t) => {
                                        const o = et(t);
                                        Il(o)
                                            .filter((e) => !Ze(t, e))
                                            .filter((t) => Ze(t, Ve(o.dom.body)) || Qe(e, t))
                                            .each(() => Dl(t));
                                    })(e.element, t),
                                        o.clear();
                                });
                    ...
                    lazyViewport: (t) =>
                        jw(e, t.element).fold(
                            () => {
                                ...
                                return { bounds: Ko(o.x, s, o.width, r), optScrollEnv: A.none() };
                            },
                            (e) => ({
                                bounds: Gw(e),
                                optScrollEnv: A.some({ currentScrollTop: e.element.dom.scrollTop, scrollElmTop: Xt(e.element).top })
                            })
                        ),
    ...
    var oA = Object.freeze({
        ...
        isDocked: (e) => e().map($E.isDocked).getOr(!1),
        getBehaviours: tA
    });
    const nA = Dn([tv, ns('items', Fn([Rn([ov, ds('items', Hn)]), Hn]))].concat(Dv)),
        sA = [
            ps('text'),
            ps('tooltip'),
            ps('icon'),
            xs(
                'search',
                !1,
                Fn([Ln, Dn([ps('placeholder')])], (e) => (d(e) ? (e ? A.some({ placeholder: A.none() }) : A.none()) : A.some(e)))
            ),
            is('fetch'),
            Os('onSetup', () => b)
        ],
        rA = Dn([tv, ...sA]),
        aA = (e) => qn('menubutton', rA, e),
        ...
        factory: (e, t) => {
            ...
            return {
                ...
                behaviours: kl([
                    ...
                    Pp.config({ mode: 'flow', selector: '.tox-mbtn', onEscape: (t) => (e.onEscape(t), A.some(!0)) }),
                    cS.config({})
                ]),
                apis: o,
    ...
    const cA = 'container',
            ...
            const o = (t) => am(e),
                n = (t, o) => (n, s) =>
                    om(n, e, s)
                        .map((e) => t(e, s))
                        .getOr(o),
                s = (e, t) => 'true' !== Ot(e.element, 'aria-hidden'),
                r = n(s, !1),
                a = n((e, t) => {
                    if (s(e)) {
                        const o = e.element;
                        Dt(o, 'display', 'none'), kt(o, 'aria-hidden', 'true'), Ir(e, Tr(), { name: t, visible: !1 });
                    }
                }),
                i = ((e) => (t, o) => {
                    L(o, (o) => e(t, o));
                ...
                l = n((e, t) => {
                    if (!s(e)) {
                        const o = e.element;
                        Ht(o, 'display'), Et(o, 'aria-hidden'), Ir(e, Tr(), { name: t, visible: !0 });
                    }
                }),
                c = {
                    getSlotNames: o,
                    getSlot: (t, o) => om(t, e, o),
                    isShowing: r,
                    hideSlot: a,
                    hideAllSlots: (e) => i(e, o()),
                    showSlot: l
                };
            return { uid: e.uid, dom: e.dom, components: t, behaviours: fu(e.slotBehaviours), apis: c };
        },
        gA = ce(
            {
        ...
        pA = {
            ...
            sketch: (e) => {
                const t = (() => {
                        const e = [];
                        return { slot: (t, o) => (e.push(t), Ju(cA, uA(t), o)), record: x(e) };
                    })(),
                    o = e(t),
                    n = t.record(),
                    s = H(n, (e) => Uu({ name: e, pname: uA(e) }));
                return mm(cA, dA, s, mA, o);
            }
        },
        hA = Dn([hv, fv, Os('onShow', b), Os('onHide', b), mv]),
        fA = (e) => ({ element: () => e.element.dom }),
        bA = (e, t) => {
            const o = H(ae(t), (e) => {
                const o = t[e],
                    n = Xn(((e) => qn('sidebar', hA, e))(o));
                return { name: e, getApi: fA, onSetup: n.onSetup, onShow: n.onShow, onHide: n.onHide };
            });
            return H(o, (t) => {
                const n = Es(b);
        ...
        vA = (e) =>
            pA.sketch((t) => ({
                ...
                components: bA(t, e),
                slotBehaviours: ly([Kr((e) => pA.hideAllSlots(e))])
            })),
        yA = (e, t) => {
            kt(e, 'role', t);
        },
        xA = (e) =>
            wm
                .getCurrent(e)
                .bind((e) =>
                    QO.isGrowing(e) || QO.hasGrown(e)
                        ? wm.getCurrent(e).bind((e) => G(pA.getSlotNames(e), (t) => pA.isShowing(e, t)))
                        : A.none()
                ),
        wA = la('FixSizeEvent'),
        SA = la('AutoSizeEvent');
    var kA = Object.freeze({
            ...
            block: (e, t, o, n) => {
                ...
                const s = t.getRoot(e).getOr(e),
                    r = kl([Pp.config({ mode: 'special', onTab: () => A.some(!0), onShiftTab: () => A.some(!0) }), oh.config({})]),
                    a = n(s, r),
                    i = s.getSystem().build(a);
                Kp.append(s, ai(i)),
                    i.hasConfigured(Pp) && t.focus && Pp.focusIn(i),
                    o.isBlocked() || t.onBlock(e),
                    o.blockWith(() => Kp.remove(s, i));
            },
            unblock: (e, t, o) => {
    ...
    const OA = Ol({
        ...
        _A = (e) => {
            const t = Ie(e),
                ...
                r = 0 === o.length ? {} : { innerHtml: ea(t) };
            return { tag: Ue(t), classes: s, attributes: n, ...r };
        },
        TA = (e) => wm.getCurrent(e).each((e) => Dl(e.element)),
        EA = (e, t, o) => {
            const n = Es(!1),
                s = Ql(),
                r = (o) => {
                        ...
                        if (
                            (((e, t) => {
                                ...
                                A.from(e.iframeElement)
                                    ...
                                    .each((e) => {
                                        t
                                            ? (_t(e, o).each((t) => kt(e, n, t)), kt(e, o, -1))
                                            : (Et(e, o),
                                              _t(e, n).each((t) => {
                                                  kt(e, o, t), Et(e, n);
                                              }));
                            ...
                            OA.block(
                                ...
                                ((e) => (t, o) => ({
                                    ...
                                    components: [{ dom: _A('<div class="tox-spinner"><div></div><div></div><div></div></div>') }]
                                }))(n)
                            ),
                                Ht(s, 'display'),
                                Et(s, 'aria-hidden'),
                            ...
                            const o = wm.getCurrent(t).exists((e) => Fl(e.element));
                            OA.unblock(t), Dt(s, 'display', 'none'), kt(s, 'aria-hidden', 'true'), o && e.focus();
                        }
                    })(e, t(), s, o.providers),
                    ((e, t) => {
            ...
            e.on('ProgressState', (t) => {
                if ((s.on(clearTimeout), h(t.time))) {
                    const o = Uh.setEditorTimeout(e, () => a(t.state), t.time);
                    s.set(o);
                } else a(t.state), s.clear();
            });
        },
        AA = (e, t, o) => ({ within: e, extra: t, withinWidth: o }),
        MA = (e, t, o) => {
            const n = j(
                    e,
                    (e, t) =>
        ...
        FA = (e, t, o) => {
            ...
            const a = n.concat([r]),
                i = re(a, (e) => Rl(e.element).bind((t) => e.getSystem().getByDom(t).toOptional()));
            o([]), BA(s, a);
            const l = ((e, t, o, n) => {
                const s = ((e, t, o) => {
                        const n = MA(t, e, o);
                        return 0 === n.extra.length ? A.some(n) : A.none();
                    })(e, t, o).getOrThunk(() => MA(t, e - o(n), o)),
                    r = s.within,
                    a = s.extra,
                    i = s.withinWidth;
                return 1 === a.length && a[0].width <= o(n)
                    ? ((e, t, o) => {
                          const n = DA(e.concat(t));
                          return AA(n, [], o);
                      })(r, a, i)
                    : a.length >= 1
                    ? ((e, t, o, n) => {
                          const s = DA(e).concat([o]);
                          return AA(s, DA(t), n);
                      })(r, a, n, i)
                    : ((e, t, o) => AA(DA(e), [], o))(r, 0, i);
            })(Jt(s.element), t.builtGroups.get(), (e) => Jt(e.element), r);
            0 === l.extra.length ? (Kp.remove(s, r), o([])) : (BA(s, l.within), o(l.extra)),
                Ht(s.element, 'visibility'),
                Lt(s.element),
                i.each(oh.focus);
        },
        IA = x([hu('splitToolbarBehaviours', [uw]), es('builtGroups', () => Es([]))]),
        RA = x(
            [
                Ai(['overflowToggledClass']),
                fs('getOverflowBounds'),
                os('lazySink'),
                es('overflowGroups', () => Es([])),
                Di('onOpened'),
                Di('onClosed')
            ].concat(IA())
        ),
        NA = x([
            Uu({ factory: pE, schema: mE(), name: 'primary' }),
            Wu({ schema: mE(), name: 'overflow' }),
        ...
        HA = x([
            ...
            Wu({
                ...
                name: 'toolbar',
                overrides: (e) => ({
                    toolbarBehaviours: kl([Pp.config({ mode: 'cyclic', onEscape: (t) => (om(t, e, 'button').each(oh.focus), A.none()) })])
                })
            })
        ]),
        LA = Ql(),
        PA = (e, t) => {
            const o = uw.getCoupled(e, 'toolbarSandbox');
            Xd.isOpen(o) ? Xd.close(o) : Xd.open(o, t.toolbar());
        },
        UA = (e, t, o, n) => {
            const s = o.getBounds.map((e) => e()),
                r = o.lazySink(e).getOrDie();
            Sd.positionWithinBounds(
                r,
                t,
                { anchor: { type: 'hotspot', hotspot: e, layouts: n, overrides: { maxWidthFunction: VA() } } },
                s
            );
        },
        WA = (e, t, o, n, s) => {
        ...
        jA = bm({
            ...
            factory: (e, t, o, n) => ({
                ...Wh.sketch({
                    ...
                    buttonBehaviours: yu({ dump: n.button().buttonBehaviours }, [
                        uw.config({
                            others: {
                                toolbarSandbox: (t) =>
                                    ((e, t, o) => {
                                        ...
                                        return {
                                            ...
                                            behaviours: kl([
                                                Pp.config({ mode: 'special', onEscape: (e) => (Xd.close(e), A.some(!0)) }),
                                                Xd.config({
                                                    onOpen: (s, r) => {
                                                        const a = LA.get().getOr(!1);
                                                        o.fetch().get((s) => {
                                                ...
                                                Al.config({
                                                    channels: {
                                                        ...
                                                        ...tu({
                                                            doReposition: () => {
                                                                Xd.getState(uw.getCoupled(e, 'toolbarSandbox')).each((n) => {
                                                                    UA(e, n, o, t.layouts);
                                                                });
                                                            }
                                                        })
                ...
                apis: {
                    setGroups: (t, n) => {
                        Xd.getState(uw.getCoupled(t, 'toolbarSandbox')).each((s) => {
                            WA(t, s, e, o.layouts, n);
                        });
                    },
                    reposition: (t) => {
                        Xd.getState(uw.getCoupled(t, 'toolbarSandbox')).each((n) => {
                            UA(t, n, e, o.layouts);
                        });
                    },
                    toggle: (e) => {
                    ...
                    getToolbar: (e) => Xd.getState(uw.getCoupled(e, 'toolbarSandbox')),
                    isOpen: (e) => Xd.isOpen(uw.getCoupled(e, 'toolbarSandbox'))
                }
            }),
            configFields: zA(),
            partFields: HA(),
        ...
        qA = bm({
            ...
            factory: (e, t, o, n) => ({
                ...
                dom: e.dom,
                components: t,
                behaviours: bu(e.tgroupBehaviours, [Pp.config({ mode: 'flow', selector: e.markers.itemSelector })]),
            ...
            factory: (e, t, o, n) => {
                const s = jh(
                    jA.sketch({
                        ...
                        layouts: { onLtr: () => [rl, sl], onRtl: () => [sl, rl], onBottomLtr: () => [il, al], onBottomRtl: () => [al, il] },
                ...
                return {
                    ...
                    dom: e.dom,
                    components: t,
                    behaviours: bu(e.splitToolbarBehaviours, [
                        uw.config({ others: { overflowGroup: () => qA.sketch({ ...n['overflow-group'](), items: [s.asSpec()] }) } })
                    ]),
                    apis: {
                        setGroups: (t, o) => {
                        ...
                        isOpen: (e) => s.getOpt(e).map(jA.isOpen).getOr(!1),
                        reposition: (e) => {
                            s.getOpt(e).each((e) => {
                                jA.reposition(e);
                            });
                        },
                        getOverflow: (e) => s.getOpt(e).bind(jA.getToolbar)
                    },
                    domModification: { attributes: { role: 'group' } }
                };
            },
        ...
        JA = x(
            [
                Ai(['closedClass', 'openClass', 'shrinkingClass', 'growingClass', 'overflowToggledClass']),
                Di('onOpened'),
                Di('onClosed')
            ].concat(IA())
        ),
            ...
            Uu({
                ...
                overrides: (e) => ({
                    toolbarBehaviours: kl([
                        ...
                        Pp.config({ mode: 'acyclic', onEscape: (t) => (om(t, e, 'overflow-button').each(oh.focus), A.some(!0)) })
                    ])
                })
            }),
            Wu({
                ...
                overrides: (e) => ({
                    buttonBehaviours: kl([
                        dh.config({ toggleClass: e.markers.overflowToggledClass, aria: { mode: 'pressed' }, toggleOnExecute: !1 })
                    ])
                })
            }),
            Wu({ name: 'overflow-group' })
        ...
        QA = (e, t) => {
            om(e, t, 'overflow-button')
                .bind(() => om(e, t, 'overflow'))
                .each((o) => {
                    eM(e, t), QO.toggleGrow(o);
                });
        },
        eM = (e, t) => {
            om(e, t, 'overflow').each((o) => {
                FA(e, t, (e) => {
                    const t = H(e, (e) => ai(e));
                    pE.setGroups(o, t);
                }),
                    om(e, t, 'overflow-button').each((e) => {
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    apis: {
                        ...
                        refresh: (t) => eM(t, e),
                        toggle: (t) => QA(t, e),
                        isOpen: (t) => ((e, t) => om(e, t, 'overflow').map(QO.hasGrown).getOr(!1))(t, e)
                    },
                    domModification: { attributes: { role: 'group' } }
                };
            },
        ...
        sM = (e, t) => {
            const o = Kr((t) => {
                const o = H(e.initGroups, nM);
                pE.setGroups(t, o);
            });
            return kl([
                Oy(e.providers.isDisabled),
                Sy(),
                Pp.config({ mode: t, onEscape: e.onEscape, selector: '.tox-toolbar__group' }),
                Jp('toolbar-events', [o])
            ]);
        },
        rM = (e) => {
            ...
            return {
                ...
                parts: {
                    'overflow-group': oM({ title: A.none(), items: [] }),
                    'overflow-button': T_(
                        {
                            name: 'more',
        ...
        aM = (e) => {
            const t = rM(e),
                o = KA.parts.primary({ dom: { tag: 'div', classes: ['tox-toolbar__primary'] } });
            return KA.sketch({
                ...t,
                lazySink: e.getSink,
                getOverflowBounds: () => {
        ...
        iM = (e) => {
            const t = tM.parts.primary({ dom: { tag: 'div', classes: ['tox-toolbar__primary'] } }),
                o = tM.parts.overflow({ dom: { tag: 'div', classes: ['tox-toolbar__overflow'] } }),
                n = rM(e);
            return tM.sketch({
                ...n,
                components: [t, o],
                ...
                onOpened: (t) => {
                    t.getSystem().broadcastOn([qE()], { type: 'opened' }), e.onToggled(t, !0);
                },
                onClosed: (t) => {
                    t.getSystem().broadcastOn([qE()], { type: 'closed' }), e.onToggled(t, !1);
                }
            });
        },
        lM = (e) => {
            ...
            return pE.sketch({
                uid: e.uid,
                dom: { tag: 'div', classes: ['tox-toolbar'].concat(e.type === nf.scrolling ? ['tox-toolbar--scrolling'] : []) },
        ...
        dM = { button: [...cM, sv, as('type', ['button'])], togglebutton: [...cM, Cs('active', !1), as('type', ['togglebutton'])] },
        uM = [as('type', ['group']), _s('buttons', [], Jn('type', dM))],
        mM = Jn('type', { ...dM, group: uM }),
        gM = Dn([_s('buttons', [], mM), is('onShow'), is('onHide')]),
        pM = (e, t) =>
            ((e, t) => {
                var o, n;
                const s = 'togglebutton' === e.type,
                    r = e.icon.map((e) => fO(e, t.icons)).map(jh),
                    a = {
                        ...e,
                            ...
                            return s
                                ? e.onAction({
                                      ...
                                      setActive: (e) => {
                                          const t = o.element;
                                          e
                                              ? (La(t, 'tox-button--enabled'), kt(t, 'aria-pressed', !0))
                                              : (Pa(t, 'tox-button--enabled'), Et(t, 'aria-pressed'));
                                      },
        ...
        partFields: [
            ju({
                factory: {
                    sketch: (e) => {
                        let t = !1;
                        const o = H(e.buttons, (o) =>
                            'group' === o.type
                                ? ((t = !0),
                                  ((e, t) => ({
                                      dom: { tag: 'div', classes: ['tox-view__toolbar__group'] },
                                      components: H(e.buttons, (e) => pM(e, t))
                                  }))(o, e.providers))
                                : pM(o, e.providers)
                        );
                        return {
                            ...
                            dom: {
                                ...
                                classes: [
                                    ...
                                    ...(fM || bM ? ['tox-view--mobile', 'tox-view--scrolling'] : [])
                                ]
                            },
                            behaviours: kl([
                                oh.config({}),
                                Pp.config({ mode: 'flow', selector: 'button, .tox-button', focusInside: pg.OnEnterOrSpaceMode })
                            ]),
                            components: t
                                ? o
                                : [
                                      oS.sketch({ dom: { tag: 'div', classes: ['tox-view__header-start'] }, components: [] }),
                                      oS.sketch({ dom: { tag: 'div', classes: ['tox-view__header-end'] }, components: o })
                                  ]
                        };
                    }
                },
    ...
    const yM = (e, t, o) =>
            pe(t, (t, n) => {
                ...
                return e.slot(
                    ...
                    vM.sketch({
                        ...
                        viewConfig: s,
                        components: [
                            ...(s.buttons.length > 0 ? [vM.parts.header({ buttons: s.buttons, providers: o })] : []),
                            vM.parts.pane({})
                        ]
                    })
                );
        ...
        wM = (e) => G(pA.getSlotNames(e), (t) => pA.isShowing(e, t)),
        SM = (e, t, o) => {
            pA.getSlot(e, t).each((e) => {
                vM.getPane(e).each((t) => {
                    var n;
    ...
    var kM = fm({
        factory: (e, t) => {
            const o = {
                ...
                whichView: (e) => wm.getCurrent(e).bind(wM),
                toggleView: (e, t, o, n) =>
                    wm.getCurrent(e).exists((s) => {
                        const r = wM(s),
                            a = r.exists((e) => n === e),
                        ...
                        return (
                            i &&
                                ...
                                r.each((e) => ((e, t) => SM(e, t, vM.getOnHide))(s, e))),
                            i
                        );
                    })
            };
    ...
    const CM = iE.optional({ factory: lA, name: 'menubar', schema: [os('backstage')] }),
        OM = iE.optional({
            factory: {
                sketch: (e) =>
                    uE.sketch({
                        uid: e.uid,
                        dom: e.dom,
                        listBehaviours: kl([Pp.config({ mode: 'acyclic', selector: '.tox-toolbar' })]),
                        makeItem: () =>
                            lM({
                                type: e.type,
        ...
        _M = iE.optional({
            factory: {
                sketch: (e) => {
                    const t = ((e) => (e.type === nf.sliding ? iM : e.type === nf.floating ? aM : lM))(e);
                    return t({
                        type: e.type,
                        uid: e.uid,
                        onEscape: () => (e.onEscape(), A.some(!0)),
        ...
        TM = iE.optional({
            factory: {
                sketch: (e) => {
                    const t = e.editor,
                        o = e.sticky ? tA : bE;
                    return { uid: e.uid, dom: e.dom, components: e.components, behaviours: kl(o(t, e.sharedBackstage)) };
                }
            },
            name: 'header',
            schema: [os('dom')]
        ...
        AM = iE.optional({ name: 'socket', schema: [os('dom')] }),
        MM = iE.optional({
            factory: {
                sketch: (e) => ({
                    uid: e.uid,
                    ...
                    components: [
                        {
                            ...
                            behaviours: kl([
                                ...
                                QO.config({
                                    ...
                                    onStartGrow: (e) => {
                                        Ir(e, wA, { width: Nt(e.element, 'width').getOr('') });
                                    },
                                    onStartShrink: (e) => {
                                        Ir(e, wA, { width: Jt(e.element) + 'px' });
                                    }
                                }),
                                Kp.config({}),
                                wm.config({
        ...
        DM = iE.optional({
            factory: {
                sketch: (e) => ({
                    ...
                    behaviours: kl([Kp.config({}), OA.config({ focus: !1 }), wm.config({ find: (e) => oe(e.components()) })]),
                    components: []
                })
            },
            name: 'throbber',
        ...
        BM = iE.optional({ factory: kM, name: 'viewWrapper', schema: [os('backstage')] }),
        FM = iE.optional({
    ...
    var IM = bm({
        ...
        factory: (e, t, o) => {
            let n = !1;
            const s = {
                getSocket: (t) => aE.getPart(t, e, 'socket'),
                setSidebar: (t, o, n) => {
                    aE.getPart(t, e, 'sidebar').each((e) =>
                        ((e, t, o) => {
                            wm.getCurrent(e).each((n) => {
                                Kp.set(n, [vA(t)]);
                                const s = null == o ? void 0 : o.toLowerCase();
                                r(s) &&
                                    ve(t, s) &&
                                    wm.getCurrent(n).each((t) => {
                ...
                toggleSidebar: (t, o) => {
                    aE.getPart(t, e, 'sidebar').each((e) =>
                        ((e, t) => {
                            wm.getCurrent(e).each((o) => {
                                wm.getCurrent(o).each((n) => {
                                    QO.hasGrown(o)
                                        ? pA.isShowing(n, t)
                                            ? (QO.shrink(o), yA(e.element, 'presentation'))
                                            : (pA.hideAllSlots(n), pA.showSlot(n, t), yA(e.element, 'region'))
                                        : (pA.hideAllSlots(n), pA.showSlot(n, t), QO.grow(o), yA(e.element, 'region'));
                                });
                            });
                        })(e, o)
                    );
                },
                whichSidebar: (t) => aE.getPart(t, e, 'sidebar').bind(xA).getOrNull(),
                getHeader: (t) => aE.getPart(t, e, 'header'),
                getToolbar: (t) => aE.getPart(t, e, 'toolbar'),
                setToolbar: (t, o) => {
                    aE.getPart(t, e, 'toolbar').each((e) => {
                        const t = H(o, nM);
                        e.getApis().setGroups(e, t);
                    });
                },
                setToolbars: (t, o) => {
                    aE.getPart(t, e, 'multiple-toolbar').each((e) => {
                        const t = H(o, (e) => H(e, nM));
                        uE.setItems(e, t);
                    });
                },
                refreshToolbar: (t) => {
                    aE.getPart(t, e, 'toolbar').each((e) => e.getApis().refresh(e));
                },
                ...
                isToolbarDrawerToggled: (t) =>
                    aE
                        ...
                        .getOr(!1),
                getThrobber: (t) => aE.getPart(t, e, 'throbber'),
                focusToolbar: (t) => {
                    aE.getPart(t, e, 'toolbar')
                        .orThunk(() => aE.getPart(t, e, 'multiple-toolbar'))
                        .each((e) => {
                            Pp.focusIn(e);
                        });
                },
                setMenubar: (t, o) => {
                    aE.getPart(t, e, 'menubar').each((e) => {
                        lA.setMenus(e, o);
                    });
                },
                focusMenubar: (t) => {
                ...
                setViews: (t, o) => {
                    aE.getPart(t, e, 'viewWrapper').each((e) => {
                        kM.setViews(e, o);
                    });
                },
                toggleView: (t, o) =>
                    aE.getPart(t, e, 'viewWrapper').exists((e) =>
                        kM.toggleView(
                            e,
                            () => s.showMainView(t),
                            () => s.hideMainView(t),
                ...
                whichView: (t) => aE.getPart(t, e, 'viewWrapper').bind(kM.whichView).getOrNull(),
                hideMainView: (t) => {
                    (n = s.isToolbarDrawerToggled(t)),
                        n && s.toggleToolbarDrawer(t),
                        aE.getPart(t, e, 'editorContainer').each((e) => {
                            const t = e.element;
                            Dt(t, 'display', 'none'), kt(t, 'aria-hidden', 'true');
                        });
                },
            ...
            return { uid: e.uid, dom: e.dom, components: t, apis: s, behaviours: e.behaviours };
        },
    ...
    const RM = {
            ...
            const o = { ...RM, ...t.menus },
                ...
                s =
                    void 0 === t.menubar || !0 === t.menubar
                        ? NM('file edit view insert format tools table help')
                        : NM(!1 === t.menubar ? '' : t.menubar),
                a = U(s, (e) => {
                    const o = ve(RM, e);
                ...
                i = H(a, (n) => {
                    ...
                    })({ title: s.title, items: NM(s.items) }, t, e);
                });
        ...
        HM = (e, t, o) => (e.on('remove', () => o.unload(t)), o.load(t)),
        LM = (e, t) => HM(e, t + '/skin.min.css', e.ui.styleSheetLoader),
        PM = (e, t) => {
            var o;
            return (
                (o = Ve(e.getElement())), bt(o).isSome() ? HM(e, t + '/skin.shadowdom.min.css', rf.DOM.styleSheetLoader) : Promise.resolve()
            );
        },
        UM = (e, t) => {
            const o = Jf(t);
            return (
                ...
                !Yf(t) && r(o)
                    ? Promise.all([LM(t, o), PM(t, o)]).then(
                          zM(t),
                          (
                              (e, t) => () =>
                                  ((e, t) => {
        ...
        GM = (e, t, o) => {
            const n = (e, n, r, a) => {
                    ...
                    if ('separator' === e.type) return A.some({ type: 'separator', text: i });
                    if ('submenu' === e.type) {
            ...
            return {
                ...
                getFetch: (e, t) => (o, n) => {
                    const s = t(),
                        a = r(s);
                    n(CO(a, pb.CLOSE_ON_EXECUTE, e, { isHorizontalMenu: !1, search: A.none() }));
                }
            };
        },
        $M = (e, t, o) => {
            const n = o.dataset,
                s = 'basic' === n.type ? () => H(n.data, (e) => FT(e, o.isSelectedFor, o.getPreviewFor)) : n.getData;
            return { items: GM(0, t, o), getStyleItems: s };
        },
        qM = (e, t, o) => {
            const { items: n, getStyleItems: s } = $M(0, t, o),
                r = yx(e, 'NodeChange', (t) => {
    ...
    const YM = (e, t, o) => {
            const n =
                ((s = ((e, t) => (t === XM.SemiColon ? e.replace(/;$/, '').split(';') : e.split(' ')))(e.options.get(t), o)),
                H(s, (e) => {
                    let t = e,
                        o = e;
                    const n = e.split('=');
        ...
        JM = (e) => {
            ...
            return {
                ...
                onAction: (t) => () => G(KM, (e) => e.format === t.format).each((t) => e.execCommand(t.command)),
                updateText: (t) => {
                    const o = G(KM, (t) => e.formatter.match(t.format)).fold(x('left'), (e) => e.title.toLowerCase());
                    Ir(t, yO, { icon: `align-${o}` });
                },
                dataset: t,
                shouldHide: !1,
        ...
        ZM = (e, t) => {
            ...
            return A.from(e.formatter.closest(n))
                ...
                .orThunk(() => Ce(e.formatter.match('p'), { title: 'Paragraph', format: 'p' }));
        },
        QM = (e) => {
            const t = 'Paragraph',
            ...
            return {
                ...
                onAction: xx(e),
                updateText: (n) => {
                    const s = ZM(e, () => o.data).fold(x(t), (e) => e.title);
                    Ir(n, vO, { text: s });
                },
                dataset: o,
                shouldHide: !1,
                            ...
                            Ce(
                                ((e) =>
                                    ...
                                    (() => {
                                        ...
                                        return Y(eD, (e) => t.indexOf(e.toLowerCase()) > -1);
                                    })())(a),
                                { title: t, format: a }
                            )
                        );
        ...
        rD = (e, t) =>
            A.from(sD.exec(e)).bind((e) => {
                const o = Number(e[1]),
                    n = e[2];
                return ((e, t) => N(t, (t) => N(nD[t], (t) => e === t)))(n, t) ? A.some({ value: o, unit: n }) : A.none();
            }),
        aD = {
            tab: x(9),
            escape: x(27),
        ...
        iD = { '8pt': '1', '10pt': '2', '12pt': '3', '14pt': '4', '18pt': '5', '24pt': '6', '36pt': '7' },
        lD = { 'xx-small': '7pt', 'x-small': '8pt', small: '10pt', medium: '12pt', large: '14pt', 'x-large': '18pt', 'xx-large': '24pt' },
        cD = (e, t) =>
            /[0-9.]+px$/.test(e)
                ? ((e, t) => {
        ...
        mD = (e, t) => {
            ...
            return {
                ...
                onAction: xx(e),
                updateText: (t) => {
                    const n = (e) => (ET(e) ? X(e.items, n) : AT(e) ? [{ title: e.title, format: e.format }] : []),
                        s = X(BT(e), n),
                        r = ZM(e, x(s)).fold(x(o), (e) => e.title);
                    Ir(t, vO, { text: r });
                },
                shouldHide: wf(e),
                isInvalid: (t) => !e.formatter.canApply(t.format),
        ...
        gD = x(
            [
                ...
                os('dom'),
                Di('onOpen'),
                hu('splitDropdownBehaviours', [uw, Pp, oh]),
                ys('matchWidth', !1),
                ys('useMinWidth', !1),
                ys('eventOrder', {}),
                us('role')
        ...
        pD = Uu({
            ...
            schema: [os('dom')],
            name: 'arrow',
            defaults: () => ({ buttonBehaviours: kl([oh.revoke()]) }),
            overrides: (e) => ({
                dom: { tag: 'span', attributes: { role: 'presentation' } },
                action: (t) => {
                    t.getSystem().getByUid(e.uid).each(Rr);
                },
                buttonBehaviours: kl([dh.config({ toggleOnExecute: !1, toggleClass: e.toggleClass })])
            })
        }),
        hD = Uu({
            factory: Wh,
        ...
        bD = bm({
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    eventOrder: { ...e.eventOrder, [ur()]: ['disabling', 'toggling', 'alloy.base.behaviour'] },
                    events: i,
                    behaviours: bu(e.splitDropdownBehaviours, [
                        uw.config({
                            others: {
                                sandbox: (t) => {
                        ...
                        Pp.config({ mode: 'special', onSpace: a, onEnter: a, onDown: (e) => (r(e), A.some(!0)) }),
                        oh.config({}),
                        dh.config({ toggleOnExecute: !1, aria: { mode: 'expanded' } })
                    ]),
        ...
        xD = (e, t) => e.map((e) => ({ 'aria-label': t.translate(e), title: t.translate(e) })).getOr({}),
        wD = la('focus-button'),
        SD = (e, t, o, n, s) => {
            const r = t.map((e) => jh(bO(e, 'tox-tbtn', s))),
                a = e.map((e) => jh(fO(e, s.icons)));
            return {
                dom: { tag: 'button', classes: ['tox-tbtn'].concat(t.isSome() ? ['tox-tbtn--select'] : []), attributes: xD(o, s) },
                components: Dy([a.map((e) => e.asSpec()), r.map((e) => e.asSpec())]),
                eventOrder: { [Ws()]: ['focusing', 'alloy.base.behaviour', uO], [Sr()]: [uO, 'toolbar-group-button-events'] },
                buttonBehaviours: kl(
                    [
                        Oy(s.isDisabled),
                        Sy(),
                            ...
                            Jp('toolbar-button-events', [
                                ...
                                Qr((e, t) => {
                                    _y(
                                        ...
                                        Ir(e, dO, { buttonApi: t }), a.onAction(t);
                                    });
                                })),
                                Ty(t, s),
                                Ey(t, s)
                            ]),
                            Oy(() => !e.enabled || o.isDisabled()),
                            Sy()
                        ].concat(t.toolbarButtonBehaviours)
                    ),
                    [uO]: null === (n = r.buttonBehaviours) || void 0 === n ? void 0 : n[uO]
                }
            });
            var a;
        },
        CD = (e, t, o) =>
            kD(e, { toolbarButtonBehaviours: o.length > 0 ? [Jp('toolbarButtonWith', o)] : [], getApi: vD, onSetup: e.onSetup }, t),
        OD = (e, t, o) =>
            kD(
                e,
                {
                    toolbarButtonBehaviours: [
                        Kp.config({}),
                        dh.config({ toggleClass: 'tox-tbtn--enabled', aria: { mode: 'pressed' }, toggleOnExecute: !1 })
                            ...
                            ),
                            {
                                ...
                                menuBehaviours: ly(
                                    'auto' !== t.columns
                                        ...
                                        : [
                                              Kr((e, o) => {
                                                  iy(e, 4, _b(t.presets)).each(({ numRows: t, numColumns: o }) => {
        ...
        AD = {
            ...
            togglebutton: ED(Nv, (e, t) => {
                return (o = e), (n = t.shared.providers), OD(o, n, []);
                var o, n;
            }),
            menubutton: ED(aA, (e, t) => t_(e, 'tox-tbtn', t, A.none(), !1)),
            splitbutton: ED(
                (e) => qn('SplitButton', iA, e),
                (e, t) =>
                    ((e, t) => {
                        const o = (e) => ({
                                isEnabled: () => !Rm.isDisabled(e),
                                ...
                                setActive: (t) => {
                                    kt(e.element, 'aria-pressed', t),
                                        pi(e.element, 'span').each((o) => {
                                            e.getSystem()
                                                .getByDom(o)
                                                .each((e) => dh.set(e, t));
                                        });
                                },
                                isActive: () => pi(e.element, 'span').exists((t) => e.getSystem().getByDom(t).exists(dh.isOn)),
                                setText: (t) =>
                                    pi(e.element, 'span').each((o) =>
                                        e
                                            .getSystem()
                                            .getByDom(o)
                                            .each((e) => Ir(e, vO, { text: t }))
                                    ),
                                setIcon: (t) =>
                                    pi(e.element, 'span').each((o) =>
                                        e
                        ...
                        return bD.sketch({
                            dom: {
                                ...
                                attributes: { 'aria-pressed': !1, ...xD(e.tooltip, t.providers) }
                            },
                            onExecute: (t) => {
                                const n = o(t);
                            ...
                            onItemExecute: (e, t, o) => {},
                            splitDropdownBehaviours: kl([
                                Cy(t.providers.isDisabled),
                                Sy(),
                                Jp('split-dropdown-events', [Kr((e, t) => gO(e)), Ur(wD, oh.focus), Ty(s, n), Ey(s, n)]),
                                IS.config({})
                            ]),
                            eventOrder: { [Sr()]: ['alloy.base.behaviour', 'split-dropdown-events'] },
                            toggleClass: 'tox-tbtn--enabled',
                            lazySink: t.getSink,
                            fetch: _D(o, e, t.providers),
                            parts: { menu: Bb(0, e.columns, e.presets) },
                            components: [
                                bD.parts.button(
                                    SD(
                                        e.icon,
                                        e.text,
                                        A.none(),
                                        A.some([dh.config({ toggleClass: 'tox-tbtn--enabled', toggleOnExecute: !1 })]),
                                        t.providers
                                    )
                                ),
                                bD.parts.arrow({
                                ...
                                bD.parts['aria-descriptor']({ text: t.providers.translate('To open the popup, press Shift+Enter') })
                            ]
                        });
                    })(e, t.shared)
            ),
            grouptoolbarbutton: ED(
                (e) => qn('GroupToolbarButton', nA, e),
                (e, t, o) => {
                    const n = o.ui.registry.getAll().buttons,
                        s = { [yc]: t.shared.header.isPositionedAtTop() ? vc.TopToBottom : vc.BottomToTop };
                    if (Cf(o) === nf.floating)
                        return ((e, t, o, n) => {
                            const s = t.shared,
                                r = Es(b),
                                a = { toolbarButtonBehaviours: [], getApi: vD, onSetup: e.onSetup },
                        ...
                        })(e, t, (e) => DD(o, { buttons: n, toolbar: e, allowToolbarGroups: !1 }, t, A.none()), s);
        ...
        MD = {
            ...
            fontsize: (e, t) => qM(e, t, uD(e)),
            fontsizeinput: (e, t) =>
                ((e, t, o) => {
                    let n = A.none();
                    const s = yx(e, 'NodeChange SwitchMode', (t) => {
                        ...
                        l = (e, t, s) => {
                            const r = n.map((e) => pu.getValue(e)).getOr(''),
                                a = o.getNewValue(r, e),
                                i = r.length - `${a}`.length,
                        ...
                        c = (e, t) => l((e, t) => e - t, e, t),
                        d = (e, t) => l((e, t) => e + t, e, t),
                        u = (e) => rt(e.element).fold(A.none, (e) => (Dl(e), A.some(!0))),
                        m = (e) => (Fl(e.element) ? (ct(e.element).each((e) => Dl(e)), A.some(!0)) : A.none()),
                        g = (o, n, s, i) => {
                            const l = t.shared.providers.translate(s),
                                c = la('altExecuting'),
                                d = yx(e, 'NodeChange SwitchMode', (t) => {
                            ...
                            return Wh.sketch({
                                dom: { tag: 'button', attributes: { title: l, 'aria-label': l }, classes: i.concat(n) },
                                components: [hO(n, t.shared.providers.icons)],
                                buttonBehaviours: kl([
                                    Rm.config({}),
                                    Jp(c, [
                                        Ty({ onSetup: d, getApi: r }, a),
                                        Ey({ getApi: r }, a),
                                        Ur(Ks(), (e, t) => {
                                            (t.event.raw.keyCode !== aD.space() && t.event.raw.keyCode !== aD.enter()) ||
                                                Rm.isDisabled(e) ||
                                                o(!1);
                                        }),
                                        Ur(er(), u),
                                ...
                                eventOrder: {
                                    [Ks()]: [c, 'keying'],
                                    [er()]: [c, 'alloy.base.behaviour'],
                                    [Ps()]: [c, 'alloy.base.behaviour']
                                }
                            });
                        },
                        p = jh(g((e) => c(!1, e), 'minus', 'Decrease font size', ['highlight-on-focus'])),
                        h = jh(g((e) => d(!1, e), 'plus', 'Increase font size', ['highlight-on-focus'])),
                        f = jh({
                            dom: { tag: 'div', classes: ['tox-input-wrapper', 'highlight-on-focus'] },
                            components: [
                                Vb.sketch({
                                    inputBehaviours: kl([
                                        Rm.config({}),
                                        Jp(i, [Ty({ onSetup: s, getApi: r }, a), Ey({ getApi: r }, a)]),
                                        Jp('input-update-display-text', [
                                            Ur(vO, (e, t) => {
                            ...
                            behaviours: kl([
                                oh.config({}),
                                Pp.config({ mode: 'special', onEnter: m, onSpace: m, onEscape: u }),
                                Jp('input-wrapper-events', [
                                    Ur(qs(), (e) => {
                                        L([p, h], (t) => {
                    ...
                    ((e) => {
                        ...
                        return {
                            updateInputValue: (e) => Ir(e, vO, { text: t() }),
                            onAction: (t, o) => e.execCommand('FontSize', !1, t, { skip_focus: !o }),
                            getNewValue: (o, n) => {
                                rD(o, ['unsupportedLength', 'empty']);
                                const s = rD(o, ['unsupportedLength', 'empty']).or(rD(t(), ['unsupportedLength', 'empty'])),
                                    r = s.map((e) => e.value).getOr(16),
                                    a = Rf(e),
                                    i = s
                                        .map((e) => e.unit)
                                        .filter((e) => '' !== e)
                                ...
                                return `${((e) => e >= 0)(l) ? l : r}${i}`;
                            }
                        };
                    })(e)
                ),
            fontfamily: (e, t) => qM(e, t, oD(e)),
            blocks: (e, t) => qM(e, t, QM(e)),
            align: (e, t) => qM(e, t, JM(e))
        },
        DD = (e, t, o, n) => {
            const s = ((e) => {
                    const t = e.toolbar,
                    ...
                    return !1 === t
                        ...
                        ? ((e) => {
                              const t = H(TD, (t) => {
                                  const o = U(t.items, (t) => ve(e, t) || ve(MD, t));
                        ...
                        ? ((e) => {
                              const t = e.split('|');
                              return H(t, (e) => ({ items: e.trim().split(' ') }));
                          })(t)
                        ...
                        0 === s.trim().length
                            ...
                            : ((e, t, o, n, s, r) =>
                                  be(t, o.toLowerCase())
                                      ...
                                      .fold(
                                          () => be(MD, o.toLowerCase()).map((t) => t(e, s)),
                                          (t) =>
    ...
    var RD = Object.freeze({
        __proto__: null,
        render: async (e, t, o, n, s) => {
            const { mainUi: r, uiMotherships: a } = t,
                i = Es(0),
                l = r.outerContainer;
            await WM(e);
            const d = Ve(s.targetNode),
                u = ft(ht(d));
            Rd(d, r.mothership),
                ((e, t, o) => {
                ...
                e.on('PostRender', () => {
                    IM.setSidebar(l, o.sidebar, $f(e)),
                        BD(e, t, o, n),
                        i.set(e.getWin().innerWidth),
                        IM.setMenubar(l, VM(e, o)),
                        IM.setViews(l, o.views),
                        ((e, t) => {
                            ...
                            const r = e.getDoc().documentElement,
                                ...
                                c = () => {
                                    ...
                                    (o.left === t.offsetWidth && o.top === t.offsetHeight) ||
                                        (i.set($t(t.offsetWidth, t.offsetHeight)), gx(e));
                                },
                                d = (t) => {
                                    ((e, t) => {
            ...
            const m = IM.getSocket(l).getOrDie('Could not find expected socket element');
            if (ID) {
                Bt(m.element, { overflow: 'scroll', '-webkit-overflow-scrolling': 'touch' });
                const t = ((e, t) => {
                        let o = null;
                        return {
                            cancel: () => {
            ...
            wy(e, t),
                ...
                e.addCommand('ToggleView', (t, o) => {
                    if (IM.toggleView(l, o)) {
                        const t = l.element;
                        r.mothership.broadcastOn([Yd()], { target: t }),
                            L(a, (e) => {
                                e.broadcastOn([Yd()], { target: t });
                            }),
            ...
            const p = {
                ...
                isEnabled: () => !Rm.isDisabled(l)
            };
            return { iframeContainer: m.element.dom, editorContainer: l.element.dom, api: p };
        }
    });
    const ND = (e) => (/^[0-9\.]+(|px)$/i.test('' + e) ? A.some(parseInt('' + e, 10)) : A.none()),
        VD = (e) => (h(e) ? e + 'px' : e),
        zD = (e, t, o) => {
        ...
        HD = (e) => {
            const t = pf(e),
                o = hf(e),
                n = bf(e);
            return ND(t).map((e) => zD(e, o, n));
        },
        { ToolbarLocation: LD, ToolbarMode: PD } = db,
        UD = (e, t, o, n, s) => {
            const { mainUi: r, uiMotherships: a } = o,
                ...
                h = Es(!1),
                f = () => h.get() && !e.removed,
                b = (e) => (p ? e.fold(x(0), (e) => (e.components().length > 1 ? Wt(e.components()[1].element) : 0)) : 0),
                v = () => {
                    L(a, (e) => {
                        e.broadcastOn([Kd()], {});
                    });
                ...
                y = (o) => {
                    ...
                    l ||
                        s.on((e) => {
                            const o = d.getOrThunk(() => {
                                const e = ND(It(xt(), 'margin-left')).getOr(0);
                    ...
                    const n = l
                        ...
                        : (() => {
                              if (l) return A.none();
                              if (
                                  Xt(r.outerContainer.element).left + Zt(r.outerContainer.element) >= window.innerWidth - 40 ||
                                  Nt(r.outerContainer.element, 'width').isSome()
                              ) {
                                  Dt(r.outerContainer.element, 'position', 'absolute'),
                                      Dt(r.outerContainer.element, 'left', '0px'),
                                      Ht(r.outerContainer.element, 'width');
                                  const e = Zt(r.outerContainer.element);
                                  return A.some(e);
                              }
                              return A.none();
                          })();
                    p && IM.refreshToolbar(r.outerContainer),
                        l ||
                            ((o) => {
                                s.on((n) => {
                                    const s = IM.getToolbar(r.outerContainer),
                                        a = b(s),
                                        i = Jo(t),
                                        { top: l, left: c } = ((e, t) => (lb(e) ? xE(t) : A.none()))(e, r.outerContainer.element).fold(
                                            () => ({ top: m() ? Math.max(i.y - Wt(n.element) + a, 0) : i.bottom, left: i.x }),
                                            (e) => {
                                                var t;
                                                const o = Jo(e),
                                                ...
                                                return { top: m() ? l : i.bottom, left: r ? i.x : i.x - o.x };
                                            }
                                        ),
                                        d = { position: 'absolute', left: Math.round(c) + 'px', top: Math.round(l) + 'px' },
                                        u = o
                                            .map((e) => {
                                                const t = Uo(),
                                            ...
                                            .getOr({});
                                    Bt(r.outerContainer.element, { ...d, ...u });
                                });
                            })(n),
                        c && s.on(o),
                        v();
                    ...
                    s.get().exists((o) => {
                        const n = u.getDockingMode(),
                            a = ((o) => {
                                switch (_f(e)) {
                                    case LD.auto:
                                        const e = IM.getToolbar(r.outerContainer),
                                            n = b(e),
                                            s = Wt(o.element) - n,
                                            a = Jo(t);
                                        if (a.y > s) return 'top';
                                        {
                                            ...
                                            return a.bottom < o - s || en().bottom < a.bottom - s ? 'bottom' : 'top';
                                        }
                                    case LD.bottom:
                                        return 'bottom';
                                    case LD.top:
            ...
            return {
                ...
                show: () => {
                    h.set(!0),
                        Dt(r.outerContainer.element, 'display', 'flex'),
                        i.addClass(e.getBody(), 'mce-edit-focus'),
                        L(a, (e) => {
                            Ht(e.element, 'display');
                        }),
                        w(),
                        lb(e) ? y((e) => ($E.isDocked(e) ? $E.reset(e) : $E.refresh(e))) : y($E.refresh);
                },
                hide: () => {
                    h.set(!1),
                        Dt(r.outerContainer.element, 'display', 'none'),
    ...
    var jD = Object.freeze({
        ...
        render: async (e, t, o, n, s) => {
            ...
            const d = () => {
                ...
                const s = rb(e);
                lb(e) ? (Rd(i, r.mothership), Rd(i, t.popupUi.mothership)) : Id(s, r.mothership),
                    Id(s, t.dialogUi.mothership),
                    BD(e, t, o, n),
                    IM.setMenubar(r.outerContainer, VM(e, o)),
                    l.show(),
                    ((e, t, o, n) => {
                        const s = Es(WD(t, o.isPositionedAtTop())),
                            r = (n) => {
                                const { pos: r, bounds: a } = WD(t, o.isPositionedAtTop()),
                                    { pos: i, bounds: l } = s.get(),
                                    c = a.height !== l.height || a.width !== l.width;
                                s.set({ pos: r, bounds: a }),
                                    c && gx(e, n),
                                    o.isVisible() && (i !== r ? o.update($E.reset) : c && (o.updateMode(), o.repositionPopups()));
                            };
                        n || (e.on('activate', o.show), e.on('deactivate', o.hide)),
                            e.on('SkinLoaded ResizeWindow', () => o.update($E.reset)),
                            e.on('NodeChange keydown', (e) => {
                                requestAnimationFrame(() => r(e));
                            });
                        let a = 0;
                        const i = PC(() => o.update($E.refresh), 33);
                        e.on('ScrollWindow', () => {
                            const e = Uo().left;
                        ...
                        const l = Zl();
                        l.set(oc(Ve(e.getBody()), 'load', (e) => r(e.raw))),
                            e.on('remove', () => {
                                l.clear();
                            });
                    })(e, i, l, c),
            ...
            const u = {
                ...
                isEnabled: () => !Rm.isDisabled(r.outerContainer)
            };
            return { editorContainer: r.outerContainer.element.dom, api: u };
        }
    });
    const GD = 'contexttoolbar-hide',
        $D = (e, t) =>
            Ur(dO, (o, n) => {
                const s = ((e) => ({ hide: () => Fr(e, hr()), getValue: () => pu.getValue(e) }))(e.get(o));
                ...
                n = jh(
                    Vb.sketch({
                        ...
                        inputBehaviours: kl([
                            Pp.config({
                                mode: 'special',
                                onEnter: (e) => s.findPrimary(e).map((e) => (Rr(e), !0)),
                                onLeft: (e, t) => (t.cut(), A.none()),
                                onRight: (e, t) => (t.cut(), A.none())
                            })
                        ])
                                ...
                                ((e) => 'contextformtogglebutton' === e.type)(t)
                                    ? ((e, t, o) => {
                                          const { primary: n, ...s } = t.original,
                                              r = Xn(Nv({ ...s, type: 'togglebutton', onAction: b }));
                                          return OD(r, o, [$D(e, t)]);
                                      })(e, t, o)
                                    : ((e, t, o) => {
                                          const { primary: n, ...s } = t.original,
                                              r = Xn(Fv({ ...s, type: 'button', onAction: b }));
                                          return CD(r, o, [$D(e, t)]);
                                      })(e, t, o))(e, t, o)
                        )
                    );
        ...
        XD = (e, t, o) => t.bottom - e.y >= o && e.bottom - t.y >= o,
        YD = (e) => {
            const t = ((e) => {
                const t = e.getBoundingClientRect();
                if (t.height <= 0 && t.width <= 0) {
                    const o = ut(Ve(e.startContainer), e.startOffset).element;
                    return ($e(o) ? st(o) : A.some(o))
                        .filter(Ge)
            ...
            if (e.inline) {
                const e = Uo();
                return Ko(e.left + t.left, e.top + t.top, t.width, t.height);
            }
            {
                const o = Zo(Ve(e.getBody()));
                return Ko(o.x + t.left, o.y + t.top, t.width, t.height);
            }
        },
        KD = (e, t, o, n = 0) => {
            const s = Go(window),
        ...
        ZD = { maxHeightFunction: cc(), maxWidthFunction: VA() },
        QD = (e) => 'node' === e,
        eB = (e, t, o, n, s) => {
            const r = YD(e),
            ...
            return ((e, t) => {
                ...
                ? ((e, o, s) => {
                      ...
                      Dt(e, 'position', o);
                      const i = XD(r, Jo(t), -20) && !n.isReposition() ? hT : gT;
                      return a.each((t) => Dt(e, 'position', t)), i;
                  })(t, n.getMode())
                : ('fixed' === n.getMode() ? s.y + Uo().top : s.y) + (Wt(t) + 12) <= r.y
                ? lT
                : cT;
        },
        tB = (e, t, o, n) => {
            const s = (t) => (n, s, r, a, i) => ({ ...eB(e, a, t, o, i)({ ...n, y: i.y, height: i.height }, s, r, a, i), alwaysFit: !0 }),
                r = (e) => (QD(n) ? [s(e)] : []);
            return t
                ? { onLtr: (e) => [cl, sl, rl, al, il, ll].concat(r(e)), onRtl: (e) => [cl, rl, sl, il, al, ll].concat(r(e)) }
                : { onLtr: (e) => [ll, cl, al, sl, il, rl].concat(r(e)), onRtl: (e) => [ll, cl, il, rl, al, sl].concat(r(e)) };
        },
        oB = (e, t) => {
        ...
        nB = (e, t) => {
            ...
            return (
                L(i, (i) => {
                    ...
                    'contextform' === l.type
                        ? ((e, i) => {
                              const l = Xn(qn('ContextForm', Wv, i));
                              (o[e] = l),
                                  l.launch.map((o) => {
                                      r['form:' + e] = {
                                          ...i.launch,
                        ...
                        : 'contexttoolbar' === l.type &&
                          ((e, t) => {
                              var o;
                              ((o = t), qn('ContextToolbar', jv, o)).each((o) => {
        ...
        cB = (e, t, o, n) => {
            const s = n.backstage,
                            ...
                            inlineBehaviours: kl([
                                Jp('context-toolbar-events', [
                                    ...
                                    Ur(aB, (e, t) => {
                                        ...
                                        Dt(o, 'width', n + 'px'),
                                            Ph.getContent(e).each((e) => {
                                                t.event.focus.bind((e) => (Dl(e), Rl(o))).orThunk(() => (Pp.focusIn(e), Il(ht(o))));
                                            }),
                                            setTimeout(() => {
                                    ...
                                    Ur(sB, (e, o) => {
                                        Ph.getContent(e).each((o) => {
                                            t.set(t.get().concat([{ bar: o, focus: Il(ht(e.element)) }]));
                                        }),
                                            Ir(e, aB, { contents: o.event.forwardContents, focus: A.none() });
                                    }),
                                    Ur(rB, (e, o) => {
                                        ne(t.get()).each((o) => {
                                            t.set(t.get().slice(0, t.get().length - 1)), Ir(e, aB, { contents: ai(o.bar), focus: o.focus });
                                        });
                                    })
                                ]),
                                Pp.config({
                            ...
                            o = xe(c.get(), 'node')
                                ? ((e, t) =>
                                      t
                                          .filter((e) => yt(e) && je(e))
                                          .map(Zo)
                                          .getOrThunk(() => YD(e)))(e, i.get())
                                : YD(e);
                        return t.height <= 0 || !XD(o, t, 0.01);
                    }
                    return !0;
                },
                p = () => {
                ...
                h = () => {
                    if (Ph.isOpen(d)) {
                        const e = d.element;
                        Ht(e, 'display'), g() ? Dt(e, 'display', 'none') : (l.set(0), Ph.reposition(d));
                    }
                },
                f = (t) => ({
                    ...
                    behaviours: kl([
                        Pp.config({ mode: 'acyclic' }),
                        Jp('pop-dialog-wrap-events', [
                            Kr((t) => {
                                e.shortcuts.add('ctrl+F9', 'focus statusbar', () => Pp.focusIn(t));
                            }),
                            Jr((t) => {
                        ...
                        i = q(
                            H(t, (t) =>
                                'contexttoolbar' === t.type
                                    ? ((t, o) =>
                                          DD(e, { buttons: t, toolbar: o.items, allowToolbarGroups: !1 }, n.backstage, A.some(['form:'])))(
                                          s,
                                          t
                                      )
                                    : ((e, t) => qD(e, t))(t, r.providers)
                            )
                        );
                    return lM({
                        type: a,
                ...
                x = (t, n) => {
                    ...
                    const s = y(t),
                        ...
                        h = ((t, n) => {
                            const s = 'node' === t ? r.anchors.node(n) : r.anchors.cursor(),
                                c = ((e, t, o, n) =>
                                    'line' === t
                                        ? { bubble: gc(12, 0, JD), layouts: { onLtr: () => [dl], onRtl: () => [ul] }, overrides: ZD }
                                        : { bubble: gc(0, 12, JD, 1 / 12), layouts: tB(e, o, n, t), overrides: ZD })(e, t, a(), {
                                    lastElement: i.get,
                                    isReposition: () => xe(l.get(), 0),
                                    getMode: () => Sd.getMode(o)
                                });
                            return fn(s, c);
                        })(p, n);
                    c.set(p), l.set(1);
                    ...
                    Ht(b, 'display'),
                        ...
                        Ph.showWithinBounds(d, f(s), { anchor: h, transition: { classes: [lB], mode: 'placement' } }, () => A.some(u())),
                                                ...
                                                const o = ((e) => {
                                                    if (e.length <= 1) return e;
                                                    {
                                                        ...
                                                        if (n || s) {
                                                            if (s && n) {
                                                                const e = o('node'),
                                                                    t = H(o('selection'), (e) => ({ ...e, position: 'node' }));
                                                                return e.concat(t);
                                                            }
                                        ...
                                        ((e, t, o) =>
                                            e(t)
                                                ...
                                                : Fs(
                                                      ...
                                                      (e) => {
                                                          if (Ge(e)) {
                                                              const { contextToolbars: t, contextForms: n } = oB(e, o.inNodeScope),
                                                                  s =
                                                                      n.length > 0
                                                                          ? n
                                                                          : ((e) => {
        ...
        uB = (e) => {
            dB(
                ...
                ((e) => ({
                    ...
                    icon: 'line-height',
                    getOptions: Zf,
                    hash: (e) => ((e, t) => rD(e, ['fixed', 'relative', 'empty']).map(({ value: e, unit: t }) => e + t))(e).getOr(e),
                    display: w,
        ...
        gB = (e, t) => (o) => {
            ...
            return e.on('PastePlainTextToggle', n), fx(() => e.off('PastePlainTextToggle', n), bx(e)(o));
        },
        pB = (e, t) => () => {
                ...
                ((e) => {
                    ...
                    ((e) => {
                        LC.each(
                            ...
                            (t) => {
                                e.ui.registry.addButton(t.name, { tooltip: t.text, icon: t.icon, onAction: wx(e, t.action) });
                            }
                        ),
                            LC.each(
                                [
        ...
        fB = (e, t) =>
            yx(e, 'Undo Redo AddUndo TypingUndo ClearUndos SwitchMode', (o) => {
            ...
            ((e) => {
                ...
                ((e) => {
                    ...
                    const t = Lx(e),
                        ...
                        n = Es(t),
                        s = Es(o);
                    Yx(e, 'forecolor', 'forecolor', 'Text color', n),
                        Yx(e, 'backcolor', 'hilitecolor', 'Background color', s),
                        Kx(e, 'forecolor', 'forecolor', 'Text color', n),
                        Kx(e, 'backcolor', 'hilitecolor', 'Background color', s);
                })(e),
                ((e) => {
                    ((e) => {
            ...
            'contextmenu' === t.type || 'longpress' === t.type
                ? e.inline
                    ? ((e) => {
                          if (OB(e)) {
                              const t = e.touches[0];
                              return CB(t.pageX, t.pageY);
                          }
                          return CB(e.pageX, e.pageY);
                      })(t)
                    : ((e, t) => {
                          const o = rf.DOM.getPos(e);
                          return ((e, t, o) => CB(e.x + t, e.y + o))(t, o.x, o.y);
                      })(
                          e.getContentAreaContainer(),
                          ((e) => {
                              if (OB(e)) {
                                  const t = e.touches[0];
                                  return CB(t.clientX, t.clientY);
                              }
                              return CB(e.clientX, e.clientY);
                          })(t)
                      )
                : TB(e),
        TB = (e) => ({ type: 'selection', root: Ve(e.selection.getNode()) }),
        EB = (e, t, o) => {
            switch (o) {
                case 'node':
                    return ((e) => ({ type: 'node', node: A.some(Ve(e.selection.getNode())), root: Ve(e.getBody()) }))(e);
                case 'point':
                    return _B(e, t);
                case 'selection':
                    return TB(e);
        ...
        AB = (e, t, o, n, s, r) => {
            const a = o(),
                i = EB(e, t, r);
            CO(a, pb.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !1, search: A.none() }).map((e) => {
                t.preventDefault(), Ph.showMenuAt(s, { anchor: i }, { menu: { markers: Ab('normal') }, data: e });
            });
        },
        MB = {
            onLtr: () => [cl, sl, rl, al, il, ll, lT, cT, iT, rT, aT, sT],
            onRtl: () => [cl, rl, sl, il, al, ll, lT, cT, aT, sT, iT, rT]
        },
        DB = {
            valignCentre: [],
            alignCentre: [],
                    ...
                    ((e, t, o, n, s, r, a) => {
                        const i = ((e, t, o) => {
                            ...
                            return {
                                ...
                                layouts: MB,
                                overrides: { maxWidthFunction: VA(), maxHeightFunction: cc() },
                                ...n
                            };
                        })(e, t, r);
                        CO(o, pb.CLOSE_ON_EXECUTE, n, { isHorizontalMenu: !0, search: A.none() }).map((o) => {
                            t.preventDefault();
                            const l = a ? zh.HighlightMenuAndItem : zh.HighlightNone;
                            Ph.showMenuWithinBounds(
                                s,
                                { anchor: i },
                                { menu: { markers: Ab('normal'), highlightOnOpen: l }, data: o, type: 'horizontal' },
                                () => A.some(KD(e, n.shared, 'node' === r ? 'node' : 'selection'))
                            ),
                                e.dispatch(GD);
                        });
                    })(e, t, a, n, s, r, !(c || i || (l && d)));
            ...
            if ((l || i) && 'node' !== r) {
                ...
                ((e, t) => {
                    ...
                    if (o.isCollapsed() || t.touches.length < 1) return !1;
                    {
                        const n = t.touches[0],
                            s = o.getRng();
                        return Jc(e.getWin(), Lc.domRange(s)).exists(
        ...
        zB = (e, t) => (VB(e, t) ? e.selection.getStart(!0) : t.target),
        HB = (e, t, o) => {
            const n = Do().deviceType.isTouch,
                ...
                a = () => Ph.hide(s),
                i = (t) => {
                    if ((wB(e) && t.preventDefault(), ((e, t) => t.ctrlKey && !wB(e))(e, t) || ((e) => 0 === kB(e).length)(e))) return;
                    const a = ((e, t) => {
                        const o = SB(e),
                            n = VB(e, t) ? 'selection' : 'point';
                        if (De(o)) {
                            const s = zB(e, t);
                            return $w(Ve(s), o) ? 'node' : n;
                        }
                        return n;
                    })(e, t);
                    (n() ? BB : AB)(
        ...
        LB = As([{ offset: ['x', 'y'] }, { absolute: ['x', 'y'] }, { fixed: ['x', 'y'] }]),
        PB = (e) => (t) => t.translate(-e.left, -e.top),
        UB = (e) => (t) => t.translate(e.left, e.top),
        WB = (e) => (t, o) => j(e, (e, t) => t(e), $t(t, o)),
        jB = (e, t, o) => e.fold(WB([UB(o), PB(t)]), WB([PB(t)]), WB([])),
        GB = (e, t, o) => e.fold(WB([UB(o)]), WB([]), WB([UB(t)])),
        $B = (e, t, o) => e.fold(WB([]), WB([PB(o)]), WB([UB(t), PB(o)])),
        qB = (e, t, o) => {
            const n = e.fold(
        ...
        QB = (e, t, o, n, s, r) => {
            const a = ((e, t, o, n) =>
                    ((e, t) => {
                        ...
                        () => o,
                        (e) => JB(e.left + n.left, e.top + n.top)
                    ))(e, t, o, n),
            ...
            return (
                ...
                i.fold(
                    () => ({ coord: JB(l.left, l.top), extra: A.none() }),
        ...
        eF = (e, t, o, n) =>
            re(e, (e) => {
                ...
                return r ? A.some({ output: XB(e.output, t, o, n), extra: e.extra }) : A.none();
            }),
        tF = (e, t, o, n, s) => {
            const r = t.getSnapPoints(e);
            return eF(r, o, n, s).orThunk(() => {
                const e = j(
                    r,
                    (e, t) => {
                        const r = t.sensor,
                ...
                return e.snap.map((e) => ({ output: XB(e.output, o, n, s), extra: e.extra }));
            });
        },
        oF = (e, t, o, n, s) => {
            const r = t.getSnapPoints(e);
        ...
        snapTo: (e, t, o, n) => {
            ...
            if (t.repositionTarget) {
                const t = et(e.element),
                    o = Uo(t),
                    r = wE(s),
                    a = ((e, t, o) => ({ coord: XB(e.output, e.output, t, o), extra: e.extra }))(n, o, r),
                    i = qB(a.coord, 0, r);
                Ft(s, i);
            }
        }
    });
    const sF = 'data-initial-z-index',
        rF = (e, t) => {
    ...
    const cF = [
        ...
        dF = (e) => {
            ...
            t.isSome() && o.isSome() && n.isSome()
                ? A.some(
                      ((e, t, o) => ('fixed' === o ? JB : YB)(parseInt(e, 10), parseInt(t, 10)))(t.getOrDie(), o.getOrDie(), n.getOrDie())
                  )
                : A.none()).getOrThunk(() => {
                const t = Xt(e);
        ...
        uF = (e, t) => ({ bounds: e.getBounds(), height: jt(t.element), width: Zt(t.element) }),
        mF = (e, t, o, n, s) => {
            const r = o.update(n, s),
                a = o.getStartData().getOrThunk(() => uF(t, e));
            r.each((o) => {
                ((e, t, o, n) => {
                    const s = t.getTarget(e.element);
                    if (t.repositionTarget) {
                        const r = et(e.element),
                            a = Uo(r),
                            i = wE(s),
                            l = dF(s),
                            c = ((e, t, o, n, s, r, a) =>
    ...
    const fF = (e, t, o) => [
        ...
        bF = [...cF, Ri('dragger', { handlers: pF(fF) })];
    ...
    const yF = (e, t, o) => {
        ...
        xF = bF,
        wF = [...cF, Ri('dragger', { handlers: pF(yF) })],
        SF = [...cF, Ri('dragger', { handlers: pF((e, t, o) => [...fF(e, t, o), ...yF(e, t, o)]) })];
    var kF = Object.freeze({ __proto__: null, mouse: xF, touch: wF, mouseOrTouch: SF }),
        CF = Object.freeze({
            __proto__: null,
            init: () => {
                let e = A.none(),
    ...
    const OF = Tl({
        ...
        _F = (e, t, o, n, s, r) =>
            e.fold(
                () => OF.snap({ sensor: KB(o - 20, n - 20), range: $t(s, r), output: KB(A.some(o), A.some(n)), extra: { td: t } }),
                (e) => {
                    const s = o - 20,
                        r = n - 20,
        ...
        EF = (e) =>
            jh(
                Wh.sketch({
                    ...
                    buttonBehaviours: kl([OF.config({ mode: 'mouseOrTouch', blockerClass: 'blocker', snaps: e }), IS.config({})]),
        ...
        AF = (e, t) => {
            const o = Es([]),
                ...
                f = (e) => h(g, e, i, 'top'),
                b = (e) => h(p, e, l, 'bottom');
            Do().deviceType.isTouch() &&
                (e.on('TableSelectionChange', (e) => {
                    s.get() || (Ad(t, g), Ad(t, p), s.set(!0)),
                        r.set(e.start),
                        a.set(e.finish),
                        e.otherCells.each((t) => {
        ...
        MF = (e, t, o) => {
            ...
            return {
                ...
                behaviours: kl([
                    Pp.config({ mode: 'flow', selector: 'div[role=button]' }),
                    Rm.config({ disabled: o.isDisabled }),
                    Sy(),
                    cS.config({}),
                    Kp.config({}),
                    Jp('elementPathEvents', [
                        Kr((t, n) => {
                            e.shortcuts.add('alt+F11', 'focus statusbar elementpath', () => Pp.focusIn(t)),
                                e.on('NodeChange', (n) => {
                                    const r = ((t) => {
                                            const o = [];
                                            let n = t.length;
    ...
    const BF = (e, t, o) => {
            const n = Ve(e.getContainer()),
                s = ((e, t, o, n, s) => {
                    const r = { height: zD(n + t.top, ff(e), vf(e)) };
                            ...
                            (() => {
                                ...
                                return (
                                    e.hasPlugin('wordcount') &&
                                        o.push(
                                            ((e, t) => {
                                                const o = (e, o, n) => Kp.set(e, [ti(t.translate(['{0} ' + n, o[n]]))]);
                                                return Wh.sketch({
                                                    ...
                                                    buttonBehaviours: kl([
                                                        ...
                                                        Jp('wordcount-events', [
                                                            Qr((e) => {
                                                                ...
                                                                pu.setValue(e, { mode: n, count: t.count }), o(e, t.count, n);
                                                            }),
                                                            Kr((t) => {
                                                                e.on('wordCountUpdate', (e) => {
                                                                    const { mode: n } = pu.getValue(t);
                                                                    pu.setValue(t, { mode: n, count: e.wordCount }), o(t, e.wordCount, n);
                                                                });
                                                            })
                                                        ])
                                                    ]),
                                                    eventOrder: { [ur()]: ['disabling', 'alloy.base.behaviour', 'wordcount-events'] }
                                                });
                                            })(e, t)
                                        ),
                                    Wf(e) &&
                            ...
                            return A.some(
                                ef(
                                    'resize-handle',
                                    {
                                        ...
                                        attributes: { title: t.translate('Resize'), 'aria-label': t.translate(n) },
                                        behaviours: [
                                            OF.config({
                                                mode: 'mouse',
                                                repositionTarget: !1,
                                                onDrag: (t, n, s) => BF(e, s, o),
        ...
        RF = (e, t) => t.get().getOrDie(`UI for ${e} has not been rendered`),
        NF = (e, t) => {
            const o = e.inline,
                n = o ? jD : RD,
                s = ib(e) ? oA : yE,
                ...
                d = ob(e),
                u = Cf(e),
                m = jh({ dom: { tag: 'div', classes: ['tox-anchorbar'] } }),
                g = jh({ dom: { tag: 'div', classes: ['tox-bottom-anchorbar'] } }),
                p = () =>
                    r.mainUi
                        .get()
                ...
                y = ((e, t, o, n) => {
                    const s = Es(!1),
                        ...
                        c = ((e) => ({ colorPicker: kT(e), hasCustomColors: CT(e), getColors: OT(e), getColorCols: _T(e) }))(t),
                        d = ((e) => ({ isDraggableModal: TT(e) }))(t),
                        u = {
                            shared: { providers: a, anchors: ST(t, o, n, r.isPositionedAtTop), header: r },
                            urlinput: i,
                            styles: l,
                            colorinput: c,
                            dialog: d,
                        ...
                        m = { ...u, shared: { ...u.shared, interpreter: (e) => K_(e, {}, m), getSink: e.popup } },
                        g = { ...u, shared: { ...u.shared, interpreter: (e) => K_(e, {}, g), getSink: e.dialog } };
                ...
                x = () => {
                    const t = (() => {
                            const t = { attributes: { [yc]: d ? vc.BottomToTop : vc.TopToBottom } },
                                o = IM.parts.menubar({
                                ...
                                i = Kf(e),
                                l = qf(e),
                                c = IM.parts.promotion({ dom: { tag: 'div', classes: ['tox-promotion'] } }),
                                g = r || a || i,
                                h = l ? [c, o] : [o];
                        ...
                        n = {
                            ...
                            components: [
                                IM.parts.socket({ dom: { tag: 'div', classes: ['tox-edit-area'] } }),
                                IM.parts.sidebar({ dom: { tag: 'div', classes: ['tox-sidebar'] } })
                            ]
                        },
                        s = IM.parts.throbber({ dom: { tag: 'div', classes: ['tox-throbber'] }, backstage: y.popup }),
                        r = IM.parts.viewWrapper({ backstage: y.popup }),
                        i = Pf(e) && !o ? A.some(IF(e, y.popup.shared.providers)) : A.none(),
                        l = q([d ? [] : [t], o ? [] : [n], d ? [t] : []]),
                        h = IM.parts.editorContainer({ components: q([l, o ? [] : [g.asSpec(), ...i.toArray()]]) }),
                        f = ab(e),
                        v = { role: 'application', ...(Gh.isRtl() ? { dir: 'rtl' } : {}), ...(f ? { 'aria-hidden': 'true' } : {}) },
                        x = ri(
                            IM.sketch({
                                dom: {
                                    tag: 'div',
                                ...
                                behaviours: kl([
                                    Sy(),
                                    Rm.config({ disableClass: 'tox-tinymce--disabled' }),
                                    Pp.config({
                                        mode: 'cyclic',
                                        selector:
                ...
                w = (t) => {
                    const o = VD(
                        ...
                        n = VD(((e) => HD(e).getOr(pf(e)))(e));
                    return (
                        e.inline ||
                            (zt('div', 'width', n) && Dt(t.element, 'width', n),
                            zt('div', 'height', o) ? Dt(t.element, 'height', o) : Dt(t.element, 'height', '400px')),
                        o
                    );
                };
            return {
                popups: { backstage: y.popup, getMothership: () => RF('popups', l) },
                dialogs: { backstage: y.dialog, getMothership: () => RF('dialogs', i) },
                renderUI: () => {
                    const o = x(),
                        a = (() => {
                            const t = rb(e),
                                ...
                                n = {
                                    dom: {
                                        ...
                                        attributes: { ...(Gh.isRtl() ? { dir: 'rtl' } : {}) }
                                    },
                                    behaviours: kl([Sd.config({ useFixed: () => s.isDocked(p) })])
                                },
                                r = {
                        ...
                        d = lb(e)
                            ? (() => {
                                  const e = {
                                          ...
                                          behaviours: kl([
                                              Sd.config({ useFixed: () => s.isDocked(p), getBounds: () => t.getPopupSinkBounds() })
                                          ])
                                      },
                                      o = ri(e),
                                      n = nS(o);
                    ...
                    return ((t) => {
                        ...
                        (f = o.outerContainer),
                            ...
                            e.addQueryStateHandler('ToggleToolbarDrawer', () => IM.isToolbarDrawerToggled(f)),
                            ((e, t, o) => {
                                const n = (e, n) => {
                                        L([t, ...o], (t) => {
                                    ...
                                    r = (e) => s(Yd(), { target: e.target }),
                                    a = $o(),
                                    i = tc(a, 'touchstart', r),
                                    l = tc(a, 'touchmove', (e) => n(vr(), e)),
                                    c = tc(a, 'touchend', (e) => n(yr(), e)),
                                    d = tc(a, 'mousedown', r),
                                    u = tc(a, 'mouseup', (e) => {
                                        0 === e.raw.button && s(Jd(), { target: e.target });
                                    }),
                                    m = (e) => s(Yd(), { target: Ve(e.target) }),
                                    g = (e) => {
                                        0 === e.button && s(Jd(), { target: Ve(e.target) });
                                    },
                                    p = () => {
                                    ...
                                    v = oc(b, 'scroll', (o) => {
                                        requestAnimationFrame(() => {
                                            if (null != e.getContainer()) {
                                                const s = jw(e, t.element)
                                                    .map((e) => [e.element, ...e.others])
                                                    .getOr([]);
                                                N(s, (e) => Ze(e, o.target)) &&
                                                    (e.dispatch('ElementScroll', { target: o.target.dom }), n(Er(), o));
                                            }
                                        });
                                    }),
                                    y = () => s(Kd(), {}),
                                    x = (t) => {
                                        t.state && s(Yd(), { target: Ve(e.getContainer()) });
                                    },
                                    w = (e) => {
                                        s(Yd(), { target: Ve(e.relatedTarget.getContainer()) });
                                    };
                                e.on('PostRender', () => {
                                    e.on('click', m),
                                        e.on('tap', m),
                                    ...
                                    e.on('detach', () => {
                                        L([t, ...o], Vd), L([t, ...o], (e) => e.destroy());
                                    });
                            })(e, o.mothership, a),
                            s.setup(e, y.popup.shared, p),
                            vB(e, y.popup),
                            HB(e, y.popup.shared.getSink, y.popup),
                            ((e) => {
                            ...
                            EA(e, v, y.popup.shared),
                            cB(e, c, r.sink, { backstage: y.popup }),
                            AF(e, r.sink);
        ...
        HF = x([
            ...
            Uu({ schema: [os('dom')], name: 'title' }),
            Uu({ factory: zF, schema: [os('dom')], name: 'close' }),
            Uu({ factory: zF, schema: [os('dom')], name: 'body' }),
            ju({ factory: zF, schema: [os('dom')], name: 'footer' }),
            Wu({
                factory: { sketch: (e, t) => ({ ...e, dom: t.dom, components: t.components }) },
                schema: [
                    ys('dom', { tag: 'div', styles: { position: 'fixed', left: '0px', top: '0px', right: '0px', bottom: '0px' } }),
                    ys('components', [])
                ],
                name: 'blocker'
            })
        ...
        LF = bm({
            ...
            factory: (e, t, o, n) => {
                const s = Ql(),
                    r = la('modal-events'),
                    a = { ...e.eventOrder, [Sr()]: [r].concat(e.eventOrder['alloy.system.attached'] || []) };
                return {
                    uid: e.uid,
                    dom: e.dom,
                    components: t,
                    ...
                    behaviours: bu(e.modalBehaviours, [
                        Kp.config({}),
                        Pp.config({
                            mode: 'cyclic',
                            onEnter: e.onExecute,
        ...
        jF = [...WF, sv],
        GF = [as('type', ['submit', 'cancel', 'custom']), ...jF],
        $F = [as('type', ['menu']), pv, fv, hv, ds('items', PF), ...WF],
        qF = [...WF, as('type', ['togglebutton']), rs('tooltip'), hv, pv, Cs('active', !1)],
        XF = Jn('type', { submit: GF, cancel: GF, custom: GF, menu: $F, togglebutton: qF }),
        ...
        pI = Gn((e) => qn('customeditor.old', Mn(gI), e).orThunk(() => qn('customeditor.new', Mn(mI), e))),
        hI = Hn,
        fI = Dn(eI),
        bI = Bn(On),
        vI = (e) => [tv, ss('columns'), e],
        ...
        TI = Dn(_I),
        EI = Hn,
        AI = (e) => [tv, nv, e, ks('align', 'start', ['start', 'center', 'end'])],
        MI = [sv, iv],
        DI = [
            sv,
            ds(
        ...
        ZI = KI.concat([
            ds(
                'children',
                Zn(0, () => jn('type', { directory: QI, leaf: JI }))
            )
        ]),
        QI = Dn(ZI),
        eR = jn('type', { directory: QI, leaf: JI }),
        ...
        aR = (e) =>
            Qn(
                ...
                Bn(
                    Gn((t) =>
                        qn(`Checking item of ${e}`, iR, t).fold(
                            (e) => sn.error(Kn(e)),
                            (e) => sn.value(e)
                        )
                    )
        ...
        hR = Dn([
            rs('title'),
            ns('body', jn('type', { panel: cR, tabpanel: mR })),
            Ss('size', 'normal'),
            _s('buttons', [], pR),
            ys('initialData', {}),
            Os('onAction', b),
        ...
        fR = Dn([as('type', ['cancel', 'custom']), ...gR]),
        bR = Dn([
            rs('title'),
            rs('url'),
            gs('height'),
        ...
        vR = (e) => (a(e) ? [e].concat(X(fe(e), vR)) : l(e) ? X(e, vR) : []),
        yR = (e) => r(e.type) && r(e.name),
        xR = {
            checkbox: nI,
            colorinput: cI,
            colorpicker: uI,
        ...
        wR = (e) => {
            const t = ((e) => U(vR(e), yR))(e),
                o = X(t, (e) =>
                    ((e) => A.from(xR[e.type]))(e).fold(
                        () => [],
                        (t) => [ns(e.name, t)]
                    )
                );
        ...
        kR = {
            ...
            openUrl: (e, t) => e(Xn(qn('dialog', bR, t))),
            redial: (e) => SR(e)
        };
    var CR = Object.freeze({
        ...
        OR = Object.freeze({ __proto__: null, getState: (e, t, o) => o }),
    ...
    const TR = Ol({
        ...
        AR = (e, t, o) => {
            const n = jh(
                CC.sketch((n) => ({
                    ...
                    components: H(e.items, (e) => X_(n, e, t, o))
                }))
            );
            return {
                ...
                behaviours: kl([
                    Pp.config({ mode: 'acyclic', useTabstopAt: C(XC) }),
                    ((s = n), wm.config({ find: s.getOpt })),
                    IC(n, { postprocess: (e) => ER(e).fold((e) => (console.error(e), {}), w) }),
                    Jp('dialog-body-panel', [
                        Ur(Xs(), (e, t) => {
                            e.getSystem().broadcastOn([eO], { newFocus: A.some(t.event.target) });
                        })
                    ])
                ])
            };
        ...
        MR = fm({
            ...
            configFields: [
                ...
                Qn(
                    'dom',
                    'dom',
                    xn(() => ({ attributes: { role: 'tab', id: la('aria'), 'aria-selected': 'false' } })),
                    Nn()
                ),
                us('action'),
                ys('domModification', {}),
                hu('tabButtonBehaviours', [oh, Pp, pu]),
                os('view')
            ],
            factory: (e, t) => ({
                uid: e.uid,
                ...
                components: e.components,
                events: mh(e.action),
                behaviours: bu(e.tabButtonBehaviours, [
                    oh.config({}),
                    Pp.config({ mode: 'execution', useSpace: !0, useEnter: !0 }),
                    pu.config({ store: { mode: 'memory', initialValue: e.value } })
                ]),
                domModification: e.domModification
            })
        ...
        BR = Gu({
            ...
            overrides: (e) => {
                const t = (e, t) => {
                        Gm.dehighlight(e, t), Ir(e, Mr(), { tabbar: e, button: t });
                    },
                    o = (e, t) => {
                        Gm.highlight(e, t), Ir(e, Ar(), { tabbar: e, button: t });
                    };
                return {
                    action: (n) => {
        ...
        IR = bm({
            ...
            factory: (e, t, o, n) => ({
                ...
                behaviours: bu(e.tabbarBehaviours, [
                    Gm.config({
                    ...
                    Pp.config({
                        mode: 'flow',
                        getInitial: (e) => Gm.getHighlighted(e).map((e) => e.element),
            ...
            factory: (e, t, o, n) => {
                ...
                return {
                    ...
                    apis: {
                        ...
                        showTab: (e, t) => {
                            s(e, (e) => {
                                const o = Gm.getCandidates(e);
                                return G(o, (e) => pu.getValue(e) === t).filter((t) => !Gm.isHighlighted(e, t));
                            });
                        }
                    }
                };
        ...
        $R = (e, t, o) => {
                ...
                i = H(e.tabs, (e) => ({
                    ...
                    view: () => [
                        CC.sketch((n) => ({
                            ...
                            formBehaviours: kl([
                                Pp.config({ mode: 'acyclic', useTabstopAt: C(XC) }),
                                Jp('TabView.form.events', [Kr(r), Jr(s)]),
                                Al.config({
                                    channels: Ds([
                                        { key: jR, value: { onReceive: s } },
                                        { key: GR, value: { onReceive: r } }
                                    ])
                                })
                            ])
                        }))
                        ...
                        o = [
                            Kr((o) => {
                                ...
                                WR(n).each((s) => {
                                    Dt(s, 'visibility', 'hidden'),
                                        ...
                                        Ht(s, 'visibility'),
                                        ((e, t) => {
                                            oe(e).each((e) => LR.showTab(t, e.value));
                                        })(e, o),
                                        requestAnimationFrame(() => {
                                            UR(n, s, t);
                                        });
                            ...
                            Ur(kS, (e, o) => {
                                ...
                                WR(n).each((e) => {
                                    ...
                                    const s = Nt(e, 'height').map((e) => parseInt(e, 10));
            ...
            return LR.sketch({
                ...
                onChangeTab: (e, t, o) => {
                    const n = pu.getValue(t);
                    Ir(e, SS, { name: n, oldName: a.get() }), a.set(n);
                },
                tabs: i,
                components: [
                    LR.parts.tabbar({
                    ...
                    LR.parts.tabview({ dom: { tag: 'div', classes: ['tox-dialog__body-content'] } })
                ],
                selectFirst: l.selectFirst,
                tabSectionBehaviours: kl([
                    Jp('tabpanel', l.extraEvents),
                    Pp.config({ mode: 'acyclic' }),
                    wm.config({ find: (e) => oe(LR.getViewItems(e)) }),
                    RC(
                        A.none(),
                        (e) => (e.getSystem().broadcastOn([jR], {}), n.get()),
                        (e, t) => {
    ...
    var ON = sN([
        ...
        GN = (function e() {
            ...
            var D,
                ...
                Se = function (e) {
                    (ye && ye === e) ||
                        ((e && 'object' === XR(e)) || (e = {}),
                        (e = kN(e)),
                        (L = 'ALLOWED_TAGS' in e ? SN({}, e.ALLOWED_TAGS) : P),
                        (U = 'ALLOWED_ATTR' in e ? SN({}, e.ALLOWED_ATTR) : W),
                        (ue = 'ADD_URI_SAFE_ATTR' in e ? SN(kN(me), e.ADD_URI_SAFE_ATTR) : me),
                        (ce = 'ADD_DATA_URI_TAGS' in e ? SN(kN(de), e.ADD_DATA_URI_TAGS) : de),
                        (ie = 'FORBID_CONTENTS' in e ? SN({}, e.FORBID_CONTENTS) : le),
                        (G = 'FORBID_TAGS' in e ? SN({}, e.FORBID_TAGS) : {}),
                        ($ = 'FORBID_ATTR' in e ? SN({}, e.FORBID_ATTR) : {}),
                        ...
                        e.CUSTOM_ELEMENT_HANDLING &&
                            ...
                            (j.allowCustomizedBuiltInElements = e.CUSTOM_ELEMENT_HANDLING.allowCustomizedBuiltInElements),
                        (D = D = -1 === ve.indexOf(e.PARSER_MEDIA_TYPE) ? 'text/html' : e.PARSER_MEDIA_TYPE),
                        (B =
                        ...
                        ae &&
                            ((L = SN({}, JR(DN))),
                            (U = []),
                            !0 === ae.html && (SN(L, ON), SN(U, BN)),
                            !0 === ae.svg && (SN(L, _N), SN(U, FN), SN(U, RN)),
                            !0 === ae.svgFilters && (SN(L, TN), SN(U, FN), SN(U, RN)),
                            !0 === ae.mathMl && (SN(L, AN), SN(U, IN), SN(U, RN))),
                        e.ADD_TAGS && (L === P && (L = kN(L)), SN(L, e.ADD_TAGS)),
                        e.ADD_ATTR && (U === W && (U = kN(U)), SN(U, e.ADD_ATTR)),
                        e.ADD_URI_SAFE_ATTR && SN(ue, e.ADD_URI_SAFE_ATTR),
                        e.FORBID_CONTENTS && (ie === le && (ie = kN(ie)), SN(ie, e.FORBID_CONTENTS)),
                        se && (L['#text'] = !0),
                        J && SN(L, ['html', 'head', 'body']),
                        L.table && (SN(L, ['tbody']), delete G.tbody),
                        sN && sN(e),
                        (ye = e));
                },
            ...
            var Ee = function (e) {
                ...
                Ae = function (e, t) {
                    try {
                        gN(o.removed, { attribute: t.getAttributeNode(e), from: t });
                    } catch (e) {
                        gN(o.removed, { attribute: null, from: t });
                    }
                ...
                Me = function (e) {
                    ...
                    return (
                        e && o && a.insertBefore(s.createTextNode(o), a.childNodes[0] || null),
                        fe === he ? T.call(t, J ? 'html' : 'body')[0] : J ? t.documentElement : a
                    );
                },
                De = function (e) {
                ...
                Be = function (e) {
                    return 'object' === XR(i)
                        ? e instanceof i
                        : e && 'object' === XR(e) && 'number' == typeof e.nodeType && 'string' == typeof e.nodeName;
                },
                Fe = function (e, t, n) {
                    M[e] &&
                        uN(M[e], function (e) {
                ...
                Ie = function (e) {
                    var t, n;
                    if (
                        (Fe('beforeSanitizeElements', e, null),
                        (n = e) instanceof m &&
                    ...
                    var s = B(e.nodeName);
                    if (
                        (Fe('uponSanitizeElement', e, { tagName: s, allowedTags: L }),
                        e.hasChildNodes() &&
                            !Be(e.firstElementChild) &&
                            (!Be(e.content) || !Be(e.content.firstElementChild)) &&
                            yN(/<[/\w]/g, e.innerHTML) &&
                            yN(/<[/\w]/g, e.textContent))
                    )
                        return Ee(e), !0;
                        ...
                        !(function (e) {
                            ...
                            return e.namespaceURI === pe
                                ...
                                ? t.namespaceURI === he
                                    ...
                                    : Boolean(Te[o])
                                : e.namespaceURI === he &&
                                  !(t.namespaceURI === pe && !Ce[n]) &&
                                  !(t.namespaceURI === ge && !ke[n]) &&
                                  !Te[o] &&
                                  (Oe[o] || !_e[o]);
                        })(e)
                        ? (Ee(e), !0)
                        : ('noscript' !== s && 'noembed' !== s) || !yN(/<\/no(script|embed)/i, e.innerHTML)
                        ? (K &&
                              3 === e.nodeType &&
                              ((t = e.textContent),
                              (t = fN(t, F, ' ')),
                              (t = fN(t, I, ' ')),
                              e.textContent !== t && (gN(o.removed, { element: e.cloneNode() }), (e.textContent = t))),
                ...
                Re = function (e, t, o) {
                    ...
                    if (X && !$[t] && yN(R, t));
                        ...
                        if (
                            !(
                                (Ne(e) &&
                                    ((j.tagNameCheck instanceof RegExp && yN(j.tagNameCheck, e)) ||
                                        (j.tagNameCheck instanceof Function && j.tagNameCheck(e))) &&
                                    ((j.attributeNameCheck instanceof RegExp && yN(j.attributeNameCheck, t)) ||
                                        (j.attributeNameCheck instanceof Function && j.attributeNameCheck(t)))) ||
                                ('is' === t &&
                                    j.allowCustomizedBuiltInElements &&
                                    ((j.tagNameCheck instanceof RegExp && yN(j.tagNameCheck, o)) ||
                    ...
                    else if (('src' !== t && 'xlink:href' !== t && 'href' !== t) || 'script' === e || 0 !== bN(o, 'data:') || !ce[e])
                        if (Y && !yN(V, fN(o, z, '')));
                        else if (o) return !1;
                    return !0;
                },
                ...
                ze = function e(t) {
                    var o,
                        n = De(t);
                    for (Fe('beforeSanitizeShadowDOM', t, null); (o = n.nextNode()); )
                        Fe('uponSanitizeShadowNode', o, null), Ie(o) || (o.content instanceof r && e(o.content), Ve(o));
                    Fe('afterSanitizeShadowDOM', t, null);
                };
            return (
                (o.sanitize = function (e, s) {
                    var a, l, c, d, u;
                    ...
                    if ((Z || Se(s), (o.removed = []), 'string' == typeof e && (re = !1), re)) {
                        ...
                        (1 === (l = (a = Me('\x3c!----\x3e')).ownerDocument.importNode(e, !0)).nodeType && 'BODY' === l.nodeName) ||
                        'HTML' === l.nodeName
                            ? (a = l)
                            : a.appendChild(l);
                    else {
                    ...
                    a && Q && Ee(a.firstChild);
                    for (var g = De(re ? e : a); (c = g.nextNode()); )
                        (3 === c.nodeType && c === d) || Ie(c) || (c.content instanceof r && ze(c.content), Ve(c), (d = c));
                    ...
                    return (
                        J &&
                            ...
                            yN(WN, a.ownerDocument.doctype.name) &&
    ...
    const $N = (e) => GN().sanitize(e),
        qN = lf.deviceType.isTouch(),
        XN = (e, t) => ({ dom: { tag: 'div', styles: { display: 'none' }, classes: ['tox-dialog__header'] }, components: [e, t] }),
        YN = (e, t) =>
            LF.parts.close(
                Wh.sketch({
                    dom: {
        ...
        KN = () => LF.parts.title({ dom: { tag: 'div', classes: ['tox-dialog__title'], innerHtml: '', styles: { display: 'none' } } }),
        JN = (e, t) =>
            LF.parts.body({
                dom: { tag: 'div', classes: ['tox-dialog__body'] },
                components: [
                    {
                        ...
                        components: [{ dom: _A(`<p>${$N(t.translate(e))}</p>`) }]
                    }
                ]
            }),
        ZN = (e) => LF.parts.footer({ dom: { tag: 'div', classes: ['tox-dialog__footer'] }, components: e }),
        QN = (e, t) => [
            oS.sketch({ dom: { tag: 'div', classes: ['tox-dialog__footer-start'] }, components: e }),
            oS.sketch({ dom: { tag: 'div', classes: ['tox-dialog__footer-end'] }, components: t })
        ],
        eV = (e) => {
            const t = 'tox-dialog',
                o = t + '-wrap',
            ...
            return LF.sketch({
                ...
                parts: {
                    blocker: {
                        dom: _A(`<div class="${o}"></div>`),
                        components: [{ dom: { tag: 'div', classes: qN ? [n, n + '--opaque'] : [n] } }]
                    }
                },
                dragBlockClass: o,
                modalBehaviours: kl([
                    ...
                    Jp(
                        ...
                        e.dialogEvents.concat([
                            ...
                            Ur(_r(), (e, t) => {
                                e.getSystem().broadcastOn([eO], { newFocus: t.event.newFocus });
                            })
                        ])
                    ),
                    Jp('scroll-lock', [
                ...
                eventOrder: {
                    [ur()]: ['dialog-events'],
                    [Sr()]: ['scroll-lock', 'dialog-events', 'alloy.base.behaviour'],
        ...
        tV = (e) =>
            Wh.sketch({
                ...
                buttonBehaviours: kl([cS.config({})]),
                components: [ef('close', { tag: 'span', classes: ['tox-icon'] }, e.icons)],
                action: (e) => {
                    Fr(e, bS);
                }
            }),
        oV = (e, t, o, n) => ({
            ...
            components: [],
            behaviours: kl([TR.config({ channel: `${KC}-${t}`, initialData: e, renderComponents: (e) => [ti(n.translate(e.title))] })])
        }),
        nV = () => ({ dom: _A('<div class="tox-dialog__draghandle"></div>') }),
        sV = (e, t, o) =>
            ((e, t, o) => {
                const n = LF.parts.title(oV(e, t, A.none(), o)),
                    s = LF.parts.draghandle(nV()),
                    r = LF.parts.close(tV(o)),
                    a = [n].concat(e.draggable ? [s] : []).concat([r]);
                return oS.sketch({ dom: _A('<div class="tox-dialog__header"></div>'), components: a });
        ...
        aV = (e, t, o) => ({
            ...
            onBlock: (o) => {
                const n = pi(e().element, '.tox-dialog__header').map((e) => Wt(e));
                LF.setBusy(e(), (e, s) => rV(o.message, s, t, n));
            },
            onUnblock: () => {
                LF.setIdle(e());
            }
        ...
        iV = (e, t, o, n) =>
            ri(
                eV({
                    ...
                    extraBehaviours: [
                        TR.config({ channel: `${YC}-${e.id}`, updateState: (e, t) => A.some(t), initialData: t }),
                        VC({}),
                        ...e.extraBehaviours
                    ],
                    onEscape: (e) => {
                    ...
                    eventOrder: {
                        [dr()]: [TR.name(), Al.name()],
                        [Sr()]: ['scroll-lock', TR.name(), 'messages', 'dialog-events', 'alloy.base.behaviour'],
                        [kr()]: ['alloy.base.behaviour', 'dialog-events', 'messages', TR.name(), 'scroll-lock']
                    }
                })
            ),
        lV = (e, t = {}) =>
            H(e, (e) =>
                'menu' === e.type
                    ? ((e) => {
                          const o = H(e.items, (e) => {
                              const o = be(t, e.name).getOr(Es(!1));
                              return { ...e, storage: o };
                          });
                          return { ...e, items: o };
                      })(e)
        ...
        cV = (e) => j(e, (e, t) => ('menu' === t.type ? j(t.items, (e, t) => ((e[t.name] = t.storage), e), e) : e), {}),
        dV = (e, t) => [
            $r(Xs(), qC),
            e(fS, (e, o, n, s) => {
            ...
            Ur(wS, (e, o) => t.onUnblock()),
            Ur(xS, (e, o) => t.onBlock(o.event))
        ],
        uV = (e, t, o) => {
            const n = (t, o) =>
                    Ur(t, (t, n) => {
            ...
            return [
                ...dV(n, t),
                n(yS, (e, t) => t.onSubmit(e)),
                n(hS, (e, t, o) => {
                    t.onChange(e, { name: o.name });
                }),
                n(vS, (e, t, n, s) => {
                    const r = () => (s.getSystem().isConnected() ? Pp.focusIn(s) : void 0),
                        a = (e) => Tt(e, 'disabled') || _t(e, 'aria-disabled').exists((e) => 'true' === e),
                        i = ht(s.element),
                        l = Il(i);
                    t.onAction(e, { name: n.name, value: n.value }),
                        Il(i).fold(r, (e) => {
                            a(e) || l.exists((t) => Qe(e, t) && a(t))
                                ? r()
                                : o()
                                      .toOptional()
                                      .filter((t) => !Qe(t.element, e))
                                      .each(r);
                        });
                }),
                n(SS, (e, t, o) => {
        ...
        mV = (e, t) => {
            const o = t.map((e) => e.footerButtons).getOr([]),
                ...
                s = (e, t) =>
                    oS.sketch({ dom: { tag: 'div', classes: [`tox-dialog__footer-${e}`] }, components: H(t, (e) => e.memento.asSpec()) });
                ...
                TR.config({
                    ...
                    updateState: (e, t) => {
                        const n = H(t.buttons, (e) => {
                            const t = jh(((e, t) => B_(e, e.type, t))(e, o));
        ...
        pV = (e, t, o) => LF.parts.footer(gV(e, t, o)),
        hV = (e, t) => {
            if (e.getRoot().getSystem().isConnected()) {
                const o = wm.getCurrent(e.getFormWrapper()).getOr(e.getFormWrapper());
                return CC.getField(o, t).orThunk(() => {
                    const o = e.getFooter().bind((e) => TR.getState(e).get());
            ...
            const n = (t) => {
                ...
                s = {
                    getData: () => {
                        ...
                        return { ...pu.getValue(n), ...ce(o, (e) => e.get()) };
                    },
                    setData: (t) => {
                        n((n) => {
                            const r = s.getData(),
                                ...
                                i = ((e, t) => {
                                    const o = e.getRoot();
                                    return TR.getState(o)
                                        .get()
                                        .map((e) => Xn(qn('data', e.dataValidator, t)))
                                        .getOr(t);
                                })(e, a),
                                l = e.getFormWrapper();
                            pu.setValue(l, i),
                    ...
                    redial: (r) => {
                        n((n) => {
                            ...
                            n.getSystem().broadcastOn([`${YC}-${a}`], i),
                                n.getSystem().broadcastOn([`${KC}-${a}`], i.internalDialog),
                                n.getSystem().broadcastOn([`${JC}-${a}`], i.internalDialog),
                                n.getSystem().broadcastOn([`${ZC}-${a}`], { ...i.internalDialog, buttons: l }),
        ...
        bV = (e, t, o, n = !1) => {
            const s = la('dialog'),
                ...
                c = jh(
                    ((e, t, o, n) =>
                        ...
                        }))({ title: i.title, draggable: !0 }, s, r, o.shared.providers)
                ),
                d = jh(((e, t, o, n, s) => qR(e, t, A.some(o), n, s))({ body: i.body, initialData: i.initialData }, s, a, o, n)),
                u = lV(i.buttons),
                m = cV(u),
                g = Ce(0 !== u.length, jh(((e, t, o) => gV(e, t, o))({ buttons: u }, s, o))),
                p = uV(
                    () => b,
                    {
                        onBlock: (e) => {
                            OA.block(f, (t, n) => {
                                const s = c.getOpt(f).map((e) => Wt(e.element));
                ...
                h = 'tox-dialog-inline',
                f = ri({
                    dom: { tag: 'div', classes: ['tox-dialog', h, ...l.toArray()], attributes: { role: 'dialog', 'aria-labelledby': r } },
                    eventOrder: { [dr()]: [TR.name(), Al.name()], [ur()]: ['execute-on-form'], [Sr()]: ['reflecting', 'execute-on-form'] },
                    behaviours: kl([
                        Pp.config({
                            mode: 'cyclic',
                            onEscape: (e) => (Fr(e, fS), A.some(!0)),
                            useTabstopAt: (e) => !XC(e) && ('button' !== Ue(e) || 'disabled' !== Ot(e, 'disabled')),
                            firstTabstop: 1
                        }),
                        TR.config({ channel: `${YC}-${s}`, updateState: (e, t) => A.some(t), initialData: e }),
                        oh.config({}),
                        Jp(
                            'execute-on-form',
                            p.concat([
                        ...
                        OA.config({ getRoot: () => A.some(f) }),
                        Kp.config({}),
                        VC({})
                    ]),
                    components: [c.asSpec(), d.asSpec(), ...g.map((e) => e.asSpec()).toArray()]
                }),
                b = fV(
                    {
                        getId: x(s),
                        getRoot: x(f),
                        getFooter: () => g.map((e) => e.get(f)),
                        getBody: () => d.get(f),
                        getFormWrapper: () => {
                            const e = d.get(f);
            ...
            return { dialog: f, instanceApi: b };
        };
    var vV = tinymce.util.Tools.resolve('tinymce.util.URI');
    const yV = ['insertContent', 'setContent', 'execCommand', 'close', 'block', 'unblock'],
        xV = (e) => a(e) && -1 !== yV.indexOf(e.mceAction),
        wV = (e, t, o, n) => {
            const s = la('dialog'),
                i = sV(e.title, s, n),
                l = ((e) => {
                    const t = {
                        ...
                        behaviours: kl([Pp.config({ mode: 'acyclic', useTabstopAt: C(XC) })])
                    };
                    return LF.parts.body(t);
                })(e),
                c = e.buttons.bind((e) => (0 === e.length ? A.none() : A.some(pV({ buttons: e }, s, n)))),
                u = ((e, t) => {
                    const o = (e, t) =>
                            Ur(e, (e, o) => {
                                n(e, (n, s) => {
                ...
                h = new vV(e.url, { base_uri: new vV(window.location.href) }),
                            ...
                            const t = tc(Ve(window), 'message', (t) => {
                                if (h.isSameOrigin(new vV(t.raw.origin))) {
                                    ...
                                    xV(n)
                                        ...
                                        : ((e) => !xV(e) && a(e) && ve(e, 'mceAction'))(n) && e.onMessage(x, n);
                                }
                            });
                            b.set(t);
                        }),
                ...
                y = iV({ id: s, header: i, body: l, footer: c, extraClasses: p, extraBehaviours: v, extraStyles: m }, e, u, n),
                x = ((e) => {
                    const t = (t) => {
        ...
        SV = (e, t) => Xn(qn('data', t, e)),
        kV = (e) => $w(e, '.tox-alert-dialog') || $w(e, '.tox-confirm-dialog'),
        CV = (e, t, o) =>
            t && o
                ? []
                : [
                      $E.config({
                          ...
                          lazyViewport: (t) =>
                              jw(e, t.element)
                                  ...
                                  .getOrThunk(() => ({ bounds: en(), optScrollEnv: A.none() }))
                      })
                  ],
        OV = (e) => {
            const t = e.editor,
                            ...
                            const s = (e) => {
                                ...
                                c = ri(
                                    eV({
                                        ...
                                        extraBehaviours: [],
                                        extraStyles: {},
                                        dialogEvents: [Ur(bS, () => s(!1)), Ur(yS, () => s(!0))],
                                        eventOrder: {}
                                    })
                                );
                            LF.show(c);
                        ...
                        const r = n,
                            a = ((e, t, o) => {
                                const n = la('dialog'),
                                    ...
                                    r = sV(s.title, n, o),
                                    a = ((e, t, o) => {
                                        const n = qR(e, t, A.none(), o, !1);
                                        return LF.parts.body(n);
                                    })({ body: s.body, initialData: s.initialData }, n, o),
                                    i = lV(s.buttons),
                                    l = cV(i),
                                    c = Ce(0 !== i.length, pV({ buttons: i }, n, o)),
                                    d = uV(
                                        () => p,
                                        aV(() => m, o.shared.providers, t),
                                        o.shared.getSink
                                    ),
                                    u = ((e) => {
                                        switch (e) {
                                    ...
                                    m = iV(
                                        { id: n, header: r, body: a, footer: c, extraClasses: u, extraBehaviours: [], extraStyles: {} },
                                        e,
                                        d,
                                        o
                                    ),
                                    g = {
                                        getId: x(n),
                                        getRoot: x(m),
                                        getBody: () => LF.getBody(m),
                                        getFooter: () => LF.getFooter(m),
                                        getFormWrapper: () => {
                                            const e = LF.getBody(m);
                                            return wm.getCurrent(e).getOr(e);
                                        },
                                        toggleFullscreen: () => {
                                            const e = 'tox-dialog--fullscreen',
                        ...
                        const c = SV(i, l),
                            ...
                            p = ri(
                                Ph.sketch({
                                    ...
                                    inlineBehaviours: kl([
                                        Jp('window-manager-inline-events', [
                                            Ur(Cr(), (e, t) => {
                                                Fr(g.dialog, bS);
                                            })
                                        ]),
                                    ...
                                    isExtraPart: (e, t) => kV(t)
                                })
                            );
                        return (
                            d.set(p),
                            Ph.showWithinBounds(p, ai(g.dialog), { anchor: s }, () => {
                                const e = t.inline ? xt() : Ve(t.getContainer()),
                                    o = Jo(e);
                                return A.some(o);
                            }),
                            (o && u) || ($E.refresh(p), t.on('ResizeEditor', m)),
                ...
                i = (o, n, s, r) =>
                    kR.open((o, a, i) => {
                            ...
                            g = ri(
                                Ph.sketch({
                                    ...
                                    inlineBehaviours: kl([
                                        ...
                                        $E.config({
                                            contextual: {
                                                lazyContext: () => A.some(Jo(Ve(t.getContentAreaContainer()))),
                                                fadeInClass: 'tox-dialog-dock-fadein',
                                                fadeOutClass: 'tox-dialog-dock-fadeout',
                                                transitionClass: 'tox-dialog-dock-transition'
                                            },
                        ...
                        return (
                            c.set(g),
                            Ph.showWithinBounds(g, ai(m.dialog), { anchor: n }, () =>
                                e.backstages.popup.shared
                                    .getSink()
                                    .toOptional()
                                    .bind((e) => {
                                        const o = jw(t, e.element)
                                                .map((e) => Gw(e))
                                                .getOr(en()),
                            ...
                            $E.refresh(g),
                            t.on('ResizeEditor ScrollWindow ElementScroll', u),
    ...
    tn.add('silver', (e) => {
            ...
            uf(e),
                ((e) => {
                    const t = e.options.register,
                        o = (e) => (f(e, r) ? { value: Bx(e), valid: !0 } : { valid: !1, message: 'Must be an array of strings.' }),
                    ...
                    t('color_map', {
                        ...
                        t('color_cols', { processor: n, default: Nx(e) }),
                        t('color_cols_foreground', { processor: n, default: Vx(e, Mx) }),
                        t('color_cols_background', { processor: n, default: Vx(e, Dx) }),
                        t('custom_colors', { processor: 'boolean', default: !0 }),
                        t('color_default_foreground', { processor: 'string', default: Ix }),
                        t('color_default_background', { processor: 'string', default: Ix });
                })(e),
                ((e) => {
                    const t = e.options.register;
        ...
        let t = () => en();
        const { dialogs: o, popups: n, renderUI: s } = NF(e, { getPopupSinkBounds: () => t() });
        Lw(e, n.backstage.shared);
        const a = OV({ editor: e, backstages: { popup: n.backstage, dialog: o.backstage } });
        return {
            renderUI: async () => {
                const o = await s();
                return (
                    jw(e, n.getMothership().element).each((e) => {
                        t = () => Gw(e);
                    }),
                    o
                );
                                        ...
                                        I(r, c).each((e) => {
                                            const n = r[e - 1].getEl(),
                                                a = {
                                                    ...
                                                    node: A.some(Ve(n)),
                                                    overrides: o,
                                                    layouts: { onRtl: () => [cl], onLtr: () => [cl] }
                                                };
                                            Ph.showWithinBounds(l, t, { anchor: a }, s);
                                        });
                                },
                                text: (e) => {
                                    of.updateText(i, e);
