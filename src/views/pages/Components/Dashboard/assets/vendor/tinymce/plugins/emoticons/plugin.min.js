...
!(function () {
    ...
    const f = (t) => (e) => e.options.get(t),
        ...
        E = (t, e) =>
            ...
            ((t, o) => {
                for (let o = 0, s = t.length; o < s; o++) if (((n = t[o]), v(n.toLowerCase(), e))) return !0;
                var n;
                return !1;
            })(t.keywords),
        S = (t, e, o) => {
            ...
            for (
                let o = 0;
                o < t.length &&
                ((0 !== e.length && !E(t[o], s)) || (n.push({ value: t[o].char, text: t[o].title, icon: t[o].char }), !a(n.length)));
                o++
            );
            return n;
        },
        ...
        N = (t, e) => {
            const n = { pattern: '', results: S(e.listAll(), '', a.some(300)) },
                ...
                g = () => ({
                    title: 'Emojis',
                    size: 'normal',
                    body: { type: 'tabpanel', tabs: i(e.listCategories(), (t) => ({ title: t, name: t, items: [c, u] })) },
                    initialData: n,
                    onTabChange: (t, e) => {
    ...
    t.add('emoticons', (t, e) => {
        ((t, e) => {
            ...
            o('emoticons_database', { processor: 'string', default: 'emojis' }),
                o('emoticons_database_url', { processor: 'string', default: `${e}/js/${b(t)}${t.suffix}.js` }),
                    ...
                    (e) => {
                        ...
                        ((t) => {
                            const e = {},
                                o = [];
                            g(t, (t, n) => {
                                const s = { title: n, keywords: t.keywords, char: i(t), category: O(A, t.category) },
        ...
        ((t, e) => {
            ...
            ((t) => {
                ...
                t.ui.registry.addButton('emoticons', { tooltip: 'Emojis', icon: 'emoji', onAction: e, onSetup: T(t) }),
                    t.ui.registry.addMenuItem('emoticons', { text: 'Emojis...', icon: 'emoji', onAction: e, onSetup: T(t) });
            })(t),
            ((t, e) => {
