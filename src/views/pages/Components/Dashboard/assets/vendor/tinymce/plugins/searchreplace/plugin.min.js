...
!(function () {
    ...
    const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
        ...
        W = (e, t, n, o, r) => {
            ...
            if (
                ((e, t) =>
                    ...
                    R(e, t) ||
                    M(e, t) ||
                    ((e, t) => 'true' === e.getContentEditable(t) && t.parentNode && 'false' === e.getContentEditableParent(t.parentNode))(
                        e,
                        t
                    ))(e, n)
            )
                return;
            const a = null !== (s = e.getParent(o, e.isBlock)) && void 0 !== s ? s : e.getRoot(),
                l = new F(n, a),
            ...
            P(e, i, n, {
                ...
                cef: d,
                text: (e) => {
                    r ? (t.fOffset += e.length) : (t.sOffset += e.length), t.elements.push(T(e));
                }
            });
        },
        $ = (e, t, n, o, r, s = !0) => {
                    ...
                    cef: (t) => {
                        return ((e, t) => {
                            ...
                            return (
                                n.sort((e, t) =>
                                    ((e, t) =>
                                        ((e, t, n) => 0 != (e.compareDocumentPosition(t) & n))(e, t, Node.DOCUMENT_POSITION_PRECEDING))(
                                        e.elements[0].dom,
                                        t.elements[0].dom
                                    )
                                        ? 1
                            ...
                            v(
                                ...
                                ((e, t) => {
                                    ...
                                    return (1 !== (o = n).nodeType && 9 !== o.nodeType && 11 !== o.nodeType) || 0 === o.childElementCount
                                        ? []
                        ...
                        const o = B(n),
                            ...
                            a = v(t, (e, t) =>
                                e.start < s && e.finish > r
                                    ? [{ element: n, start: Math.max(r, e.start) - r, finish: Math.min(s, e.finish) - r, matchId: t }]
                                    : []
                            );
        ...
        J = (e, t, n) => {
            ...
            let r = o.index;
            const s = e.dom;
            n ? (r + 1 === o.count ? (r = 0) : r++) : r - 1 == -1 ? (r = o.count - 1) : r--,
        ...
        Q = (e, t, n, o, r, s) => {
            ...
            if ((g.browser.isSafari() && a.setRng(a.getRng(), i), d)) {
                const a = J(e, t, !0);
                t.set({ index: a, count: d, text: n, matchCase: o, wholeWord: r, inSelection: s });
            }
            return d;
        },
        X = (e, t) => {
        ...
        ee = (e, t, n, o, r) => {
            ...
            return t.set({ ...s, count: r ? 0 : s.count - 1, index: i }), o ? X(e, t) : Y(e, t), !r && t.get().count > 0;
        },
        te = (e, t, n) => {
            let o, r;
            const s = t.get(),
            ...
            for (let e = 0; e < a.length; e++) {
                const t = q(a[e]);
                null !== t && t.length && (t === s.index.toString() && (o || (o = a[e].firstChild), (r = a[e].firstChild)), K(a[e]));
            }
            if ((t.set({ ...s, index: -1, count: 0, text: '' }), o && r)) {
                const t = e.dom.createRng();
                return t.setStart(o, 0), t.setEnd(r, r.data.length), !1 !== n && e.selection.setRng(t), t;
            }
        },
        ne = (t, n) => {
            const o = (() => {
            ...
            const r = f.trim(t.selection.getContent({ format: 'text' })),
                s = (e) => {
                    e.setEnabled('next', ((e, t) => t.get().count > 1)(0, n)), e.setEnabled('prev', ((e, t) => t.get().count > 1)(0, n));
                },
                a = (e, t) => {
                ...
                u = (e) => {
                    ...
                    if (o.findtext.length) {
                        if (r.text === o.findtext && r.matchCase === o.matchcase && r.wholeWord === o.wholewords) X(t, n);
                        else {
                            const r = Q(t, n, o.findtext, o.matchcase, o.wholewords, o.inselection);
                            r <= 0 && l(!0, e), a(e, 0 === r);
                        }
                        s(e);
                    } else d(e);
                ...
                m = n.get(),
                p = { findtext: r, replacetext: '', wholewords: m.wholeWord, matchcase: m.matchCase, inselection: m.inSelection },
                x = (e) => {
                    const t = [
                        {
                            type: 'bar',
                    ...
                    return (
                        e && t.push({ type: 'alertbanner', level: 'error', text: 'Could not find the specified string.', icon: 'warning' }),
                        t
                    );
                },
                y = (e, o) => ({
                            ...
                            case 'inselection':
                                l(!1, e),
                                    ((e) => {
                                        const t = e.getData(),
                                            o = n.get();
                                        n.set({ ...o, matchCase: t.matchcase, wholeWord: t.wholewords, inSelection: t.inselection });
                                    })(e),
                                    d(e);
                        }
                        c(e, o.name);
        ...
        return (
            ...
            ((e, t) => {
                e.ui.registry.addMenuItem('searchreplace', {
                    ...
                    e.ui.registry.addButton('searchreplace', { tooltip: 'Find and replace', onAction: oe(e, t), icon: 'search' }),
