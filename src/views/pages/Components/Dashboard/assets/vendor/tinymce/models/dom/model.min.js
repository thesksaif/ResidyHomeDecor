...
!(function () {
    ...
    const S = Array.prototype.slice,
        ...
        Se = (e) => (1 !== e.nodeType && 9 !== e.nodeType && 11 !== e.nodeType) || 0 === e.childElementCount,
        Te = (e, t) => {
    ...
    const ft = (e, t, o) => {
        ...
        Ht = g(10),
        $t = (e, t) => Vt(e, t, x),
        Vt = (e, t, o) => j(Le(e), (e) => (Ce(e, t) ? (o(e) ? [e] : []) : Vt(e, t, o))),
        qt = (e, t) =>
            ((e, t, o = y) => (o(t) ? C.none() : D(e, ne(t)) ? C.some(t) : ht(t, e.join(','), (e) => Ce(e, 'table') || o(e))))(
                ['td', 'th'],
                e,
                t
            ),
        Ut = (e) => $t(e, 'th,td'),
        Gt = (e) => (Ce(e, 'colgroup') ? mt(e, 'col') : j(Jt(e), (e) => mt(e, 'col'))),
        Kt = (e, t) => bt(e, 'table', t),
        Yt = (e) => $t(e, 'tr'),
        ...
        ao = [
            ...
            { name: 'Opera', versionRegexes: [so, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: lo('opera') },
            { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: lo('firefox') },
            {
                name: 'Safari',
        ...
        co = [
            { name: 'Windows', search: lo('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
            {
                name: 'iOS',
            ...
            { name: 'Android', search: lo('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
            { name: 'macOS', search: lo('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
            ...
            { name: 'ChromeOS', search: lo('cros'), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] }
        ],
        ...
        ko = Do,
        Eo = (g(vo), g('iOS'), g(yo), g(xo), g(Co), g(So), g(To), g(Ro), (e) => window.matchMedia(e).matches);
    let No = eo(() =>
        ((e, t, o) => {
            const n = io.browsers(),
                r = io.oses(),
                    ...
                    .bind((e) =>
                        ((e, t) =>
                            V(t.brands, (t) => {
                                ...
                                }).map((e) => ({ current: e.name, version: no.nu(parseInt(t.version, 10), 0) }));
                            }))(n, e)
                    )
                    .orThunk(() =>
                        ((e, t) =>
    ...
    const Bo = () => No(),
        ...
        zn = un({ delta: h, edge: Rn, positions: (e) => Bn(Dn, On, e) }, { delta: (e) => -e, edge: Tn, positions: (e) => Bn(On, Dn, e) }),
        An = { delta: (e, t) => zn(t).delta(e, t), positions: (e, t) => zn(t).positions(e, t), edge: (e) => zn(e).edge(e) },
        Ln = {
            unsupportedLength: [
                'em',
                'ex',
        ...
        nr = (e, t, o, n) => {
            const r = cn(e),
                ...
                l = [C.some(An.edge(t))].concat(E(An.positions(r, t), (e) => e.map((e) => e.x))),
                a = b(jt);
            return E(s, (e, t) =>
                or(
                    e,
        ...
        lr = (e, t, o, n, r) => {
            const s = dn(e),
                l = [C.some(o.edge(t))].concat(E(o.positions(s, t), (e) => e.map((e) => e.y)));
        ...
        _r = (e) => ({ col: Dr(e), colgroup: Or(e), row: kr(e), cell: Rr(e), replace: Nr, colGap: Dr(e), gap: Rr(e) }),
        ...
        Kr = (e) => {
            ...
            return t.isSet('table_default_attributes')
                ? o
                : ((e, t) => (Vr(e) || Ur(e) ? t : $r(e) ? { ...t, width: Lr(e) } : { ...t, width: Ar }))(e, o);
        },
        Yr = zr('table_use_colgroups'),
        Jr = (e) => bt(e, '[contenteditable]'),
        Qr = (e, t = !1) => (lt(e) ? e.dom.isContentEditable : Jr(e).fold(g(t), (e) => 'true' === Xr(e))),
    ...
    var gs = [
        ...
        hs = () => ({
            ...
            insert: g({ before: Me, after: je, afterAll: He, append: Ie, appendAll: $e, prepend: Pe, wrap: Fe }),
            remove: g({ unwrap: Ue, remove: qe }),
            create: g({ nu: xe.fromTag, clone: (e) => xe.fromDom(e.dom.cloneNode(!1)), text: xe.fromText }),
            query: g({ comparePosition: (e, t) => e.dom.compareDocumentPosition(t.dom), prevSibling: ze, nextSibling: Ae }),
            property: g({
                children: Le,
                name: ne,
                parent: Ne,
    ...
    const ps = (e, t, o, n) => {
        ...
        bs = hs(),
        vs = (e, t) =>
            ((e, t, o) => (o.length > 0 ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, ps) : C.none()))(bs, (t, o) => e(o), t),
        ys = (e) => ht(e, 'table'),
        xs = (e, t, o) => {
            ...
            return Re(e, t)
                ...
                : ys(e).bind((r) =>
                      ys(t).bind((s) => {
                          if (Re(r, s)) return C.some({ boxes: ds(r, e, t), start: e, finish: t });
                          if (De(r, s)) {
                              const o = it(t, 'td,th', n(r)),
                                  l = o.length > 0 ? o[o.length - 1] : t;
                              return C.some({ boxes: us(r, e, r, t, s), start: e, finish: l });
                          }
                          if (De(s, r)) {
                              const o = it(e, 'td,th', n(s)),
                                  l = o.length > 0 ? o[o.length - 1] : e;
                              return C.some({ boxes: us(s, e, r, t, s), start: e, finish: l });
                          }
                          return ((e, t, o) =>
                              ((e, t, o, n = y) => {
                              ...
                              bt(l, 'table', o).bind((o) => {
                                  ...
                                  return C.some({ boxes: us(o, e, r, t, s), start: i, finish: a });
                              })
                          );
                      })
                  );
        ...
        Ss = (e, t, o) => wt(e, t).bind((t) => wt(e, o).bind((e) => vs(ys, [t, e]).map((o) => ({ first: t, last: e, table: o })))),
        Ts = (e, t, o, n, r) =>
            ((e, t) => L(e, (e) => Ce(e, t)))(e, r).bind((e) =>
                ((e, t, o) =>
                    ...
                    ((e, t) =>
                        ht(e, 'table').bind((o) =>
                            wt(o, t).bind((t) => xs(t, e).bind((e) => e.boxes.map((t) => ({ boxes: t, start: e.start, finish: e.finish }))))
                        ))(e, n)
                )
            ),
        Rs = (e, t) => Cs(e, t),
                                      ...
                                      cs(e, t, o).bind((t) =>
                                          ((e, t) => {
                                              ...
                                              for (let r = t.startRow; r <= t.finishRow; r++)
                                                  for (let s = t.startCol; s <= t.finishCol; s++) o = o && tn(e, r, s).exists(n);
        ...
        Es = (e, t, o) =>
            t.length <= 1 ? C.none() : Ds(e, o.firstSelectedSelector, o.lastSelectedSelector).map((e) => ({ bounds: e, cells: t })),
        ...
        Ls = (e, t, o) => ({ element: o, mergable: Es(t, e, As), unmergable: ks(e), selection: Os(e) }),
        Ws = (e) => (t, o) => {
            const n = ne(t),
                r =
                    'col' === n || 'colgroup' === n
                                ...
                                const t = ((e, t) => {
                                            ...
                                            for (let e = 0; e < l; e++) {
                                                ...
                                                for (let a = 0; a < s; a++)
                                                    e < o.minRow ||
                                                        ...
                                                        a < o.minCol ||
                                                        a > o.maxCol ||
                                                        (tn(t, e, a).filter(n).isNone() ? fr(r, l, e) : (l = !0));
                                            }
                                        })(r, l, a, o);
                                    const m = ((e, t, o, n) => {
                                    ...
                                    return (
                                        ((e, t, o, n) => {
                                            ...
                                            const r = _($t(e, 'tr'), (e) => 0 === e.dom.childElementCount);
                                            N(r, qe),
        ...
        Hs = (e, t, o) =>
            (e.property().isText(t) && 0 === e.property().getText(t).trim().length) || e.property().isComment(t)
                ...
                : C.none(),
        $s = (e, t) => (e.property().isText(t) ? e.property().getText(t).length : e.property().children(t).length),
        Vs = (e, t) => {
                    ...
                    Un(e).bind((e) => {
                        return (
                            ...
                            C.from(Wn.exec(t)).bind((e) => {
                                const t = Number(e[1]),
                                    n = e[2];
                                return ((e, t) => O(t, (t) => O(Ln[t], (t) => e === t)))(n, o) ? C.some({ value: t, unit: n }) : C.none();
                            })
                        );
                        var t, o;
                    }))(e);
        ...
        sl = (e) => {
            const t = 'thead' === e.section,
                o = vt(ll(e.cells), 'th');
            return 'tfoot' === e.section ? { type: 'footer' } : t || o ? { type: 'header', subType: rl(t, o) } : { type: 'body' };
        },
        ll = (e) => {
        ...
        dl = () => ({ transformRow: (e, t) => cl(e, 'thead' === t ? 'tbody' : t), transformCell: al }),
        ul = il,
        fl = ml,
        gl = dl,
        ...
        bl = (e, t) => {
            const o = [],
                ...
                s = (e) => j(e, (e) => E(e.cells, (e) => (pl(e.element, 'span', e.colspan, 1), e.element))),
                l = (t, o) => {
                    const n = ((e, t) => {
                            const o = pt(e, t).getOrThunk(() => {
                                const o = xe.fromTag(t, ke(e).dom);
                                return 'thead' === t ? wl(e, 'caption,colgroup', o) : 'colgroup' === t ? wl(e, 'caption', o) : Ie(e, o), o;
                            });
                            return Ve(o), o;
                        })(e, o),
                        l = ('colgroup' === o ? s : r)(t);
                    ...
                    if (!1 === o[r][s]) {
                        const m = ((e, t, o, n) => {
                            const r = ((e, t) => e[t])(e, t),
                                ...
                                a = s ? 1 : vl(((e, t) => E(e, (e) => Ho(e, t)))(e.slice(t), o), n);
            ...
            return t(i, l)
                .map((t) => {
                    const o = ((e, t) => xl(e, t, !1))(i, a),
                        n = e(o, t, Re, r(a), m),
                        s = Yo(n.grid);
                    return { info: t, grid: Cl(n.grid), cursor: n.cursor, lockedColumns: s };
                })
                .bind((e) => {
                    const t = bl(s, e.grid),
        ...
        Dl = (e, t) => Tl(e, t, x).map((e) => ({ cells: e, generators: t.generators, clipboard: t.clipboard })),
        Ol = (e, t) => Tl(e, t, x),
        kl = (e, t) => Tl(e, t, (e) => !e.isLocked),
        El = (e, t) => P(t, (t) => ((e, t) => Sl(e, t).exists((e) => !e.isLocked))(e, t)),
        Nl = (e, t, o, n) => {
            const r = qo(e).rows;
            let s = !0;
        ...
        zl = { value: Bl, error: _l, fromOption: (e, t) => e.fold(() => _l(t), Bl) },
        ...
        Vl = (e, t, o, n, r) => {
            ...
            return [
                ...
                ((e, t, o, n) => Uo(e, (e) => n(e, o), t))(
                    s[o],
                    (e, o) =>
                        t > 0 && t < s.length && n($o(s[t - 1], o), $o(s[t], o)) ? Ho(s[t], o) : et(r(e.element, n), !0, e.isLocked),
                    n,
                    r
                ),
                ...c
        ...
        Ul = (e, t, o, n) =>
            ((e, t, o, n) => void 0 !== $o(e[t], o) && t > 0 && n($o(e[t - 1], o), $o(e[t], o)))(e, t, o, n) ||
            ((e, t, o) => t > 0 && o($o(e, t - 1), $o(e, t)))(e[t], o, n),
        Gl = (e, t, o, n) => {
            const r = (e) => (((e) => ('row' === e ? Pt(t) : jt(t)))(e) ? `${e}group` : e);
            return e ? (ol(t) ? r(o) : null) : n && ol(t) ? r('row' === o ? 'col' : 'row') : null;
        },
        ...
        Ql = (e, t, o, n, r) => {
            const s = qo(e).rows,
                l = j(t, (e) => Jl(s, e, n)),
                a = E(s, (e) => nl(e.cells)),
                c = ((e, t) => (P(t, h) && nl(e) ? x : (e, o, n) => !('th' === ne(e.element) && t[o])))(l, a),
                i = (
                    (e, t) => (o, n) =>
        ...
        sa = (e) => A(e, (e, t) => (O(e, (e) => e.column === t.column) ? e : e.concat([t])), []).sort((e, t) => e.column - t.column),
        la = ue('col'),
        aa = ue('colgroup'),
        ca = (e) => 'tr' === ne(e) || aa(e),
        ia = (e) => ({ element: e, colspan: Wt(e, 'colspan', 1), rowspan: Wt(e, 'rowspan', 1) }),
        ma = (e) => we(e, 'scope').map((e) => e.substr(0, 3)),
        da = (e, t = ia) => {
            const o = (o) => {
                if (ca(o)) return aa((r = { element: o }).element) ? e.colgroup(r) : e.row(r);
                {
                    const r = o,
        ...
        ba = (e) => {
            const t = ue('br'),
                        ...
                        .bind((o) => {
                            const n = Ae(o)
                                .map(
                                    (e) =>
                                        !!pa(e) ||
                                        (!!((e, t) => D(['br', 'img', 'hr', 'input'], e.property().name(t)))(ha, e) && 'img' !== ne(e))
                                )
                                .getOr(!1);
                            return Ne(o).map((r) => {
                                return !0 === n || 'li' === ne((s = r)) || ft(s, wa).isSome() || t(o) || (pa(r) && !Re(e, r))
                                    ? []
                                    : [xe.fromTag('br')];
                                var s;
                            });
                ...
                n = (() => {
                    const n = j(e, (e) => {
                        const n = Le(e);
                        return ((e) => P(e, (e) => t(e) || (ie(e) && 0 === hr(e).trim().length)))(n) ? [] : n.concat(o(e));
                    });
        ...
        Ca = (e, t, o) => {
            const n = ((e, t, o) => {
                var n, r;
                const s = qo(e).rows;
                return C.from(null === (r = null === (n = s[t]) || void 0 === n ? void 0 : n.cells[o]) || void 0 === r ? void 0 : r.element)
                    .filter(va)
                    .orThunk(() =>
                        ((e) =>
                            V(e, (e) =>
        ...
        Sa = (e) => A(e, (e, t) => (O(e, (e) => e.row === t.row) ? e : e.concat([t])), []).sort((e, t) => e.row - t.row),
        Ta = (e, t) => (o, n, r, s, l) => {
            const a = Sa(n),
                c = E(a, (e) => e.row),
                i = ((e, t, o, n, r, s, l) => {
                    ...
                    const f = [...a, ...u],
                        g = ((e, t) => (P(t, h) && nl(e.cells) ? x : (e, o, n) => !('th' === ne(e.element) && t[n])))(i, d),
                        p = (
                            (e, t) => (o, n, r) =>
        ...
        _a = (e, t) => O(t, (t) => t.column + t.colspan >= e.grid.columns && t.isLocked),
        za = (e, t) => {
            const o = cn(e),
                n = sa(t);
        ...
        ja = Rl(
            (e, t, o, n) => {
                const r = t[0].row,
                    s = Sa(t),
                    l = z(s, (e, t) => ({ grid: Vl(e.grid, r, t.row + e.delta, o, n.getOrInit), delta: e.delta + 1 }), {
                        grid: e,
                        delta: 0
                    }).grid;
        ...
        Ia = Rl(
            (e, t, o, n) => {
                const r = t.details,
                    s = sa(r),
                    l = s[0].column,
                    a = z(s, (e, t) => ({ grid: ql(e.grid, l, t.column + e.delta, o, n.getOrInit), delta: e.delta + 1 }), {
                        grid: e,
                        delta: 0
                    }).grid;
        ...
        Za = Rl(
                    ...
                    const s = Yo(t),
                        ...
                        i = ((e, t, o) => {
                            if (e.row >= t.length || e.column > Vo(t[0]))
                                return zl.error('invalid start address out of table bounds, row: ' + e.row + ', column: ' + e.column);
                            const n = t.slice(e.row),
                                r = n[0].cells.slice(e.column),
                                s = Vo(o[0]),
                                l = o.length;
                            return zl.value({ rowDelta: n.length - l, colDelta: r.length - s });
                        })(l, t, a);
                    return i.map((e) => {
            ...
            (e, t) => qt(t.element).bind((o) => Sl(e, o).map((e) => ({ ...e, generators: t.generators, clipboard: t.clipboard }))),
            Ea,
            f,
            da
        ),
                ...
                a =
                    ...
                    (i, m, d = !1) => {
                        ...
                        const u = xe.fromDom(e.getDoc()),
                            f = Br(a, u, r),
                            g = { sizing: fc(e, i), resize: Ir(e) ? Zs() : el(), section: l(i) };
                        return s(i)
                            ? n(i, m, f, g).bind((n) => {
                                  t.refresh(i.dom),
                                      N(n.newRows, (t) => {
                                          ...
                                          () => {
                                              ...
                                              return H(n)
                                                  ...
                                                  .map((n) => {
                                                      ...
                                                      return r.selectNode(n.dom), e.selection.setRng(r), ge(n, 'data-mce-selected', '1'), r;
                                                  });
                                          },
                                          (n) => {
                                              const r = qs(Us, n),
                                  ...
                                  return lt(i) && (ts(i), d || ic(e, i.dom, c)), r.map((e) => ({ rng: e, effect: c }));
                              })
                            : C.none();
                    },
        ...
        wc = Zl([{ invalid: ['raw'] }, { pixels: ['value'] }, { percent: ['value'] }]),
        bc = (e, t, o) => {
            const n = o.substring(0, o.length - e.length),
                r = parseFloat(n);
            return n === r.toString() ? t(r) : wc.invalid(o);
        },
        vc = { ...wc, from: (e) => (Rt(e, '%') ? bc('%', wc.percent, e) : Rt(e, 'px') ? bc('px', wc.pixels, e) : wc.invalid(e)) },
        yc = (e, t, o) => {
            const n = vc.from(o),
                r = P(e, (e) => '0px' === e)
                    ? ((e, t) => {
        ...
        xc = (e, t) => (0 === e.length ? t : z(e, (e, t) => vc.from(t).fold(g(0), h, h) + e, 0)),
        Cc = (e, t) =>
            vc.from(e).fold(
                g(e),
                (e) => e + t + 'px',
        ...
        Sc = (e) => {
            ...
            const t = z(
                ...
                o = t.output;
            return o.slice(0, o.length - 1).concat([Cc(o[o.length - 1], Math.round(t.remainder))]);
        },
        Tc = vc.from,
        ...
        Ac = { styles: { 'border-collapse': 'collapse', width: '100%' }, attributes: { border: '1' }, colGroups: !1 },
        Lc = (e, t, o, n) =>
            k(e, (e) =>
                ((e, t, o, n) => {
                    ...
                    for (let s = 0; s < e; s++) {
                        ...
                        s < o && ge(e, 'scope', 'row'), n < t && ge(e, 'scope', 'col'), Ie(e, xe.fromTag('br')), Ie(r, e);
                    }
                    return r;
                })(t, o, n, e)
            ),
        ...
        Mc = (e, t, o, n, s) => {
            ...
            return (
                ...
                wt(Zr(e), 'table[data-mce-id="__mce"]')
                    .map(
                        (t) => (
                            $r(e) ? _c(t) : Vr(e) ? zc(t) : (Hr(e) || ((e) => r(e) && -1 !== e.indexOf('%'))(l.width)) && Bc(t),
                            ts(t),
                            be(t, 'data-mce-id'),
                            ((e, t) => {
                                N(dt(t, 'tr'), (t) => {
    ...
    const Pc = 'x-tinymce/dom-table-',
        ...
        Xc = (e, t) => {
            const o = es(e),
                n = (e) => Kt(e, o),
                l = (t) => ((e) => js(os(e), es(e)).filter(ss))(e).bind((e) => n(e).map((o) => t(o, e))),
                a = (t) => {
                    e.focus();
                },
                c = (t, o = !1) =>
                    ...
                    l((t, o) =>
                        ((e, t, o) => {
                            ...
                            return Ol(n, t)
                                .bind((e) => {
                                    const t = xl(n, o, !1),
                                        r = qo(t).rows.slice(e[0].row, e[e.length - 1].row + e[e.length - 1].rowspan),
                                        s = j(r, (e) => {
                                    ...
                                    E(e, (e) => {
                                        ...
                                        return (
                                            N(e.cells, (e) => {
                                                ...
                                                pl(o, 'colspan', e.colspan, 1), pl(o, 'rowspan', e.rowspan, 1), Ie(t, o);
                                            }),
                                            t
                                        );
                                    })
                    ...
                    o().each((o) => {
                        ...
                        l((o, r) => {
                            const s = _r(xe.fromDom(e.getDoc())),
                                l = ((e, t, o, n) => ({ selection: Os(e), clipboard: o, generators: n }))(Ps(e), 0, n, s);
                            t(o, l).each(a);
                        });
                    }),
                g = (e) => (t, o) =>
            ...
            G(
                {
                    ...
                    mceTableDelete: () =>
                        Qc(e).each((t) => {
                            Kt(t, o)
                                ...
                                .each((t) => {
                                    const o = xe.fromText('');
                                    if ((je(t, o), qe(t), e.dom.isEmpty(e.getBody()))) e.setContent(''), e.selection.setCursorLocation();
                                    else {
                    ...
                    mceTableCellToggleClass: (t, o) => {
                        l((t) => {
                            ...
                            N(n, (e) => s('tablecellclass', { value: o }, e.dom)), ic(e, t.dom, mc);
                        });
                    },
                    mceTableToggleClass: (t, o) => {
                        l((t) => {
                            e.formatter.toggle('tableclass', { value: o }, t.dom), ic(e, t.dom, mc);
                        });
                    },
                        ...
                        Qc(e).each((t) => {
                            Kt(t, o).each((o) => {
                                pt(o, 'caption').fold(
                                    ...
                                    (n) => {
                                        ue('caption')(t) && Te('td', o).each((t) => e.selection.setCursorLocation(t.dom, 0)), qe(n);
                                    }
                                ),
                                    ic(e, o.dom, dc);
                            });
        ...
        Zc = Zl([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
        ei = { before: Zc.before, on: Zc.on, after: Zc.after, cata: (e, t, o, n) => e.fold(t, o, n), getStart: (e) => e.fold(h, h, h) },
        ...
        ai = (e) => ({ left: e.left, top: e.top, right: e.right, bottom: e.bottom, width: e.width, height: e.height }),
        ci = Zl([{ ltr: ['start', 'soffset', 'finish', 'foffset'] }, { rtl: ['start', 'soffset', 'finish', 'foffset'] }]),
        ii = (e, t, o) => t(xe.fromDom(o.startContainer), o.startOffset, xe.fromDom(o.endContainer), o.endOffset),
        mi = (e, t) => {
            const o = ((e, t) =>
                t.match({
                    domRange: (e) => ({ ltr: g(e), rtl: C.none }),
                    relative: (t, o) => ({ ltr: eo(() => si(e, t, o)), rtl: eo(() => C.some(si(e, o, t))) }),
                    exact: (t, o, n, r) => ({ ltr: eo(() => li(e, t, o, n, r)), rtl: eo(() => C.some(li(e, n, r, t, o))) })
                }))(e, t);
            return ((e, t) => {
                const o = t.ltr();
                return o.collapsed
                    ? t
                          ...
                          .map((e) => ci.rtl(xe.fromDom(e.endContainer), e.endOffset, xe.fromDom(e.startContainer), e.startOffset))
    ...
    const ui = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
        ...
        gi = (e, t) => {
            const o = di(e, t);
            return ui(xe.fromDom(o.startContainer), o.startOffset, xe.fromDom(o.endContainer), o.endOffset);
        },
        hi = fi,
        pi = (e, t, o, n, r) =>
            Re(o, n)
                ...
                : xs(o, n, t).bind((t) => {
                      ...
                      return n.length > 1 ? (r(e, n, t.start, t.finish), C.some(ti(C.some(hi(o, 0, o, br(o))), !0))) : C.none();
                  }),
        ...
        Ci = (e, t, o, n, r = xi) =>
            L(r, (e) => e.current === o).bind((o) => o.current(e, t, n, o.next).orThunk(() => o.fallback.bind((o) => Ci(e, t, o, n)))),
        Si = (e, t, o, n, r, s) =>
            Ci(e, t, n, r).bind((t) => (s(t.item) ? C.none() : o(t.item) ? C.some(t.item) : Si(e, t.item, o, t.mode, r, s))),
        ...
        Di = (e, t, o, n) =>
            Si(e, t, o, vi, { sibling: (e, t) => e.query().nextSibling(t), first: (e) => (e.length > 0 ? C.some(e[0]) : C.none()) }, n),
        Oi = hs(),
        ki = (e, t) => ((e, t, o) => Ri(e, t, Ti(e), o))(Oi, e, t),
        Ei = (e, t) => ((e, t, o) => Di(e, t, Ti(e), o))(Oi, e, t),
        Ni = Zl([{ none: ['message'] }, { success: [] }, { failedUp: ['cell'] }, { failedDown: ['cell'] }]),
        Bi = (e) => bt(e, 'tr'),
        _i = {
            ...Ni,
        ...
        zi = ue('br'),
        Ai = (e, t, o) => t(e, o).bind((e) => (ie(e) && 0 === hr(e).trim().length ? Ai(e, t, o) : C.some(e))),
        Li = (e, t, o, n) =>
            ((e, t) =>
                We(e, t)
                    .filter(zi)
        ...
        Wi = (e, t) => ({ left: e.left, top: e.top + t, right: e.right, bottom: e.bottom + t }),
        Mi = (e, t) => ({ left: e.left, top: e.top - t, right: e.right, bottom: e.bottom - t }),
        ji = (e, t, o) => ({ left: e.left + t, top: e.top + o, right: e.right + t, bottom: e.bottom + o }),
        Pi = (e) => ({ left: e.left, top: e.top, right: e.right, bottom: e.bottom }),
        ...
        Fi = (e, t, o) =>
            ce(t)
                ...
                : ie(t)
                ? ((e, t, o) =>
                      o >= 0 && o < br(t) ? e.getRangedRect(t, o, t, o + 1) : o > 0 ? e.getRangedRect(t, o - 1, t, o) : C.none())(
                      e,
                      t,
                      o
                  ).map(Pi)
                : C.none(),
        Hi = (e, t) => (ce(t) ? Ii(e, t).map(Pi) : ie(t) ? e.getRangedRect(t, 0, t, br(t)).map(Pi) : C.none()),
        $i = Zl([{ none: [] }, { retry: ['caret'] }]),
        Vi = (e, t, o) =>
            gt(t, pa).fold(y, (t) =>
                Hi(e, t).exists((e) => ((e, t) => e.left < t.left || Math.abs(t.right - e.left) < 1 || e.left > t.right)(o, e))
            ),
        qi = {
            point: (e) => e.bottom,
            adjuster: (e, t, o, n, r) => {
            ...
            0 === r
                ...
                : e.situsFromPoint(n.left, t.point(n)).bind((s) =>
                      s.start.fold(
                          ...
                          (s) =>
                              Hi(e, s)
                                  .bind((l) => t.adjuster(e, s, l, o, n).fold(C.none, (n) => Ui(e, t, o, n, r - 1)))
                                  .orThunk(() => C.some(n)),
                          C.none
                      )
                  ),
            ...
            e.getSelection().bind((n) =>
                ((e, t, o, n) => {
                    ...
                    (r) => {
                        ...
                        return (
                            (l = _i.verify(e, n.finish, n.foffset, s.finish, s.foffset, o.failure, t)),
                            _i.cata(
                                l,
                                (e) => C.none(),
                                () => C.none(),
            ...
            0 === s
                ...
                : Zi(e, t, o, n, r).bind((l) => {
                      ...
                      return _i.cata(
                          ...
                          () => C.none(),
                          () => C.some(l),
                          (l) => (Re(o, l) && 0 === n ? Qi(e, o, n, Mi, r) : Ji(e, t, l, 0, r, s - 1)),
                          (l) => (Re(o, l) && n === br(l) ? Qi(e, o, n, Wi, r) : Ji(e, t, l, br(l), r, s - 1))
                      );
                  }),
        Qi = (e, t, o, n, r) => Fi(e, t, o).bind((t) => Xi(e, r, n(t, Ki.getJumpSize()))),
        Xi = (e, t, o) => {
            const n = Bo().browser;
            ...
            bt(n, 'td,th', t).bind((n) =>
                bt(n, 'table', t).bind((s) =>
                    ((e, t) => ft(e, (e) => Ne(e).exists((e) => Re(e, t)), void 0).isSome())(r, s)
                        ? ((e, t, o) => Yi(e, t, o).bind((n) => Ji(e, t, n.element, n.offset, o, 20).map(e.fromSitus)))(e, t, o).bind((e) =>
                              bt(e.finish, 'td,th', t).map((t) => ({ start: n, finish: t, range: e }))
                          )
                        : C.none()
                )
            ),
        ...
        om = (e, t) =>
            bt(e, 'tr', t).bind((e) =>
                bt(e, 'table', t).bind((o) => {
                    const n = dt(o, 'tr');
                    return Re(e, n[0])
                        ? ((e, t, o) => Ri(Oi, e, (e) => Cr(e).isSome(), o))(o, 0, t).map((e) => {
                              const t = br(e);
            ...
            bt(e, 'tr', t).bind((e) =>
                bt(e, 'table', t).bind((o) => {
                    ...
                    return Re(e, n[n.length - 1])
                        ? ((e, t, o) => Di(Oi, e, (e) => xr(e).isSome(), o))(o, 0, t).map((e) => ti(C.some(hi(e, 0, e, 0)), !0))
                        : C.none();
                })
            ),
        rm = (e, t, o, n, r, s, l) => em(e, o, n, r, s).bind((e) => pi(t, o, e.start, e.finish, l)),
        sm = (e) => {
            let t = e;
            return {
                get: () => t,
        ...
        am = (e, t) => bt(e, 'td,th', t),
        cm = (e) => Be(e).exists(Qr),
        im = { traverse: Ae, gather: Ei, relative: ei.before, retry: Ki.tryDown, failure: _i.failedDown },
        mm = { traverse: ze, gather: ki, relative: ei.before, retry: Ki.tryUp, failure: _i.failedUp },
        dm = (e) => (t) => t === e,
        um = dm(38),
        fm = dm(40),
        gm = (e) => e >= 37 && e <= 40,
        ...
        wm = Zl([{ domRange: ['rng'] }, { relative: ['startSitu', 'finishSitu'] }, { exact: ['start', 'soffset', 'finish', 'foffset'] }]),
        bm = {
        ...
        ym = (e, t) => {
            const o = ne(e);
            return 'input' === o ? ei.after(e) : D(['br', 'img'], o) ? (0 === t ? ei.before(e) : ei.after(e)) : ei.on(e, t);
        },
        ...
        Om = (e) => {
            if (e.rangeCount > 0) {
                ...
                return C.some(ui(xe.fromDom(t.startContainer), t.startOffset, xe.fromDom(o.endContainer), o.endOffset));
            }
            return C.none();
        },
        km = (e) => {
        ...
        Nm = (e) =>
            ((e) =>
                xm(e)
                    ...
                    .bind(km))(e).map((e) => bm.exact(e.start, e.soffset, e.finish, e.foffset)),
        Bm = (e) => ({
                ...
                ((e, t, o) =>
                    ((e, t, o) => {
                        ...
                        return vm(n, t, o).map((e) =>
                            ui(xe.fromDom(e.startContainer), e.startOffset, xe.fromDom(e.endContainer), e.endOffset)
                        );
                    })(e, t, o))(e, t, o).map((e) => fi(e.start, e.soffset, e.finish, e.foffset)),
            clearSelection: () => {
                ((e) => {
        ...
        Km = (e, t) => {
            const o =
                    ...
                    { get: () => Rs(xe.fromDom(e.getBody()), r).fold(() => js(os(e), es(e)).fold(Pm, Fm), Im) }),
                n = ((e, t, o) => {
                    const n = (t) => {
                        ...
                        l = (t) => {
                            const o = dt(t, `${e.selectedSelector},${e.firstSelectedSelector},${e.lastSelectedSelector}`);
                            N(o, n);
                        };
                    return {
                        clearBeforeUpdate: l,
            ...
            return (
                e.on('init', (o) => {
                                                ...
                                                am(s.target, o).each((l) => {
                                                    xs(r, l, o).each((o) => {
                                                        ...
                                                        if (1 === r.length) {
                                                            ...
                                                            r.length > 1 && (n.selectRange(t, r, o.start, o.finish), e.selectContents(l));
                                                    });
                                                });
                                        });
                                    };
                                        ...
                                        g = Cs(t, n.selectedSelector).fold(
                                            ...
                                            (e) => {
                                                const o = (o) => () => {
                                                    const s = V(o, (o) =>
                                                        ((e, t, o, n, r) =>
                                                            Ts(n, e, t, r.firstSelectedSelector, r.lastSelectedSelector).map(
                                                                (e) => (
                                                    ...
                                                    return s.fold(
                                                        () =>
                                                            Ss(t, n.firstSelectedSelector, n.lastSelectedSelector).map((e) => {
                                                                const o = fm(u) || m.isForward(u) ? ei.after : ei.before;
                                                                return (
                                                                    r.setRelativeSelection(ei.on(e.first, 0), o(e.table)),
                                                                    n.clear(t),
                                                                    ti(C.none(), !0)
                                                                );
                                                            }),
                                    ...
                                    Cs(t, n.selectedSelector).fold(() => {
                                        ...
                                        return !0 === c.shiftKey && gm(i) && Am(r, l)
                                            ? ((e, t, o, n, r, s, l) =>
                                                  Re(o, r) && n === s
                                                      ? C.none()
                                                      : bt(o, 'td,th', t).bind((o) => bt(r, 'td,th', t).bind((n) => pi(e, t, o, n, l))))(
                                                  t,
                                                  o,
                                                  r,
                                                  s,
                    ...
                    e.on('dragstart', (e) => {
                        ...
                        e.on('mouseover', (e) => {
                            var t;
                            (void 0 !== (t = e).buttons && 0 == (1 & t.buttons)) || !Gm(e) || a.mouseover(Um(e));
                        }),
                        e.on('mouseup', (e) => {
                ...
                e.on('PreInit', () => {
                    e.serializer.addTempAttr(As.firstSelected), e.serializer.addTempAttr(As.lastSelected);
                }),
                {
                    getSelectedCells: () =>
                        ((e, t, o, n) => {
        ...
        Jm = (e) => ({ registry: K(e, (e) => ({ bind: e.bind, unbind: e.unbind })), trigger: K(e, (e) => e.trigger) }),
        Qm = (e) => e.slice(0).sort(),
        Xm = (e, t) => {
            const o = _(t, (t) => !D(e, t));
            o.length > 0 &&
                        ...
                        (n) => {
                            ...
                            return (
                                s.length > 0 &&
                                    ((e, t) => {
                                        throw new Error(
                                            'All values need to be of type: ' + t + '. Keys (' + Qm(e).join(', ') + ') were not.'
                                        );
                                    })(s, o.label),
                                n
                            );
    ...
    const ad = rd('ephox-snooker').resolve,
            ...
            ((e, t, o, n) => {
                ud(e, t, (e, t) => {
                    const r = ((e, t, o, n, r) => {
                        ...
                        return (
                            Bt(s, { position: 'absolute', left: t + 'px', top: o - 3.5 + 'px', height: '7px', width: n + 'px' }),
            ...
            ((e, t, o, n) => {
                ud(e, t, (e, t) => {
                    const r = ((e, t, o, n, r) => {
                        const s = xe.fromTag('div');
                        return (
                            Bt(s, { position: 'absolute', left: t - 3.5 + 'px', top: o + 'px', height: r + 'px', width: '7px' }),
        ...
        vd = (e) => {
            ...
            o.events.stop.bind(() => {
                t.get().each((t) => {
                    n.each((o) => {
                        r(t, 'data-row').each((e) => {
                            const n = s(t, 'top');
                            be(t, 'data-initial-top'), d.trigger.adjustHeight(o, n, parseInt(e, 10));
                        }),
                            r(t, 'data-column').each((e) => {
                                const n = s(t, 'left');
                                be(t, 'data-initial-left'), d.trigger.adjustWidth(o, n, parseInt(e, 10));
                            }),
                            gd(e, o);
                    });
                });
            ...
            const l = (n, r) => {
                ...
                c = qm(e.parent(), 'mousedown', (e) => {
                    var t;
                    (t = e.target), jm(t, id) && l(e.target, 'top'), ((e) => jm(e, md))(e.target) && l(e.target, 'left');
                }),
                i = (t) => Re(t, e.view()),
                ...
                d = Jm({ adjustHeight: Ym(['table', 'delta', 'row']), adjustWidth: Ym(['table', 'delta', 'column']), startAdjust: Ym([]) });
            return {
                destroy: () => {
        ...
        yd = (e, t, o) => {
            const n = _n,
                r = An,
                s = vd(e),
                l = Jm({ beforeResize: Ym(['table', 'type']), afterResize: Ym(['table', 'type']), startDrag: Ym([]) });
            return (
                s.events.adjustHeight.bind((e) => {
                    ...
                    ((e, t, o, n) => {
                        const r = Zo(e),
                            s = ((e, t, o) => lr(e, t, o, Yn, (e) => e.getOrThunk(Ht)))(r, e, n),
                            l = E(s, (e, n) => (o === n ? Math.max(t + e, Ht()) : e)),
                            a = oa(r, l),
                            c = ((e, t) => E(e.all, (e, o) => ({ element: e.element, height: t[o] })))(r, l);
                        N(c, (e) => {
                        ...
                        e.inline
                            ? ((e, t, o) => ({ parent: g(t), view: g(e), origin: g(bn(0, 0)), isResizable: o }))(
                                  ...
                                  (() => {
                                      ...
                                      return (
                                          Bt(e, { position: 'static', height: '0', width: '0', padding: '0', margin: '0', border: '0' }),
