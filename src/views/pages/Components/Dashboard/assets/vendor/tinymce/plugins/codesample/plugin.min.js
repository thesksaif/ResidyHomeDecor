    ...
    const r = 'undefined' != typeof window ? window : Function('return this;')(),
        i = (function (e, t, n) {
            ...
            return (
                ...
                s.languages.insertBefore('c', 'string', { char: { pattern: /'(?:\\(?:\r\n|[\s\S])|[^'\\\r\n]){0,32}'/, greedy: !0 } }),
                ...
                Object.defineProperty(s.languages.markup.tag, 'addInlined', {
                    value: function (e, t) {
                        var n = {};
                        (n['language-' + t] = { pattern: /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i, lookbehind: !0, inside: s.languages[t] }),
                            (n.cdata = /^<!\[CDATA\[|\]\]>$/i);
        ...
        p = (e) => {
            const t = ((e) =>
                ...
                n = ((r = t), ((e, t) => (0 < e.length ? a.some(e[0]) : a.none()))(r)).fold(('', () => ''), (e) => e.value);
            var r;
            const i = ((e, t) =>
                    g(e).fold(
                        () => t,
        ...
        ((e) => {
            ...
            ((e) => {
                e.on('PreProcess', (t) => {
                    ...
                    e.on('SetContent', () => {
                        const t = e.dom,
                            n = f.grep(t.select('pre'), (e) => d(e) && 'true' !== t.getAttrib(e, 'data-mce-highlighted'));
                        n.length &&
                            e.undoManager.transact(() => {
                                f.each(n, (n) => {
                                    var a;
