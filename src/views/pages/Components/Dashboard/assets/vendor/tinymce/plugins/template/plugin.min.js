...
!(function () {
    ...
    const c = (e) => (t) => t.options.get(e),
        ...
        M = (e, t, a = new Date()) => {
            ...
            return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace('%D', '%m/%d/%Y')).replace(
                '%r',
                '%I:%M:%S %p'
            )).replace('%Y', '' + a.getFullYear())).replace('%y', '' + a.getYear())).replace('%m', _(a.getMonth() + 1, 2))).replace(
                '%d',
                _(a.getDate(), 2)
            )).replace('%H', '' + _(a.getHours(), 2))).replace('%M', '' + _(a.getMinutes(), 2))).replace(
                '%S',
                '' + _(a.getSeconds(), 2)
            )).replace('%I', '' + (((a.getHours() + 11) % 12) + 1))).replace('%p', a.getHours() < 12 ? 'AM' : 'PM')).replace(
                '%B',
                '' + e.translate(l[a.getMonth()])
            )).replace('%b', '' + e.translate(s[a.getMonth()]))).replace('%A', '' + e.translate(r[a.getDay()]))).replace(
                '%a',
                '' + e.translate(n[a.getDay()])
            )).replace('%%', '%');
        };
    class T {
        constructor(e, t) {
    ...
    const C = { '"': '&quot;', '<': '&lt;', '>': '&gt;', '&': '&amp;', "'": '&#039;' },
        w = (e) =>
            e.replace(/["'<>&]/g, (e) => {
                return ((t = C), (a = e), ((e, t) => S.call(e, t))(t, a) ? T.from(t[a]) : T.none()).getOr(e);
                var t, a;
            }),
        O = (e, t, a) =>
            ((a, n) => {
                for (let n = 0, s = a.length; n < s; n++) if (((r = a[n]), e.hasClass(t, r))) return !0;
                var r;
                return !1;
            })(a.split(/\s+/)),
        A = (e, t) => x({ validate: !0 }, e.schema).serialize(e.parser.parse(t, { insert: !0 })),
        D = (e, t) => (
            o.each(t, (t, a) => {
        ...
        I = (e, t, a) => {
            ...
            l && l.length > 0 && ((s = n.create('div')), s.appendChild(l[0].cloneNode(!0))),
                o.each(n.select('*', s), (t) => {
    ...
    const k = (e, t) => {
            const a = (e, t) =>
                ...
                n = (t) => {
                    e.windowManager.alert('Could not load the specified template.', () => t.focus('template'));
                },
                r = (e) =>
                    e.value.url.fold(
                ...
                const a = ((e) =>
                    ...
                    i = (t, n, r) => {
                        const s = ((e, t) => {
                                ...
                                if (-1 === t.indexOf('<html>')) {
                                    ...
                                    const l = b(e),
                                        ...
                                        i =
                                            ...
                                            (E.os.isMacOS() || E.os.isiOS() ? 'e.metaKey' : 'e.ctrlKey && !e.altKey') +
                            ...
                            c = [
                                { type: 'listbox', name: 'template', label: 'Templates', items: a },
                                { type: 'htmlpanel', html: `<p aria-live="polite">${w(n.value.description)}</p>` },
                                { label: 'Preview', type: 'iframe', name: 'preview', sandboxed: !1, transparent: !1 }
                            ],
    ...
    e.add('template', (e) => {
        ((e) => {
            ...
            t('template_cdate_classes', { processor: 'string', default: 'cdate' }),
                ...
                t('template_selected_content_classes', { processor: 'string', default: 'selcontent' }),
                ...
                t('templates', {
                    processor: (e) =>
                        ...
                        ((e, t) => {
                            if (r(e)) {
                                for (let a = 0, n = e.length; a < n; ++a) if (!t(e[a])) return !1;
                                return !0;
                            }
                            return !1;
                        })(e, n) ||
                ...
                t('template_cdate_format', { processor: 'string', default: e.translate('%Y-%m-%d') }),
                t('template_mdate_format', { processor: 'string', default: e.translate('%Y-%m-%d') });
        })(e),
            ((e) => {
                const t = () => e.execCommand('mceTemplate');
                e.ui.registry.addButton('template', { icon: 'template', tooltip: 'Insert template', onSetup: P(e), onAction: t }),
                    e.ui.registry.addMenuItem('template', { icon: 'template', text: 'Insert template...', onSetup: P(e), onAction: t });
            })(e),
            ((e) => {
                e.addCommand(
                    'mceInsertTemplate',
