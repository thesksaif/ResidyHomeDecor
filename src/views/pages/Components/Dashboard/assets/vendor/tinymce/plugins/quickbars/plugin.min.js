                ...
                onAction: () => {
                    ((t) =>
                        new Promise((e) => {
                            ...
                            const r = (t) => {
                                    var r;
                                    o || (null === (r = n.parentNode) || void 0 === r || r.removeChild(n), (o = !0), e(t));
                                },
                                i = (t) => {
                            ...
                            const s = (e) => {
                                ...
                                o || ('focusin' === e.type ? u.setEditorTimeout(t, n, 1e3) : n()), t.off('focusin remove', s);
                            };
                ...
                t.ui.registry.addContextToolbar('quickblock', {
                    predicate: (e) => {
                        ...
                        return (
                            ...
                            ((t, e, o) => h((t, e) => v(t, e), y, t, 'table,[data-mce-bogus="all"]', o))(o, 0, r).fold(
                                () =>
                ...
                const e = (e) => t.dom.isEditable(e),
                    o = (t) => {
                        const o = 'FIGURE' === t.nodeName && /image/i.test(t.className),
                            n = 'IMG' === t.nodeName || o,
                            r = ((t) => void 0 !== t.dom.classList)((i = p(t))) && i.dom.classList.contains('mce-pagebreak');
                        var i;
                        return n && e(t.parentElement) && !r;
                    },
                    n = l(t);
                n.length > 0 && t.ui.registry.addContextToolbar('imageselection', { predicate: o, items: n, position: 'node' });
                const r = s(t);
                r.length > 0 &&
