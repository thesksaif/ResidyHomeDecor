                    ...
                    (function (global) {
                        (function () {
                                ...
                                switch (o) {
                                    ...
                                    case s._const.replaceElement:
                                        var h =
                                            ...
                                            'http://www.w3.org/2000/svg' === i.parentNode.namespaceURI;
                                    ...
                                    case s._const.addElement:
                                        ...
                                        i.insertBefore(
                                            r(e[s._const.element], 'http://www.w3.org/2000/svg' === i.namespaceURI, s),
                                            i.childNodes[u] || null
                                        );
                                        break;
                            ...
                            var u = function (t) {
                                ...
                                m = function (t) {
                                    return (
                                        delete t.outerDone, delete t.innerDone, delete t.valueDone, !t.childNodes || t.childNodes.every(m)
                                    );
                                },
                                g = function (t) {
                                                ...
                                                var t = (function (t, e, s, i) {
                                                    ...
                                                    for (var h = 0; h < o; h++)
                                                        for (var p = t[h], m = 0; m < r; m++) {
                                                            ...
                                                            s[h] || i[m] || !v(p, g, d, c)
                                                                ? (l[h + 1][m + 1] = 0)
                                                                : ((l[h + 1][m + 1] = l[h][m] ? l[h][m] + 1 : 1),
                                                                  l[h + 1][m + 1] >= n && ((n = l[h + 1][m + 1]), (a = [h + 1, m + 1])));
                                                        }
                                                    return (
                                                        0 !== n && {
                                                            oldValue: a[0] - n,
                                        ...
                                        t.replace(O, function (o, r) {
                                            ...
                                            if (d) {
                                                ...
                                                return (
                                                    p &&
                                                        u.nodeName &&
                                                        (p.node.childNodes || (p.node.childNodes = []), p.node.childNodes.push(u)),
                                                    ''
                                                );
                                            }
                                            if (l) {
                                            ...
                                            if (
                                                (!l || s.voidElement) &&
                                                (n > -1 &&
                                                    (s.voidElement || s.node.nodeName.toUpperCase() === o.slice(2, -1).toUpperCase()) &&
                                                    --n > -1 &&
                                                    (s = a[n]),
                                                '<' !== h && h)
                                            ) {
                                ...
                                T = (function () {
                                    ...
                                    return (
                                                ...
                                                0 === (s = this.findNextDiff(t, e, [])).length &&
                                                    (b(t, e) ||
                                                        (this.foundAll
                                                            ...
                                                            : ((this.foundAll = !0), m(t), (s = this.findNextDiff(t, e, []))))),
                                        ...
                                        (t.prototype.findOuterDiff = function (t, e, s) {
                                            ...
                                            if (
                                                s.length &&
                                                this.options.diffcap < Math.abs((t.childNodes || []).length - (e.childNodes || []).length)
                                            )
                                                return [
                                                    new x()
                                                        .setValue(this.options._const.action, this.options._const.replaceElement)
                                                            ...
                                                            ? '#text' === u.nodeName
                                                                ...
                                                                : (r.push(
                                                                      new x()
                                                                          ...
                                                                          .setValue(this.options._const.route, s.concat(l))
                                                                          .setValue(this.options._const.element, g(u))
                                                                  ),
                                                                  (l -= 1))
                                                            : p &&
                                                              !u &&
                                                              ('#text' === p.nodeName
                                                                  ...
                                                                  : r.push(
                                                                        new x()
                                                                            ...
                                                                            .setValue(this.options._const.route, s.concat(l))
                                                                            .setValue(this.options._const.element, g(p))
                                                                    ))),
                                                    u && p)
                                                )
                                                    if (!this.options.maxChildCount || a < this.options.maxChildCount)
                                                    ...
                                                    if (!0 === u[b])
                                                        ...
                                                        if (
                                                            ...
                                                            for (var y = 0; y < r.length; y += 1)
                                                                v(t.childNodes[o + y], t.childNodes[r.oldValue + y], {}, !1, !0) ||
                                                                    (a = !0);
                                                            if (a)
                                                                return [
                                                                    new x()
                                                ...
                                                var s = this,
                                                    ...
                                                    f = function (t, e) {
                                                        return D.w(
                                                            s
                                                                .toDate()
                                                                [t].apply(s.toDate('s'), (i ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)),
                                                            s
                                                        );
                                                    },
                                                    m = this.$W,
                                ...
                                sort(t, e, s = !1) {
                                    ...
                                    this.dt.data.data.sort((s, i) => {
                                        ...
                                        this.dt._searchQueries.length
                                            ...
                                            : s || ((this.dt._currentPage = 1), this.dt.update(), this.dt.emit('datatable.sort', t, e));
                                }
                                _measureWidths() {
                                    ...
                                    if ((this.dt.options.scrollY.length || this.dt.options.fixedColumns) && t?.length) {
                                        ...
                                        if (this.dt.options.header || this.dt.options.footer) {
                                            ...
                                            const e = Array.from(
                                                this.dt.dom.querySelector('thead, tfoot')?.firstElementChild?.querySelectorAll('th') || []
                                            );
                                            let s = 0;
                                    ...
                                    if (this.modalDOM) {
                                        ...
                                        if ('Enter' === t.key) {
                                            if (this.editingCell) {
                                                ...
                                                const t = Array.from(
                                                    this.dt.wrapperDOM.querySelectorAll(`input.${this.options.classes.input}[type=text]`)
                                                );
                                                this.saveRow(
                                                    t.map((t) => t.value.trim()),
                                                    this.data.row
                                            ...
                                            'Escape' === t.key &&
                                                (this.editingCell
                                                    ...
                                                    : this.editingRow && this.saveRow(null, this.data.row));
                                }
                                editCell(t) {
                                        ...
                                        o.addEventListener('click', (t) => {
                                            ...
                                            e instanceof Element &&
                                                (e.hasAttribute('data-editor-cancel')
                                                    ? (t.preventDefault(), this.options.cancelModal(this) && this.closeModal())
                            ...
                            (exports.DataTable = class {
                                ...
                                _renderSeparateHeader() {
                                    ...
                                    this.headerDOM ||
                                        ((this.headerDOM = document.createElement('div')), (this._virtualHeaderDOM = { nodeName: 'DIV' })),
                                        ...
                                        childNodes: [
                                            {
                                                nodeName: 'THEAD',
                                                childNodes: [
                                                    A(this.data.headings, this.columns.settings, this.columns._state, this.options, {
                                                        unhideHeader: !0
                                                    })
                                                ]
                                            }
                                ...
                                _paginate() {
                                    ...
                                    return (
                                        this._searchQueries.length &&
                                            ((t = []), this._searchData.forEach((e) => t.push({ index: e, row: this.data.data[e] }))),
                                ...
                                multiSearch(t) {
                                        ...
                                        this.columns.settings.map((e, s) => {
                                            ...
                                            ['base', 'accent'].includes(n) && (i = i.map((t) => t.toLowerCase())),
                                                ['base', 'case'].includes(n) &&
                                                    (i = i.map((t) => t.normalize('NFD').replace(/\p{Diacritic}/gu, '')));
                                            return (
                                                (e.ignorePunctuation ?? this.options.ignorePunctuation) &&
                                                    (i = i.map((t) => t.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, ''))),
                                                i
                                            );
                                        })
                                    );
                                    this.data.data.forEach((t, e) => {
                                        ...
                                        s.every((t) => t.find((t, e) => !!t && t.find((t) => i[e].find((e) => e.includes(t))))) &&
                                            ...
                                            Object.entries(e).forEach(([e, s]) => {
                                                ...
                                                a > -1
                                                    ...
                                                    : this.hasHeadings ||
                                                      this.hasRows ||
                                                      0 !== i ||
                                                      ((n[t.length] = q(s, this.columns.settings[t.length])),
                                                      t.push(e),
                                        ...
                                        t(e) &&
                                            (!e.headings || this.hasHeadings || this.hasRows
                                                ? e.data &&
                                                  ...
                                                  (s = e.data.map((t) => t.map((t, e) => q(t, this.columns.settings[e]))))
                                                : (this.data = F(
                                                      e,
                                                      void 0,
                                                      this.columns.settings,
                                ...
                                (exports.exportJSON = function (e, s = {}) {
                                    ...
                                    if (i.selection)
                                        if (Array.isArray(i.selection))
                                            for (let t = 0; t < i.selection.length; t++)
                                                a = a.concat(
                                                    e.pages[i.selection[t] - 1].map((t) => t.row.filter((t, e) => n(e)).map((t) => t.data))
                                                );
                                        else
                                            a = a.concat(
                                                e.pages[i.selection - 1].map((t) => t.row.filter((t, e) => n(e)).map((t) => t.data))
                                            );
