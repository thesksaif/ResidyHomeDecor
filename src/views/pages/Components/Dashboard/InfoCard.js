            ...
            <div className={`card info-card ${type}-card`}>
                ...
                <div className="card-body">
                    <h5 className="card-title">
                        {title} <span>| {timeFrameText}</span>
                    </h5>
                    <div className="d-flex align-items-center">
                        <div className="card-icon rounded-circle d-flex align-items-center justify-content-center">{icon}</div>
                        <div className="ps-3">
                            <h6>{amount}</h6>
                            <span className="text-success small pt-1 fw-bold">{percentage}</span>{' '}
                            <span className="text-muted small pt-2 ps-1">{increaseDecrease}</span>
                        </div>
                    </div>
                </div>
            </div>
...
InfoCard.propTypes = {
    ...
    increaseDecrease: PropTypes.string.isRequired,
