...
const InteriorSection = () => {
    return (
        <div className="interior-section">
            ...
            <p>
                Be it end-to-end interiors, renovation or modular solutions, we have it all for your home or office. With a wide range of
                furniture & decor, we have your back from start to finish.
            </p>
            <div className="interior-cards">
                {services.map((service, index) => (
                    <InteriorCard key={index} image={service.image} title={service.title} description={service.description} />
                ))}
            </div>
        </div>
    );
