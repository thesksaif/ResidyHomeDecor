                            ...
                            <div className="row ">
                                <div className="col-md-6">
                                    <div className="about-text">
                                        ...
                                        <h2 className="about-title">Professional and Expert Interior Contractor</h2>
                                        <p className="para">
                                            Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Praesent sapien massa,
                                            convallis a pellentesque nec, egestas non nisi. Nulla porttitor accumsan tincidunt. Donec rutrum
                                ...
                                <div className="col-md-6">
                                    <div className="about-info">
                                        ...
                                        <div className="founder-info d-flex align-items-center mt-3">
                                            <img src={max} alt="Max Stewart" className="founder-image rounded-circle mr-3" />
                                        ...
                                        <div className="info  mt-3">
                                            ...
                                            <p className="text-muted">+1 2345 678 or info@example.com</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
