                    ...
                    <div className="col-md-6">
                        <div className="history-content">
                            ...
                            <p className="history-description">
                                From creating stunning living spaces to designing efficient work environments, our journey has been marked
                                by creativity and innovation. Join us as we explore the art of interior design, where every space tells a
                                story.
                            </p>
