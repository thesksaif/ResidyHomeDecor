      ...
      <div className="Footer container">
        <div className="row">
          <div className="col-md-3">
            ...
            <p>
              BResidyHomeDecor is a dashboard template that utilizes the
              Material-UI framework and the React JavaScript library. It offers
              a range of features and customization options to help you create a
          ...
          <div className="col-md-2">
            ...
            <ul className="list-unstyled">
              ...
              <li>
                <a href="#" className="text-white">
                  Documentation <span className="red-dot"></span>
                </a>
              </li>
              <li>
                <a href="#" className="text-white">
