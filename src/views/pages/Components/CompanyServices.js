                    ...
                    <div className="row d-flex justify-content-center">
                        <div className="col-5 add-content">
                            ...
                            <ul>
                                ...
                                <li>
                                    <i className="fas fa-arrow-alt-circle-right"></i> Window Replacement
                                </li>
                                <li>
                                    <i className="fas fa-arrow-alt-circle-right"></i> Skylights & Sun Tunnels
                                </li>
                                <li>
                                    <i className="fas fa-arrow-alt-circle-right"></i> Chimney Spark Arrestor
                                </li>
                                <li>
                                    <i className="fas fa-arrow-alt-circle-right"></i> Interior Sheetrock Repair
                                </li>
                            </ul>
