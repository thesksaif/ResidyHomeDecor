    ...
    >
      ...
      >
        <Grid
          ...
          xs={12}
          md={6}
          sx={{ img: { width: '100%', borderRadius: '5px' } }}
        >
        ...
        <Grid item xs={12} md={6}>
          <Grid container spacing={2.5}>
            <Grid item xs={12}>
              ...
              >
                ResidyHomeDecor has made it easy for developers of any skill
                level to use their product.
              </Typography>
            </Grid>
            <Grid item xs={12}>
              <Typography sx={listSX}>
                <IconCircleCheck size={20} />A straightforward and simple
                project structure.
              </Typography>
              <Typography sx={listSX}>
              ...
              <Typography sx={listSX}>
                <IconCircleCheck size={20} />A theme that can be easily
                configured on a single page.
              </Typography>
              {/* <Stack direction="row">
                                <AnimateButton>
                                    <Button
            ...
            <Grid item xs={12} md={6}>
              <Grid container spacing={2.5}>
                <Grid item xs={12}>
                  ...
                  >
                    Streamlining the design process and saving you time and
                    effort in the initial planning phase.
                  </Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography sx={listSX}>
                  ...
                  <Typography sx={listSX}>
                    <IconCircleCheck size={20} />
                    Detailed project plans available only in Premium & Extended
                    Packages.
                  </Typography>
                  <Typography sx={listSX}>
                    <IconCircleCheck size={20} />A theme that can be easily
