    ...
    return (
        <div className="tab-navigation">
            <div className="tabs-wrapper">
                <button className="arrow-button prev-button" onClick={() => scrollContainer('left')} aria-label="Scroll left">
                ...
                <button className="arrow-button next-button" onClick={() => scrollContainer('right')} aria-label="Scroll right">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
