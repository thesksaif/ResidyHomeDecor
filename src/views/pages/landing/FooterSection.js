                            ...
                            <Grid item xs={12} md={4}>
                                <Stack spacing={{ xs: 2, md: 5 }}>
                                    ...
                                    <Typography variant="body2" color={textColor}>
                                        ResidyHomeDecor is a leading interior design and home decor company. We offer personalized solutions
                                        to transform your home or office into a beautiful, functional space. Our team of expert designers
                                        and craftsmen are dedicated to delivering quality and style in every project.
                                    </Typography>
                                </Stack>
                            </Grid>
                                    ...
                                    <Grid item xs={6} sm={4}>
                                        <Stack spacing={{ xs: 3, md: 5 }}>
                                            ...
                                            <Stack spacing={{ xs: 1.5, md: 2.5 }}>
                                                ...
                                                <FooterLink component={RouterLink} to="/about-us" underline="none">
                                                    About Us
                                                </FooterLink>
                                                <FooterLink component={RouterLink} to="/services" underline="none">
                                                    Services
                                                </FooterLink>
                                                <FooterLink component={RouterLink} to="/contact-us" underline="none">
                                                    Contact Us
                                                </FooterLink>
                                                <FooterLink component={RouterLink} to="/quote" underline="none" target="_blank">
                                                    GET QUOTE
                                                </FooterLink>
                                            </Stack>
                                        </Stack>
                ...
                <Container>
                    ...
                    >
                        ...
                        <Stack direction="row" alignItems="center" spacing={{ xs: 3, sm: 1.5, md: 2 }}>
                            ...
                            <IconButton size="small" component={Link} href="" target="_blank" aria-label="x">
                                <TwitterIcon
                                    sx={{
                                        color: 'text.secondary',
                                        '&:hover': { color: 'primary.main' }
                            ...
                            <IconButton size="small" component={Link} href="" target="_blank" aria-label="youtube">
                                <YouTubeIcon
                                    sx={{
                                        color: 'text.secondary',
                            ...
                            <IconButton size="small" component={Link} href="" target="_blank" aria-label="linkedin">
                                <LinkedInIcon
                                    sx={{
                                        color: 'text.secondary',
                                        '&:hover': { color: 'primary.main' }
