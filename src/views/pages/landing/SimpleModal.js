                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12}>
                            <FormControl fullWidth>
                                ...
                                <OutlinedInput type="number" label="Mobile Number" placeholder="Enter Your Mobile Number" />
                            </FormControl>
                        </Grid>
                        <Grid item xs={12}>
                            <FormControl fullWidth>
                                <InputLabel>Email Address</InputLabel>
                                <OutlinedInput type="email" label="Email Address" placeholder="Enter Your Email Address" />
                            </FormControl>
                        </Grid>
                        <Grid item xs={12}>
                            <FormControl fullWidth>
