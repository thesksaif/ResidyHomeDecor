...
const Gallery = () => {
    ...
    return (
        <div className="services-container">
            <SectionHeader heading="Design Ideas for Every Space" subheading="Because every corner holds a unique design potential." />
            ...
            <button className="consultation-button themed-button">Explore More Designs</button>
            ...
            {lightbox.open && (
                <div className="gallery-lightbox" role="dialog" aria-modal="true">
                    <button
                        ...
                        tabIndex={-1}
                    />
                    <div className="gallery-lightbox-content" style={{ position: 'relative', zIndex: 2 }}>
                        <button
                        ...
                        <img src={lightbox.image} alt={lightbox.title} className="gallery-lightbox-image" />
