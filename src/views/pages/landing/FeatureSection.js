...
const offerData = [
  ...
  },
  {
    ...
    caption:
      'Residy Home Decor simplifies the design process with easy theme setup and well-organized, flexible layout options.',
    image: Offer3,
  },
  {
...
const FeatureSection = () => {
  ...
  return (
    ...
    >
      <Box
        sx={{ maxWidth: 1300, mx: 'auto', px: { xs: 2, sm: 3, md: 0 }, mb: 4 }}
      >
        <SectionHeader
