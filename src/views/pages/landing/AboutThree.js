                ...
                <div className="row">
                    ...
                    <div className="col-xl-6">
                        <div className="about-three__img">
                            <div className="shape1 float-bob-x">
                                <img src="https://logistiq.vercel.app/assets/images/shapes/about-v2-shape2.png" alt="" />
                            </div>
                    ...
                    <div className="col-xl-6">
                        <div className="about-three__content">
                            <SectionHeader heading="About Us" subheading="ResidyHomeDecor – Crafting Beautiful Interiors" />
                            <div className="about-three__content-text">
                                <p>
                                    At ResidyHomeDecor, we believe every home tells a story. With over 25 years of experience, our team of
                                    passionate designers and craftsmen have been transforming ordinary spaces into extraordinary living
                                    experiences. We blend creativity, functionality, and your unique style to create interiors that inspire.
                                </p>
                            </div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div className="content-box">
                                            ...
                                            <p>
                                                We tailor every project to reflect your personality, needs, and lifestyle, ensuring a truly
                                                bespoke interior.
                                            </p>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div className="content-box">
                                            <h2>Expert Team</h2>
                                            <p>
                                                Our experienced designers and skilled artisans work together to deliver quality and
                                    ...
                                    <li>
                                        ...
                                        <div className="content-box">
                                            ...
                                            <p>
                                                From concept to completion, we manage every aspect of your interior design journey for a
                                                seamless experience.
                                            </p>
                                        </div>
                                    </li>
