...
const testimonials = [
  {
    quote:
      'Residy Home Decor completely transformed my living space! The design team listened to my needs and created a home that feels both luxurious and comfortable. Every guest compliments the interiors!',
    name: 'Priya Sharma',
  ...
  {
    quote:
      'From concept to execution, the Residy team was professional and creative. My kitchen and wardrobe are now both stylish and functional. Highly recommend for anyone looking for a modern makeover!',
    name: 'Rahul Verma',
  ...
  {
    quote:
      'I loved the attention to detail and the personalized approach. The designers made sure every corner of my home reflected my personality. The process was smooth and the results are stunning!',
    name: 'Ananya Gupta',
