...
const PlanList = ({ plan, view, priceFlag }) => {
  ...
  return (
    <Grid
      ...
      sm={3}
      md={3}
      sx={{ display: view !== plan.id ? { xs: 'none', sm: 'block' } : 'block' }}
    >
      <FeatureContentWrapper>
        {plan.popular && (
          <PopularBadgeWrapper rtlLayout={rtlLayout}>
            Popular
          </PopularBadgeWrapper>
        )}
...
const ListItem = ({ item, index, view }) => (
  <Grid
    ...
    sm={3}
    md={3}
    sx={{ display: view !== index + 1 ? { xs: 'none', sm: 'block' } : 'block' }}
  >
    {item === 1 && (
      <Box sx={{ px: 3, py: 1.5 }}>
...
const OrderButton = ({ view, index, popular }) => (
  <Grid
    ...
    sm={3}
    md={3}
    sx={{ display: view !== index ? { xs: 'none', sm: 'block' } : 'block' }}
  >
    <FeatureContentWrapper>
      <Button
      ...
      <Stack direction="row" spacing={gridSpacing} justifyContent="center">
        <ButtonGroup disableElevation variant="contained" sx={{ mb: 3 }}>
          <Button
            size="large"
            sx={{
              bgcolor: priceFlag === 'yearly' ? 'primary.main' : 'primary.200',
            }}
          ...
          <Button
            size="large"
            sx={{
              bgcolor: priceFlag === 'monthly' ? 'primary.main' : 'primary.200',
            }}
