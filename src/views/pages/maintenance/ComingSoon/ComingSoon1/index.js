        ...
        <CardContent sx={{ position: 'relative' }}>
          ...
          {theme.palette.mode === 'light' && (
            <img
              ...
              width="100"
              style={{
                position: rtlLayout ? 'relative' : 'initial',
                top: rtlLayout ? 30 : 'initial',
              }}
            />
          )}
          {theme.palette.mode === 'dark' && (
                  ...
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                      <Typography sx={{ fontSize: '1.125rem' }}>
                        Presenting Material-UI based React Dashboard Template to
                        build performance centric websites and applications.
                      </Typography>
                    </Grid>
                  </Grid>
                </Grid>
