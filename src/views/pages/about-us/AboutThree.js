            ...
            <div className="about-hero__container">
                ...
                <div className="about-hero__right">
                    <div className="about-hero__tagline">
                        ...
                        <span className="about-hero__tagline-icon" role="img" aria-label="plane">
                            ✈️
                        </span>
                    </div>
                    <h1 className="about-hero__title">
                        ...
                        <span>
                            And Home Decor <span className="about-hero__title-accent">AGENCY</span>
                        </span>
                    </h1>
                    <p className="about-hero__desc">
                        ResidyHomeDecor is your trusted partner for transforming spaces. With 25+ years of experience, we blend creativity
                        and functionality to deliver beautiful, personalized interiors for every client.
                    </p>
                    <div className="about-hero__features">
                        <div className="about-hero__feature-card">
                            <div className="about-hero__feature-icon" style={{ background: '#dc3545' }}>
                            ...
                            <div>
                                ...
                                <div className="about-hero__feature-desc">
                                    We always provide people a complete solution focused on any home or business.
                                </div>
                            </div>
                        </div>
                        <div className="about-hero__feature-card">
