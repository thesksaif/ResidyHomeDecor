...
const finishOptions = [
    ...
    },
    {
        ...
        image: acrylic,
        price: '₹₹₹₹',
        proTip: 'Acrylic finish for a high-gloss, ultra-modern look and superior durability.'
    }
];
        ...
        <Box sx={{ maxWidth: '100%', mx: 'auto' }}>
            ...
            <Grid container spacing={3} justifyContent="center">
                {finishOptions.map((option) => (
                    <Grid item xs={12} sm={6} md={6} key={option.value} display="flex" justifyContent="center">
                        <Paper
                            variant="outlined"
                            sx={{
