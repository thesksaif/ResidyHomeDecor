...
const packages = [
  {
    ...
    value: 'essentials',
    description:
      'A range of basic units and accessories that are necessary for a comfortable wardrobe.',
    image: wardrobeSwing,
  ...
  },
  {
    ...
    value: 'premium',
    description:
      'An exquisite offering with sleek fixtures, hardware, cabinets and fittings for an elegant wardrobe design.',
          ...
          >
            ...
            >
              <FormControlLabel
                value={pkg.value}
                control={
                  <Radio color="error" checked={selected === pkg.value} />
                }
                label={
