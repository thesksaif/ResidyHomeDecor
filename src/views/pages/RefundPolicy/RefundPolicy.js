                    ...
                    <Grid item xs={12}>
                        <MainCard elevation={4} border={false} boxShadow shadow={4} sx={{ mb: 3 }}>
                            <Stack spacing={2} sx={{ textAlign: 'left' }}>
                                <Typography>
                                    This Refund Policy governs the manner in which Demos: A Network for Ideas and Action, Ltd. (“Demos”,
                                ...
                                <Typography>
                                    ...
                                    information, which becomes subject to their individual Refund policies. In addition, Demos shares
                                ...
                                <Typography>
                                    If you have any questions about this Refund Policy or anything relating to the Website, please contact
                                    Demos at{' '}
                                    <Link href="#" underline="none">
                                        info@demos.org.
                                    </Link>{' '}
