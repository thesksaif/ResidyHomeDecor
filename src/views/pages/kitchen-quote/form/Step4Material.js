...
import { Box, Typography, Button, Paper, Radio, RadioGroup, FormControlLabel, CardMedia, Alert } from '@mui/material';
            ...
            <RadioGroup value={selected} onChange={(e) => setSelected(e.target.value)}>
                {materialOptions.map((option) => (
                    ...
                    >
                        <FormControlLabel
                            value={option.value}
                            control={<Radio color="error" checked={selected === option.value} />}
