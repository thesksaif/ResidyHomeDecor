...
import { Box, Typography, Button, TextField, Grid, Alert, MenuItem } from '@mui/material';
...
const Step2Measurements = ({ handleNext, handleBack, layout, measurements, setMeasurements }) => {
