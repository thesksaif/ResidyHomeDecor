...
const StepperNavbar = ({ activeStep }) => (
    ...
    >
        ...
        >
            <Logo />
            <Stepper activeStep={activeStep} alternativeLabel sx={{ flex: 1, maxWidth: 900, mx: 'auto' }}>
                {steps.map((label, idx) => (
            ...
            >
                <CardWrapper>
                    <Box sx={{ p: { xs: 3, sm: 5 } }}>
                        ...
                        >
                            {activeStep === 0 && <Step1Layout handleNext={handleNext} layout={layout} setLayout={setLayout} />}
                            {activeStep === 1 && (
                                <Step2Measurements
