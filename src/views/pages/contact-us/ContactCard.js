...
const ContactCard = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 6, md: 12 } }}>
      <Paper
        elevation={4}
        sx={{ borderRadius: 4, overflow: 'hidden', p: { xs: 2, md: 0 } }}
      >
        <Grid container alignItems="stretch">
          ...
          <Grid
            ...
            xs={12}
            md={6}
            sx={{ display: 'flex', alignItems: 'center', p: { xs: 3, md: 5 } }}
          >
            <Box
              component="form"
            ...
            >
              ...
              <Button
                ...
                sx={{
                  ...
                  fontSize: '1.1rem',
                  background:
                    'linear-gradient(90deg, #f44336 0%, #ff7961 100%)',
                  boxShadow: '0 4px 16px rgba(244, 67, 54, 0.12)',
                  transition: 'background 0.2s, box-shadow 0.2s',
                  '&:hover': {
                    background:
                      'linear-gradient(90deg, #ff7961 0%, #f44336 100%)',
          ...
          {[
            {
              ...
              icon: (
                <LocationOn
                  sx={{ fontSize: '40px', mb: 1, color: 'inherit' }}
                />
              ),
            ...
            },
            {
              title: 'Make a Call',
              icon: (
                <Phone sx={{ fontSize: '40px', mb: 1, color: 'inherit' }} />
              ),
              text1: '9264484444',
            ...
            },
            {
              title: 'Send a Mail',
              icon: (
                <Email sx={{ fontSize: '40px', mb: 1, color: 'inherit' }} />
              ),
